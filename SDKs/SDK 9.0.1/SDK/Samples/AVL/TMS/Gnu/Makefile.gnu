...
#                  Build                           #
#--------------------------------------------------#
OBJ        =	"$(OBJ_DIR)\Entry.o" "$(OBJ_DIR)\Sample_TMS.o" "$(OBJ_DIR)\Sample_Util.o"
...
"$(OBJ_DIR)\Sample_TMS.o" : "$(SOURCE_DIR)\Sample_TMS.c"
	@echo Compiling... Sample_TMS.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Sample_TMS.c"
