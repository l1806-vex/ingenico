...
extern int Test_TMS(void);
extern void InitParam_TMS(void);
extern void ParseFileTMS(S_FILE *pFile);


//// Global variables ///////////////////////////////////////////

static const char APP_NAME[] = "TMS SAMPLE";
