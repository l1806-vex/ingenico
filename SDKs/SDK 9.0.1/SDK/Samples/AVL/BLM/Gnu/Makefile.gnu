...
#                  Build                           #
#--------------------------------------------------#
OBJ        =	"$(OBJ_DIR)\Entry.o" "$(OBJ_DIR)\Sample_BLM.o" "$(OBJ_DIR)\Sample_Util.o"
...
"$(OBJ_DIR)\Sample_BLM.o" : "$(SOURCE_DIR)\Sample_BLM.c"
	@echo Compiling... Sample_BLM.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Sample_BLM.c"
