...
#                  Build                           #
#--------------------------------------------------#
OBJ        =	"$(OBJ_DIR)\Entry.o" "$(OBJ_DIR)\Sample_ASM.o" "$(OBJ_DIR)\Sample_Util.o"
#--------------------------------------------------#
...
"$(OBJ_DIR)\Sample_ASM.o" : "$(SOURCE_DIR)\Sample_ASM.c"
	@echo Compiling... Sample_ASM.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Sample_ASM.c"
