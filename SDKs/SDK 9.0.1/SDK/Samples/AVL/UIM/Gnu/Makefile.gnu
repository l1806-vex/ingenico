...
#                  Build                           #
#--------------------------------------------------#
OBJ        =	"$(OBJ_DIR)\Entry.o" "$(OBJ_DIR)\Sample_UIM.o" "$(OBJ_DIR)\Sample_Util.o"
...
"$(OBJ_DIR)\Sample_UIM.o" : "$(SOURCE_DIR)\Sample_UIM.c"
	@echo Compiling... Sample_UIM.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Sample_UIM.c"
