...
#                  Linker                          #
#--------------------------------------------------#
LINKOPT    = --script="$(PRJ_ROOT)\gcc_link.gnu" -Map "$(MAP_FILE)"

SYSOBJ     = "$(SDK_LIB)\dllcstartup.o"
...
#--------------------------------------------------#
"$(OBJ_DIR)\source.o" : "$(SOURCE_DIR)\source.c"
	@echo Compiling...source.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\source.c"

"$(OBJ_DIR)\GetProcAdr.o" : "$(SOURCE_DIR)\GetProcAdr.c"
	@echo Compiling...GetProcAdr.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\GetProcAdr.c"
