...
"$(OBJ_DIR)\DoCallHost.o" : "$(SOURCE_DIR)\DoCallHost.c"
	@echo Compiling...DoCallHost.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\DoCallHost.c"

"$(OBJ_DIR)\DoRemote.o" : "$(SOURCE_DIR)\DoRemote.c"
	@echo Compiling...DoRemote.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\DoRemote.c"
