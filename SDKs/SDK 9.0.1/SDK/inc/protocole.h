...
#define PROTOCOLE_HORS_DE_PORTEE        7  /*!< with BT out of range               */
...
*/
// \if SIMULATION
//  @GSIM_F:DIAL_Recept:KSFAM_SANTE:
//  @GSIM_A:1:DATA_CODE(*pusLgRecepMessage)
//  @GSIM_A:2:ONE_POINTER 
//  @GSIM_A:3:ONE_POINTER
//  @GSIM_A:4:ONE_POINTER
//  @GSIM_A:5:DATA_SIZE(3)
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:DIAL_Emiss:KSFAM_SANTE:
//  @GSIM_A:1:DATA_SIZE(usLgEmissMessage)
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:DIAL_DemTemps:KSFAM_SANTE:
//  @GSIM_A:1:DATA_SIZE(usLgEmissMessage) 
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:DIAL_EnvoyerEvt:KSFAM_SANTE:
//  @GSIM_A:1:DATA_SIZE(ulLgMsg) 
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:DIAL_ActiverTLV4:KSFAM_SANTE:
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:APPLI_Dialogue:KSFAM_SANTE:
//  @GSIM_A:2:DATA_SIZE(usLgEmissMessage)
//  @GSIM_A:4:DATA_CODE(*pusLgRecepMessage)
...
*/
// \if SIMULATION
//  @GSIM_F:OS_SysGetParamEXT:KSFAM_SANTE:
