// $Id: GL_IconButton.h,v 1.1.2.7 2012/01/16 08:12:56 rbertholet Exp $
// Graphic Object icon button
#ifndef GL_IconButton_h_INCLUDED
#define GL_IconButton_h_INCLUDED
#ifdef __cplusplus
extern "C"
{
#endif
/**
@addtogroup GL_IconButton
@{
@addtogroup GL_IconButtonDoc  Documentation
@{
This class is an icon followed by a button

Below is a list of specific functions to this class :
	- @ref GL_IconButton_Create : Creating an icon button
...
<h2>Sample</h2>
	...
	Below is an example of creating a window with an icon button.

	@image html iconButtonTest.png
	@include GL_SampleIconButton.c
@}
*/

/*<ALL>
	Extension("ICONBUTTON",              "WIDGET",     "The class icon button is equivalent to a button with an icon, it allows the display of an image more",
...
T_GL_HWIDGET GL_IconButton_Create(T_GL_HWIDGET parent) GL_EXCEPTION;
...
#endif
#endif // GL_IconButton_h_INCLUDED
