...
// \if SIMULATION
//  @GSIM_F:HTTP_Server_Open:KSFAM_HTTPSERVER:0x01
...
// \if SIMULATION
//  @GSIM_F:HTTPS_Server_Open:KSFAM_HTTPSERVER:0x05
//  @GSIM_A:1:ONE_ADDRESS
// \endif
...
// \if SIMULATION
//  @GSIM_F:HTTP_Server_Wait_Request:KSFAM_HTTPSERVER:0x04
//  @GSIM_A:1:ONE_ADDRESS
// \endif
...
//! - \ref HTTP_SERVER_ERROR_HANDLE
// \if SIMULATION
//  @GSIM_F:HTTPS_Server_WaitRequest:KSFAM_HTTPSERVER:0x08
//  @GSIM_A:1:ONE_ADDRESS
// \endif
...
// \if SIMULATION
//  @GSIM_F:HTTP_Server_SendResponse:KSFAM_HTTPSERVER:0x03
//  @GSIM_A:1:ONE_ADDRESS
//  @GSIM_A:2:DATA_SIZE(nDataSize)
// \endif
...
//! - \ref HTTP_SERVER_ERROR_SERVER_CLOSED
// \if SIMULATION
//  @GSIM_F:HTTPS_Server_SendResponse:KSFAM_HTTPSERVER:0x07
//  @GSIM_A:1:ONE_ADDRESS
//  @GSIM_A:2:DATA_SIZE(nDataSize)
// \endif
...
// \if SIMULATION
//  @GSIM_F:HTTP_Server_Close:KSFAM_HTTPSERVER:0x02
//  @GSIM_A:1:ONE_ADDRESS
// \endif
...
//! - \ref HTTP_SERVER_ERROR_HANDLE
// \if SIMULATION
//  @GSIM_F:HTTPS_Server_Close:KSFAM_HTTPSERVER:0x06
//  @GSIM_A:1:ONE_ADDRESS
// \endif
...
//! - \ref HTTP_SERVER_ERROR_HANDLE
// \if SIMULATION
//  @GSIM_F:HTTPS_Server_GetHandles:KSFAM_HTTPSERVER:0x09
//  @GSIM_A:1:ONE_ADDRESS
