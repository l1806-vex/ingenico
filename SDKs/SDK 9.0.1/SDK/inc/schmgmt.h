...
/*! @brief dalloc allocates a component in a non secure area. 
 *
...
// \endif
extern SERR dalloc (SEG_ID s_id, int size);

extern SERR salloc (SEG_ID s_id, int size, char *new_ad);


/*! @brief Copy loads a component into the memory allocated for it. 
 *
...
// \endif
extern SERR copy (SEG_ID s_id, char *src, int size);


/*! @brief This function is used to set CRC16 on the component identifier.
...
// \endif
extern SERR putcrc(SEG_ID s_id);


/*! @brief Execute a SCHEME identified by its identifier and suspend calling sheme execution.
...
//  @GSIM_A:3:ARRAY_OF(4) 
// \endif
extern SERR call (SEG_ID s_id, int *codeexit, int *args);


/*! @brief This function allows an application to delete the last scheme loaded into the crypto processor. 
 *
...
// \endif
extern SERR dfree(SEG_ID s_id);


/*! @brief This function allows an application: 
...
// \endif
extern SERR ddir(int iAux,SEG_ID *Id0,SEG_ID *Id1,SEG_ID *Id2);



/*! @brief Load Booster System in Booster memory.
 *	@param s_id : component identifier.
...
// \endif
extern SERR copy_systeme(SEG_ID s_id, char *src, int size);


/*! @brief dallocUSB allocates a component in a non secure area of the peripheral connected via USB link. 
 *
...
// \endif
extern SERR dallocUsb (SEG_ID s_id, int size);



/*! @brief copyUSB loads a component into the memory allocated for it in the peripheral connected via the USB link. 
 *	@param s_id : segment identifier. 
 *	@param src  : buffer to be copied.
 *	@param size : size to be copied.
 *	@return
...
// \endif
extern SERR copyUsb (SEG_ID s_id, char *src, int size);



/*! @brief This function is used to set CRC16 on the component identifier allocated in the peripheral connected via the USB link.
 *	@param s_id : component identifier ( a buffer ).
 *	@return 
 *	SERR code.
 *
...
// \endif
extern SERR putcrcUsb(SEG_ID s_id);



/*! @brief Execute a SCHEME identified by its identifier in the peripheral connected via the USB link.
 *	@param s_id     : component identifier.
 *	@param codeexit : error returned by the component.
 *	@param args     : parameters of component passing by value or by address. (4 int)
 *	@return
...
//  @GSIM_A:3:ARRAY_OF(4) 
// \endif
extern SERR callUsb (SEG_ID s_id, int *codeexit, int *args);



/*! @brief This function allows an application to delete the last scheme loaded into the peripheral connected via the USB link. 
 *	@param s_id : component identifier.
 *	@return
 *	 SERR codes :
 *	 - SERR_UNKNOWN_ID if the component identifier does not exist.
...
// \endif
extern SERR dfreeUsb(SEG_ID s_id);


/*! @brief This function lists the Ids of all allocated component in the peripheral connected via USB link.
 *	@param iAux : position in component ID table :
 *	 - 0 : means start from the beginning of the component table and get the first component Ids.
 *	 - 1 : means get next component Ids.
 *
...
//  @GSIM_A:4:ONE_POINTER
// \endif
extern SERR ddirUsb(int iAux,SEG_ID *Id0,SEG_ID *Id1,SEG_ID *Id2);


#define _INTERNAL_INTER_UC		0									/*!< INTER UC TYPE : Internal USART        */
#define _USB_PINPAD_INTER_UC	1									/*!< INTER UC TYPE : External USB (PINPAD,CLESS...) */
//#define _USB_CLESS_INTER_UC	2
#define _USB_READER_INTER_UC	3									/*!< INTER UC TYPE : External USB (CAD30USR...)    */
...
// \endif
extern SERR dallocGeneric (unsigned char i_uc_type, SEG_ID s_id, int size);
...
// \endif
extern SERR copyGeneric (unsigned char i_uc_type, SEG_ID s_id, char *src, int size);
...
// \endif
extern SERR putcrcGeneric(unsigned char i_uc_type, SEG_ID s_id);
...
//  @GSIM_A:4:ARRAY_OF(4) 
// \endif
extern SERR callGeneric (unsigned char i_uc_type, SEG_ID s_id, int *codeexit, int *args);
...
// \endif
extern SERR dfreeGeneric(unsigned char i_uc_type, SEG_ID s_id);
...
//  @GSIM_A:3:ARRAY_OF(3) 
// \endif
extern SERR ddirGeneric(unsigned char i_uc_type, int suite, SEG_ID *id );
