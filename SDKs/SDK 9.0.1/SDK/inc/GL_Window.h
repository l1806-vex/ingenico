...
@{
@addtogroup GL_WindowDoc Documentation
@{
...
@param window window handle
@param key key value */
void GL_Window_SendKey(T_GL_HWIDGET window, wchar key) GL_EXCEPTION;
...
void GL_Window_SetInactivityDuration(T_GL_HWIDGET window, ulong duration) GL_EXCEPTION;
