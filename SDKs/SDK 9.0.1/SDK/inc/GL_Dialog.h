// $Id: GL_Dialog.h,v 1.1.2.37 2011/12/02 10:03:18 rbertholet Exp $
...
@{
@addtogroup GL_DialogDoc Documentation
@{
...
/* **************************************************************************************************************************************** */
/** 
@addtogroup GL_DialogList List dialog boxes
@{

@addtogroup GL_DialogListDoc Documentation
@{
...
ulong GL_Dialog_Menu (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char ** menu, int selectedItem, T_GL_BUTTONS buttons, wchar shortcut, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return the number of the menu item clicked (numbering starts at zero) else returns GL_KEY_CANCEL @see GL_TypesKeys*/
ulong GL_Dialog_IconMenu (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char ** menu, int selectedItem, T_GL_BUTTONS buttons, wchar shortcut, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return the number of the menu item clicked (numbering starts at zero) else returns GL_KEY_CANCEL @see GL_TypesKeys*/
ulong GL_Dialog_IconButtonMenu (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char ** menu, int selectedItem, T_GL_BUTTONS buttons, wchar shortcut, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return the number of the menu item clicked (numbering starts at zero) else returns GL_KEY_CANCEL @see GL_TypesKeys*/
ulong GL_Dialog_Choice (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char ** menu, int selectedItem, T_GL_BUTTONS buttons, wchar shortcut, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return the number of the menu item clicked (numbering starts at zero) else returns GL_KEY_CANCEL @see GL_TypesKeys*/
ulong GL_Dialog_MultiChoice (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char ** items, int selectedItem, bool * checkedItems, T_GL_BUTTONS buttons, wchar shortcut, ulong duration) GL_EXCEPTION;
...
/** 
@}
@addtogroup GL_DialogFile File dialog boxes
@{ 

@addtogroup GL_DialogFileDoc Documentation
@{
...
ulong GL_Dialog_File (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * root, const char * filter, char * fileSelected, unsigned long fileSelectedSize, T_GL_DIALOG_FILE_FILTER filterCallback, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return Returns the identity of the standard button*/
ulong GL_Dialog_MultiFile (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * root, const char * filter, T_GL_HSTRINGLIST files, T_GL_DIALOG_FILE_FILTER filterCallback, ulong duration) GL_EXCEPTION;
...
/** 
@}
@addtogroup GL_DialogMessage Message dialog boxes
@{ 

@addtogroup GL_DialogMessageDoc Documentation
@{
...
ulong GL_Dialog_Message(T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, T_GL_DIALOG_ICON icon, T_GL_BUTTONS buttons, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Picture (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * source, T_GL_BUTTONS buttons, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Progress(T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * source, T_GL_COORD * value, T_GL_COORD min, T_GL_COORD max, T_GL_DIALOG_PROGRESS_UPDATE update, T_GL_BUTTONS buttons, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Media (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * source, byte volume, T_GL_BUTTONS buttons, ulong duration) GL_EXCEPTION;

/* **************************************************************************************************************************************** */
/* **************************************************************************************************************************************** */
/** 
@}
@addtogroup GL_DialogInput Input dialog boxes
@{ 
@addtogroup GL_DialogInputDoc Documentation
@{
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Text (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * mask, char * value, ulong valueSize, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Date (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, T_GL_HDATE date, const char * format, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Ip (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, T_GL_HIP ipAddr, ulong duration) GL_EXCEPTION;
...
@param text text displayed (null hide text) (This value is the raw text without the mask characters)
@param mask mask string (or null if no mask defined) @ref GL_Widget_MaskProperties 
@param amount amount displayed and amount entered (all characters not significant from the mask must be present in the amount: for example a mask "/d/d/d./d/d" you must put the amount with dot "123.34")
@param amountSize maximum size of amount buffer
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Amount (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * mask, char * amount, ulong amountSize, const char * unit, T_GL_ALIGN unitAlign, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Color (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, T_GL_HCOLOR color, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Slider(T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * source, T_GL_COORD * value, T_GL_COORD min, T_GL_COORD max, T_GL_DIM step, T_GL_DIALOG_SLIDER_UPDATE update, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return Returns the identity of the standard button*/
ulong GL_Dialog_VirtualKeyboard (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * mask, char * value, ulong valueSize, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return Returns the identity of the standard button*/
ulong GL_Dialog_Password (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * mask, char * value, ulong valueSize, ulong duration) GL_EXCEPTION;
...
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
ulong GL_Dialog_Signature (T_GL_HGRAPHIC_LIB graphicLib, const char * title, const char * text, const char * filename, ulong duration);
