...
//! <TR><TD><b>Developers shall read the documents [ICO-PE-045-GU-EN_PackIP_Security_Guidance] and
//! [ICO-PE-046-GU-EN_PackSSL_Security_Guidance] provided with the Telium SDK.
...
//! Set to 0 by default (wait until connection is finished or failed).
#define LL_TCPIP_T_SSL_TCP_CONNECT_TIMEOUT				19
...
//! \brief The peripheral can't be used since the terminal is not on its cradle (can be obtained with \ref LL_PHYSICAL_V_USB_BASE link ).
