...
/*! @brief This function check the parameters of customization to display the string amount.
 *  this function verify if the currency has to be displayed before or after the amount: test the parameter currency_position of struct S_MONEY
