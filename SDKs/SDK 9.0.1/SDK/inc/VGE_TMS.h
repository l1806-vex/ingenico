...
/*! @brief Enumeration of the parsing types. */
typedef enum
{
 ...
 *  @brief  Its content depends on the application needs (For instance a list of information to be journalized : date, hour, state, number of transactions 
