// $Id: GL_GraphicLib.h,v 1.1.2.74 2012/01/16 08:12:56 rbertholet Exp $
...
/**
@addtogroup GL_Ressource
@{ 
@addtogroup GL_RessourceDoc Documentation
@{
...
@{
@addtogroup GL_GraphicLibDoc Documentation
@{
...
/** 
@addtogroup GL_GraphicLibCreation Creation destruction
@{
*/
...
void GL_GraphicLib_BindManyKey(T_GL_HGRAPHIC_LIB graphicLib, wchar teliumKey, const wchar * keys, unsigned long count) GL_EXCEPTION;

/** Binds telium key to virtual key
@param graphicLib Graphic library context handle 
@param teliumKey telium keyboard key (see @ref GL_TypesKeys)
@param key virtual key */
void GL_GraphicLib_BindSingleKey(T_GL_HGRAPHIC_LIB graphicLib, wchar teliumKey, wchar key) GL_EXCEPTION;

/** Unbinds telium key 
@param graphicLib Graphic library context handle 
@param teliumKey telium keyboard key */
void GL_GraphicLib_UnbindKey(T_GL_HGRAPHIC_LIB graphicLib, wchar teliumKey) GL_EXCEPTION;
...
@param graphicLib Graphic library context handle 
@param key key value */
void GL_GraphicLib_SendKey(T_GL_HGRAPHIC_LIB graphicLib, wchar key) GL_EXCEPTION;
