// $Id: GL_CommonTypes.h,v 1.1.2.43 2012/01/16 08:12:56 rbertholet Exp $
...
/** No key pressed */
#define GL_KEY_NONE                0xFFFF
/** Telium numeric 0 key */
#define GL_KEY_0                   0x0030
/** Telium numeric 1 key */
#define GL_KEY_1                   0x0031
/** Telium numeric 2 key */
#define GL_KEY_2                   0x0032
/** Telium numeric 3 key */
#define GL_KEY_3                   0x0033
/** Telium numeric 4 key */
#define GL_KEY_4                   0x0034
/** Telium numeric 5 key */
#define GL_KEY_5                   0x0035
/** Telium numeric 6 key */
#define GL_KEY_6                   0x0036
/** Telium numeric 7 key */
#define GL_KEY_7                   0x0037
/** Telium numeric 8 key */
#define GL_KEY_8                   0x0038
/** Telium numeric 9 key */
#define GL_KEY_9                   0x0039
/** Telium numeric dot key */
#define GL_KEY_DOT                 0x002E

/** Begin of range of controls keys */
#define GL_KEY_CONTROL_BEGIN       0xF800
/** End of range of controls keys */
#define GL_KEY_CONTROL_END         0xF87F
/** Telium green key */
...
#define GL_KEY_PAPER               0xF853
/** Telium paper feed key */
#define GL_KEY_F                   0xF854
/** Telium function 1 key */
#define GL_KEY_F1                  0xF855
/** Telium function 2 key */
#define GL_KEY_F2                  0xF856
/** Telium function 3 key */
#define GL_KEY_F3                  0xF857
/** Telium function 4 key */
#define GL_KEY_F4                  0xF858
/** Telium up arrow key */
#define GL_KEY_UP                  0xF859
/** Telium down arrow key */
#define GL_KEY_DOWN                0xF85A
/** Telium ok key */
#define GL_KEY_OK                  0xF86B
/** Telium clear key */
#define GL_KEY_CLEAR               0xF86C
...
#define GL_VIRTUAL_KEY_PREVIOUS    0xF81B
/** Pass the focus to next widget */
#define GL_VIRTUAL_KEY_NEXT        0xF81C
/** Moves the cursor to the left in the widget that has focus */
#define GL_VIRTUAL_KEY_LEFT        0xF800
/** Moves the cursor to the right in the widget that has focus */
#define GL_VIRTUAL_KEY_RIGHT       0xF801
/** Moves the cursor to the up in the widget that has focus */
#define GL_VIRTUAL_KEY_UP          0xF802
/** Moves the cursor to the down in the widget that has focus */
#define GL_VIRTUAL_KEY_DOWN        0xF803
/** Selects the previous page */
#define GL_VIRTUAL_KEY_PAGE_UP     0xF808
/** Selects the next page */
#define GL_VIRTUAL_KEY_PAGE_DOWN   0xF809
/** Toggle to insert mode */
#define GL_VIRTUAL_KEY_INSERT      0xF804
/** Deletes one character */
#define GL_VIRTUAL_KEY_DELETE      0xF805
/** Moves the cursor to the beginning of line */
#define GL_VIRTUAL_KEY_HOME        0xF806
/** Moves the cursor to the end of line */
#define GL_VIRTUAL_KEY_END         0xF807
...
/** no user action since the specified time @ref GL_Window_SetInactivityDuration */
...
{
	GL_EVENT_NONE              = 0x0000,  ///< Event not defined
	GL_EVENT_STYLUS_MOVE       = 3,       ///< The stylus moved on the screen (@ref GL_Widget_CommonMessage)
	GL_EVENT_STYLUS_DOWN       = 4,       ///< The stylus pressed on the screen (@ref GL_Widget_CommonMessage)
	GL_EVENT_STYLUS_UP         = 5,       ///< The stylus removed from the screen (@ref GL_Widget_CommonMessage)
	GL_EVENT_KEY_DOWN          = 6,       ///< The key pressed on keyboard (@ref GL_Widget_CommonMessage)
	GL_EVENT_KEY_UP            = 7,       ///< The key released on keyboard (@ref GL_Widget_CommonMessage)
	GL_EVENT_TIMER_OUT         = 8,       ///< The timer is out (@ref GL_Widget_CommonMessage)
	GL_EVENT_PAINT             = 9,       ///< The window must be repaint (@ref GL_Widget_CommonMessage)
	GL_EVENT_EXIT              = 10,      ///< The button "close" on the main window has been clicked (WIN32 only)
	GL_EVENT_WINDOW_LEAVE      = 12,      ///< The stylus enters the bounding area of a window (@ref GL_Widget_CommonMessage)
	GL_EVENT_WINDOW_ENTER      = 13,      ///< The stylus leaves the bounding area of a window (@ref GL_Widget_CommonMessage)
	GL_EVENT_USERAREA_CHANGED  = 14,	  ///< The User Area has been changed
	GL_EVENT_TOUCH_PHY		   = 15,	  ///< Physical event on the touchscreen

	GL_EVENT_VERTICAL_SCROLL   = 101,     ///< The view or scrollbar moved vertically (@ref GL_Widget_CommonMessage)
	GL_EVENT_HORIZONTAL_SCROLL = 102,     ///< The view or scrollbar moved horizontally (@ref GL_Widget_CommonMessage)
	GL_EVENT_STYLUS_CLICK      = 103,     ///< The widget clicked (@ref GL_Widget_CommonMessage)
	GL_EVENT_STYLUS_SCROLL     = 104,     ///< The scrolling request was done by the stylus (stylus down, long stylus move, stylus up) (@ref GL_Widget_CommonMessage)
	GL_EVENT_FOCUS_KEY         = 105,     ///< The change in focus is due to key pressed (used to move the scrolled view to the widget focused) (@ref GL_Widget_CommonMessage)
	GL_EVENT_VALID             = 106,     ///< The button valid (green) clicked on virtual keyboard (@ref GL_Widget_CommonMessage)
	GL_EVENT_CANCEL            = 107,     ///< The button cancel (red) clicked on virtual keyboard (@ref GL_Widget_CommonMessage)
	GL_EVENT_FOCUS             = 108,     ///< The widget received focus (@ref GL_Widget_CommonMessage)
	GL_EVENT_UNFOCUS           = 109,     ///< The widget lost focus (@ref GL_Widget_CommonMessage)
	GL_EVENT_INACTIVITY        = 110,     ///< No user action detected for the specified time (@ref GL_Widget_CommonMessage)
	GL_EVENT_STYLUS_LEAVE      = 111,     ///< The stylus enters the bounding area of a widget (@ref GL_Widget_CommonMessage)
	GL_EVENT_STYLUS_ENTER      = 112,     ///< The stylus leaves the bounding area of a widget (@ref GL_Widget_CommonMessage)
	GL_EVENT_BREAK             = 113,     ///< The events are popped before stacking other
	GL_EVENT_CHECKED           = 114,     ///< The widget is checked (@ref GL_Widget_CommonMessage)
	GL_EVENT_UNCHECKED         = 115,     ///< The widget is unchecked (@ref GL_Widget_CommonMessage)
	GL_EVENT_MEDIA_ENDED       = 116,     ///< The video or audio ended (@ref GL_Widget_CommonMessage)
...
/**
@}
@addtogroup GL_TypesSkinedColors Skined colors
@{
*/
...
#define GL_COLOR_DARKORANGE              ((T_GL_COLOR)0xFFFF8C00)  //!< <table border="1" cellspacing="0" cellpadding="0"><tr><td bgcolor="Darkorange">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td></tr></table>
...
/** Infinite duration */
#define GL_TIME_INFINITE ((ulong)(-1))

/** Second duration */
#define GL_TIME_SECOND ((ulong)1000)

/** Minute duration */
#define GL_TIME_MINUTE ((ulong)(60*GL_TIME_SECOND))
...
/**
@}
@addtogroup GL_TypesMimes Mimes types
@{
*/
