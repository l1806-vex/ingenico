...
#define COMPATIBILITY_NUMBER  14
typedef struct
{
  ...
  char ToBeContinued[4*14];            // RUF : 14 more parameters
} S_STATE_PARAM;
 ...
 * - 2 : Manager language is regional 1 
 * - 3 : Manager language is regional 2 
 * @par exit (EXIT_DLL_PARAM_NOT_INITIALIZED + 6) if function does not exist
 *
 * @link KSFAM_PSQ Back to top @endlink
 */
 ...
 * @param liaison : link type on whitch the c30 is connected.
 * @return
 * - 1 if c30 connected.
 * - 0 otherwise.
...
//  @GSIM_A:1:OUT_ONLY
// \endif
extern void          PSQ_Donner_reference ( S_EQUIPEMENT * p_equip );
...
//  @GSIM_A:1:ONE_POINTER
// \endif
extern unsigned char GetPackInfos(hPack_t *hPack,unsigned short ucTypeAppli, char *FilePath, char *FileName);
...
//  @GSIM_A:1:ONE_POINTER
// \endif
extern void          PSQ_give_specific_context(S_SPECIFIC_CONTEXT *paramout);
...
//  @GSIM_A:1:ONE_POINTER
// \endif
extern void          PSQ_give_specific_context_extended(S_SPECIFIC_CONTEXT_EXTENDED *paramout);
...
/*! @brief This function update the list of parameters used to
 *  perform the customisation of manager
 * @param param : struct of parameters
 * @par exit (EXIT_DLL_PARAM_NOT_INITIALIZED + 90) if function does not exist
 * @link KSFAM_PSQ Back to top @endlink
 */
// \if SIMULATION
//  @GSIM_F:PSQ_update_state_param:KSFAM_PSQ:
// \endif
extern void      PSQ_update_state_param(S_STATE_PARAM *param);
