// $Id: GL_Message.h,v 1.1.2.23 2012/01/02 08:26:10 rbertholet Exp $
...
@{
@addtogroup GL_MessageDoc Documentation
@{
...
/** Gets the key code in case of KEY message
@param message message from which getting the key code
@return key key code */
wchar GL_Message_GetKey(T_GL_HMESSAGE message) GL_EXCEPTION;
