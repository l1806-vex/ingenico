...
/*! @addtogroup KSFAM_SSL
	...
	<TR><TD></TD></TR>
	<TR><TD><b>Developers shall read the [SMO-SFO-ICO-PE-046-GU-EN_PackSSL_SecurityGuidance_UserGuide.pdf] which describes
...
#define SSL_MKEY_MASK                           0x0000001FL     /*!< Mask of SSL key exchange algorithm */ 
#define SSL_kRSA                                0x00000001L     /*!< RSA key exchange*/
#define SSL_kDHr                                0x00000002L     /*!< DH cert RSA CA cert*/
#define SSL_kDHd                                0x00000004L     /*!< DH cert DSA CA cert*/
#define SSL_kFZA                                0x00000008L     /*!< Fortezza*/ 
#define SSL_kEDH                                0x00000010L     /*!< tmp DH key no DH cert*/ 

#define SSL_AUTH_MASK                           0x000003e0L     /*!< Mask of all authentication algorithm*/ 
...
#define SSL_aFZA                                0x00000080L     /*!< Fortezza*/ 
#define SSL_aNULL                               0x00000100L     /*!< no Authenticate, ADH */
#define SSL_aDH                                 0x00000200L     /*!< no Authenticate, ADH */

#define SSL_NULL                                (SSL_eNULL)                             /*!< NULL*/ 
#define SSL_ADH                                 (SSL_kEDH|SSL_aNULL)                    /**< aDH */
#define SSL_RSA                                 (SSL_kRSA|SSL_aRSA)                     /*!< RSA*/ 
#define SSL_DH                                  (SSL_kDHr|SSL_kDHd|SSL_kEDH)            /*!< DH*/ 
#define SSL_FZA                                 (SSL_aFZA|SSL_kFZA|SSL_eFZA)            /*!< Fortezza*/ 
#define SSL_EDH                                 (SSL_kEDH|(SSL_AUTH_MASK^SSL_aNULL))    /*!< eDH*/ 

#define SSL_ENC_MASK                            0x0021Fc00L     /*!< Mask of ciphering algorithm*/ 
...
#define SSL_IDEA				0x00004000L     /*!< IDEA*/ 
#define SSL_eFZA				0x00008000L     /*!< Fortezza*/ 
#define SSL_eNULL				0x00010000L     /*!< NULL*/ 
#define SSL_AES					0x00200000L     /*!< AES*/ 

#define SSL_MAC_MASK                            0x00060000L     /*!< Mask of mac algorithm*/ 
#define SSL_MD5					0x00020000L     /*!< MD5*/ 
#define SSL_SHA1				0x00040000L     /*!< SHA1*/ 	
#define SSL_SHA                                 (SSL_SHA1)      /*!< SHA*/ 

#define SSL_SSL_MASK                            0x00180000L     /*!< Mask of SSL version*/ 
#define SSL_SSLV2				0x00080000L     /*!< SSL v2*/ 
#define SSL_SSLV3				0x00100000L     /*!< SSL v3*/ 

//! @}

// export information
#define SSL_EXP_MASK                            0x00000003L     /*!< Mack of export*/ 
#define SSL_NOT_EXP                             0x00000001L     /*!< No export*/ 
#define SSL_EXPORT                              0x00000002L     /*!< Export*/ 

// cipher strength information
#define SSL_STRONG_MASK                         0x000000fcL     /*!< Mask of SSL algorithm strength*/ 
 ...
 * @param ssl : A SSL structure
 * @param ip_dot_addr : The ssl server IP address like "192.168.1.2"
 ...
 * @param szName	: Name of the new profile
...
/*! @brief This function adds a CA to a profile
 ...
 * @param handle	: A profile handle
 * @param protocol	: The ssl protocol (SSLv2,SSLv3)
 * @return
 *	- #SSL_PROFILE_EOK (0) if successful
