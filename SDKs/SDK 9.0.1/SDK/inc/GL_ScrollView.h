// $Id: GL_ScrollView.h,v 1.1.2.23 2012/01/16 08:12:56 rbertholet Exp $
...
@{
@addtogroup GL_ScrollViewDoc Documentation
@{
...
The scrolled view containing a list is also not supported.</H1>
