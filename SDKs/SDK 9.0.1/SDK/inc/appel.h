...
#define CUSTOMIZE_MESSAGE       	72  /*!< Reserved to customize the manager messages  */
...
#define CUSTOMIZE_CARD_ENTRY     82
...
/*! @brief This type define a structure wich describes an application. */
typedef struct
{
	NO_SEGMENT     noappli;							/*!< the number of the application */
	unsigned char  priority;						/*!< priority of the application */
	unsigned short type_code;						/*!< the type of code. */
	unsigned short type_application;		/*!< the type of application. */
} StructAppli;

/*! @brief This type define a structure wich describes a service. */
typedef struct
{
	unsigned short   nb_appli;								/*!< number of applications */
	unsigned short   service;									/*!< service id */
	StructAppli      Appli[NUMBER_OF_APPLI];	/*!< array of structures describing nb_appli applications. */
} StructService;

/*! @brief This type define a structure wich describes an engine. */
typedef struct
{
	unsigned short   nb_service;								/*!< number of services */
	StructService    Service[NB_MAX_SERVICE];		/*!< array of structures describing nb_service services. (100 max). */
} StructMoteur;
...
typedef struct
{
	...
	char               rfu2[5];                     /*!< reserved for future use */
...
typedef struct
{
	S_ETATOUT param_in;	  							/*!< input parameter.*/
} StructMoreFunction;
...
*/
// \if SIMULATION
//  @GSIM_F:Get_TypeCode:KSFAM_M2OS:0x02
// \endif
extern int            Get_TypeCode(NO_SEGMENT no_appli);
...
*/
// \if SIMULATION
//  @GSIM_F:Get_ObjectType:KSFAM_M2OS:
// \endif
extern int 			  Get_ObjectType(NO_SEGMENT no_appli);
...
*/
// \if SIMULATION
//  @GSIM_F:Get_AppliName:KSFAM_M2OS:
// \endif

extern char          *Get_AppliName(NO_SEGMENT no_appli);


/*! @brief This function returns the name and the version of the application
 * @param no_appli : rank of the application
 * @return Name and version of the application.
 * @par exit (EXIT_DLL_EXTENS_NOT_INITIALIZED + 111) if function does not exist
 *
 * @link KSFAM_M2OS Back to top @endlink
*/
// \if SIMULATION
//  @GSIM_F:Get_FileName:KSFAM_M2OS:0x08
// \endif
extern char          *Get_FileName(NO_SEGMENT no_appli);
...
*/
// \if SIMULATION
//  @GSIM_F:Get_AppliCrc:KSFAM_M2OS:0x07
// \endif
extern unsigned short Get_AppliCrc(NO_SEGMENT no_appli);
//! @}
...
*/
// \if SIMULATION
//  @GSIM_F:Get_Appli_Number:KSFAM_M2OS:0x05
// \endif
extern int            Get_Appli_Number(int type);
//! @}
...
*/
// \if SIMULATION
//  @GSIM_F:Get_AppliData:KSFAM_M2OS:0x04
// \endif
extern char          *Get_AppliData(NO_SEGMENT no_appli);
//! @}
...
*/
// \if SIMULATION
//  @GSIM_F:Get_AppliCode:KSFAM_M2OS:0x03
// \endif
extern int            Get_AppliCode(NO_SEGMENT no_appli);
...
*/
// \if SIMULATION
//  @GSIM_F:Get_Nb_Segment:KSFAM_M2OS:0x09
// \endif
extern int            Get_Nb_Segment(void);
/*! @} **/
