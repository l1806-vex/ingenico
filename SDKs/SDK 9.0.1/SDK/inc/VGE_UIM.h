...
/*! @brief Navigation option structure. */
typedef struct
{
...
/*! @brief PAN entry option structure. */
typedef struct
{
...
/*! @brief Expiration date entry option structure. */
typedef struct
{
...
/*! @brief CVV2 entry option structure. */
typedef struct
{
...
/*! @brief Numerical entry option structure. */
typedef struct
{
...
/*! @brief Alpha numerical entry option structure. */
typedef struct
{
...
/*! @brief Graphic mode option structure. */
typedef struct
{
...
/*! @brief Normal mode option structure. */
typedef struct
{
	int iLine ;				/*!< Line			*/
	int iColumn ;			/*!< Column			*/
...
/*! @brief Message option structure. */
typedef struct
{
...
/*! @brief Input entry option structure. */
typedef struct
{
 ...
 *	@brief It returns to the calling application the entered IP address.
