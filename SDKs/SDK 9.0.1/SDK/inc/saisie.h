 ...
 *  This function display message MESS184 on terminal display,use Write_InfosMSG_Cust to customize the message
...
// \endif
extern unsigned char Pinpad_List_Entry(T_LABEL *LabelList,unsigned char LabelNumber,unsigned char *Indice,int WaitForKeyboard);

/*! @brief This function is used to confirm AID value on PINPAD; 
 *	This function uses the graphic library capabilities. It starts an entry system task. 
 *  This function display message MESS185 on terminal display,use Write_InfosMSG_Cust to customize the message
...
// \endif
extern unsigned char Pinpad_Confirm_AID(unsigned char *aid,int WaitForKeyboard);
...
// \endif
extern unsigned char Terminal_List_Entry  (T_LABEL *LabelList,unsigned char LabelNumber,unsigned char *Indice);
...
// \endif
extern unsigned char Navigate(unsigned short timeout,unsigned char no_appli,int *No,int Nb,NavigationItems *Table);
...
* - starts an entry system task. Application has to wait for the event ENTRY , then it can 
* - get the entry using Get_Entry .
* -  wG_Saisie_Alphanumerique manage language,fonts and UNICODE messages
* @param menu : see wG_List_Entry.
...
*/
// \if SIMULATION
//  @GSIM_F:wG_Saisie_Alphanumerique:KSFAM_ENTRY:
//  @GSIM_S:wG_Saisie_Alphanumerique:E_wG_Saisie_Alphanumerique
// \endif
extern void wG_Saisie_Alphanumerique(wStructListe *menu,TAB_ENTRY_ALPHA *table);
...
// \endif
extern void wG_Init(wStructListe *Menu,unsigned char line,unsigned char column);
...
// \endif
extern void cGUI_List_Entry (wStructListe *Menu,cGuiStructList *MenuCgui);
...
// \endif
extern void cGUI_Large_List_Entry (wStructListe *Menu,cGuiLargeStructList *MenuCgui);
...
// \endif
void cGUI_List_Multi_Entry (cGuiStructList *tablewgui);
...
// \endif
extern void cGUI_Aff_Liste(wStructListe *table,cGuiStructList *MenuCgui);
...
// \endif
extern void cGUI_Numerical_Entry(wStructListe *menu,TAB_ENTRY_STRING *table,cGuiStructEntry *NumEntry);
...
// \endif
extern void cGUI_Icon_List(wIconList *IconList);
...
*/
extern void cGUI_Large_Icon_List(wLargeIconList *IconList);
...
// \endif
extern void cGUI_Extended_Entry(wStructListe *menu,TAB_ENTRY_STRING *table,cGuiStructEntry *NumEntry);
...
// \endif
extern void cGUI_Alphanum_Entry(wStructListe *menu,TAB_ENTRY_ALPHA *table,cGuiStructEntry *NumEntry);
...
#define wG_Extended_entry(p0,p1)      wG_Saisie_Etendue((StructListe *)p0,(TAB_ENTRY_STRING *)p1)
