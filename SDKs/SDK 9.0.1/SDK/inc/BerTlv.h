 ...
 **/
int BerTlvGetTagClass(BER_TLV_TAG Tag);
 ...
 **/
int BerTlvIsTagUniversalClass(BER_TLV_TAG Tag);
 ...
 **/
int BerTlvIsTagApplicationClass(BER_TLV_TAG Tag);
 ...
 **/
int BerTlvIsTagContextSpecificClass(BER_TLV_TAG Tag);
 ...
 **/
int BerTlvIsTagPrivateClass(BER_TLV_TAG Tag);
 ...
 **/
int BerTlvIsTagPrimitiveObject(BER_TLV_TAG Tag);
 ...
 **/
int BerTlvIsTagConstructedObject(BER_TLV_TAG Tag);
 ...
 **/
int BerTlvIsTagValid(BER_TLV_TAG Tag);
 ...
 **/
int BerTlvGetTagSize(BER_TLV_TAG Tag);
 ...
 *	@return	The number of bytes needed.
 **/
int BerTlvGetLengthSize(BER_TLV_LENGTH Length);
 ...
 **/
int BerTlvSkipPadding(const void* pBuffer, int nBufferSize);
 ...
 **/
int BerTlvEncodeTag(BER_TLV_TAG Tag, void* pBuffer, int nBufferSize);
 ...
 **/
int BerTlvDecodeTag(BER_TLV_TAG* pTag, const void* pBuffer, int nBufferSize);
 ...
 *	@return	The number of bytes written or -1 if the buffer is too small.
 **/
int BerTlvEncodeLength(BER_TLV_LENGTH Length, void* pBuffer, int nBufferSize);
 ...
 **/
int BerTlvDecodeLength(BER_TLV_LENGTH* pLength, const void* pBuffer, int nBufferSize);
 ...
 *	@return	The number of bytes written or -1 if the buffer is too small.
 **/
int BerTlvEncode(BER_TLV_TAG Tag, BER_TLV_LENGTH Length, void* pBuffer, int nBufferSize);
 ...
 **/
int BerTlvDecode(BER_TLV_TAG* pTag, BER_TLV_LENGTH* pLength, const void* pBuffer, int nBufferSize);
