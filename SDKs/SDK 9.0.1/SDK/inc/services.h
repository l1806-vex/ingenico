...
#define HARDWARE_LED_CAM     		0x200	/*!< optional contact card reader led (available on IPP3xx only)                        */
#define HARDWARE_LED_SWIPE  		0x300	/*!< optional Magnetic card reader led (available on IPP3xx only)                       */
...
* - HARDWARE_LED_CAM   optional contact card reader led (available on IPP3xx only)
* - HARDWARE_LED_SWIPE optional Magnetic card reader led (available on IPP3xx only)
