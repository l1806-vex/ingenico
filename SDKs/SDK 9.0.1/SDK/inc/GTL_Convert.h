...
//!	\param[out] szString Converted string in ascii format.
...
//! GTL_Convert_DcbToAscii (pDcb, szString, 0, 8) : szString = 0x31 0x32 0x33 0x34 0x41 0x42 0x43 0x44
//! GTL_Convert_DcbToAscii (pDcb, szString, 1, 5) : szString = 0x32 0x33 0x34 0x41 0x42
...
//!	\param[out] szString Converted number in ascii format.
...
//! GTL_Convert_DcbNumberToAscii (pDcb, szString, 4, 10) : szString = 0x00 0x00 0x31 0x32 0x33 0x34 0x41 0x42 0x43 0x44
//! GTL_Convert_DcbNumberToAscii (pDcb, szString, 4, 3) : szString = 0x31 0x32 0x33
...
//! unsigned char szString [10];
//! GTL_Convert_DcbPaddedToAscii (pDcb, szString, 6) : szString = 0x31 0x32 0x33 0x34 0x41 0x42 0x43 0x44 0x45 ("1234ABCDE")
