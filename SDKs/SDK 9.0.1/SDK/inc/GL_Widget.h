// $Id: GL_Widget.h,v 1.1.2.107 2012/01/16 08:12:56 rbertholet Exp $
...
/**
@addtogroup GL_WidgetDoc Documentation
@{
	Summary :
...
This section presents the features shared by all widgets.
...
<hr>@section GL_Widget_GeometryProperties Geometry properties
...
<hr>@section GL_Widget_LayoutProperties Layout properties
...
<hr>@section GL_Widget_RangeProperties Range properties
...
<hr>@section GL_Widget_IdProperties Identifier properties
...
<hr>@section GL_Widget_ByIdProperties By Id properties
...
<hr>@section GL_Widget_FormatProperties Format properties
	...
	<b>flags</b>
		...
		- <b>#</b> Used with o, x or X specifiers the value is preceeded with 0, 0x or 0X respectively for values different than zero.
...
<hr>@section GL_Widget_AppearanceProperties Appearance properties
...
<hr>@section GL_Widget_FocusProperties Focus properties
...
<hr>@section GL_Widget_ClickProperties Click properties
...
<hr>@section GL_Widget_CheckProperties Check properties
...
<hr>@section GL_Widget_TextProperties Text properties
...
<hr>@section GL_Widget_InputProperties Input properties
...
<hr>@section GL_Widget_MaskProperties Mask properties
...
<hr>@section GL_Widget_CallbackProperties Callback properties
...
<hr>@section GL_Widget_CommonMessage Messages sent by the widgets
	...
	All widgets :
		...
		- @ref GL_EVENT_STYLUS_CLICK : The widget clicked (datas attached @ref GL_Message_GetPosition)
		- @ref GL_EVENT_STYLUS_SCROLL : The scrolling request was done by the stylus (stylus down, long stylus move, stylus up) (datas attached @ref GL_Message_GetMove, @ref GL_Message_GetPosition)
		- @ref GL_EVENT_STYLUS_MOVE : The stylus moved on the screen (datas attached @ref GL_Message_GetPosition)
		- @ref GL_EVENT_STYLUS_DOWN : The stylus pressed on the screen (datas attached @ref GL_Message_GetPosition)
		- @ref GL_EVENT_STYLUS_UP : The stylus removed from the screen (datas attached @ref GL_Message_GetPosition)
		- @ref GL_EVENT_KEY_DOWN : The key pressed on keyboard (datas attached @ref GL_Message_GetKey)
		- @ref GL_EVENT_KEY_UP : The key released on keyboard (datas attached @ref GL_Message_GetKey)
	...
	@ref GL_Window :
		...
		- @ref GL_EVENT_INACTIVITY : No user action detected for the specified time,
			configured by the function @ref GL_Window_SetInactivityDuration
		- @ref GL_EVENT_PAINT : The window must be repaint (datas attached @ref GL_Message_GetSize, @ref GL_Message_GetPosition)

	@ref GL_Timer :
		- @ref GL_EVENT_TIMER_OUT : The timer is out (datas attached @ref GL_Message_GetTimer)

	@ref GL_RadioButton and @ref GL_CheckButton
		- @ref GL_EVENT_CHECKED : The widget is checked
		- @ref GL_EVENT_UNCHECKED : The widget is unchecked

	@ref GL_ScrollView :
		- @ref GL_EVENT_VERTICAL_SCROLL : The view or scrollbar moved vertically (datas attached @ref GL_Message_GetRange)
		- @ref GL_EVENT_HORIZONTAL_SCROLL : The view or scrollbar moved horizontally (datas attached @ref GL_Message_GetRange)

	@ref GL_VScrollBar :
		- @ref GL_EVENT_VERTICAL_SCROLL : The view or scrollbar moved vertically (datas attached @ref GL_Message_GetRange)
	
	@ref GL_HScrollBar and @ref GL_HSlider :
		- @ref GL_EVENT_HORIZONTAL_SCROLL : The view or scrollbar moved horizontally (datas attached @ref GL_Message_GetRange)

	@ref GL_VirtualKeyboard :
		- @ref GL_EVENT_VALID : The button valid (green) clicked on virtual keyboard (datas attached @ref GL_Message_GetPosition)
		- @ref GL_EVENT_CANCEL : The button cancel (red) clicked on virtual keyboard (datas attached @ref GL_Message_GetPosition)

	For more details on the operation on messages see @ref GL_MessageDoc

<hr>@section GL_Widget_ShortcutProperties Shortcut properties
...
<hr>@section GL_Widget_ImagesProperties Image properties
...
<hr>@section GL_Widget_ImagesTransformationProperties Image transformation properties
...
<hr>@section GL_Widget_UserDataProperties User data properties
...
<hr>@section GL_Widget_Image Image
...
<h2>Dithering tools</h2>
	...
	- ImageOptimizer.exe : console image converter
...
<h2>Animated image creation</h2>
	...
	add in brackets the type of slide : 
	 - <b>(replace)</b> : replaces the image displayed by the background before displaying the next image
	 - <b>(combine)</b> : leaves the image displayed before displaying the next image
	 - <b>(previous)</b> : replaces the previously displayed image before displaying the next image
...
/** First reserved id used by the skin */
#define GL_ID_SKIN_START               0xFF000000

/** Identifies the label */
#define GL_ID_SKIN_LABEL               0xFF000001

/** Identifies the check or radio picture */
#define GL_ID_SKIN_CHECK               0xFF000003

/** Identifies the slider */
#define GL_ID_SKIN_SLIDER              0xFF000004

/** Identifies the bar */
#define GL_ID_SKIN_BAR                 0xFF000005

/** Identifies the icon image */
#define GL_ID_SKIN_ICON                0xFF000006

/** Identifies the horizontal scroll bar */
#define GL_ID_SKIN_HSCROLLBAR          0xFF000007

/** Identifies the vertical scroll bar */
#define GL_ID_SKIN_VSCROLLBAR          0xFF000008

/** Identifies the list */
#define GL_ID_SKIN_LIST                0xFF000009

/** Identifies the scroll view */
#define GL_ID_SKIN_SCROLLVIEW          0xFF00000A

/** Identifies the dialog */
#define GL_ID_SKIN_DIALOG              0xFF00000B

/** Identifies the text in dialog */
#define GL_ID_SKIN_DIALOG_CONTENT      0xFF00000C

/** Identifies the title in dialog  */
#define GL_ID_SKIN_DIALOG_TITLE        0xFF00000D

/** Identifies the icon in dialog  */
#define GL_ID_SKIN_DIALOG_ICON         0xFF00000E

/** Identifies the button in dialog  */
#define GL_ID_SKIN_DIALOG_BUTTONS      0xFF00000F

/** Identifies the text in dialog  */
#define GL_ID_SKIN_DIALOG_TEXT         0xFF000010

/** Identifies the valid button in dialog  */
#define GL_ID_SKIN_DIALOG_VALID        0xFF000011

/** Identifies the correction button in dialog  */
#define GL_ID_SKIN_DIALOG_CORRECTION   0xFF000012

/** Identifies the cancel button in dialog  */
#define GL_ID_SKIN_DIALOG_CANCEL       0xFF000013

/** Identifies the layout in dialog  */
#define GL_ID_SKIN_DIALOG_LAYOUT       0xFF000014

/** Identifies the edit in dialog  */
#define GL_ID_SKIN_DIALOG_VALUE        0xFF000015

/** Identifies the unit in dialog  */
#define GL_ID_SKIN_DIALOG_UNIT         0xFF000016

/** Identifies the edit field in the virtual keyboard */
#define GL_ID_SKIN_EDIT_FIELD          0xFF000017

/** Identifies the list in dialog */
#define GL_ID_SKIN_DIALOG_LIST         0xFF000018

/** Identifies the help in dialog  */
#define GL_ID_SKIN_DIALOG_HELP         0xFF000019

/** Identifies the virtual keyboard table */
#define GL_ID_SKIN_DIALOG_KEYBOARD     0xFF00001A

/** Identifies the key icon */
#define GL_ID_SKIN_KEY_ICON            0xFF00001B

/** Identifies the shortcut button in dialog  */
#define GL_ID_SKIN_DIALOG_SHORTCUT     0xFF00001C
...
/** Last id used by the skin */
#define GL_ID_SKIN_STOP                0xFFFFFFFE

/** Undefined id */
#define GL_ID_UNDEFINED                0xFFFFFFFF
...
/** Gets the widget background color (@ref GL_TypesSkinedColors, @ref GL_TypesColors)
@param widget widget handle 
@return the background color */
T_GL_COLOR GL_Widget_GetBackColor(T_GL_HWIDGET widget) GL_EXCEPTION;

/** Sets the widget background color (@ref GL_TypesSkinedColors, @ref GL_TypesColors)
@param widget widget handle 
@param color new color */
void GL_Widget_SetBackColor(T_GL_HWIDGET widget, T_GL_COLOR color) GL_EXCEPTION;

/** Gets the widget foreground color (@ref GL_TypesSkinedColors, @ref GL_TypesColors)
@param widget widget handle 
@return the background color */
T_GL_COLOR GL_Widget_GetForeColor(T_GL_HWIDGET widget) GL_EXCEPTION;

/** Sets the widget foreground color (@ref GL_TypesSkinedColors, @ref GL_TypesColors)
@param widget widget handle 
@param color new color */
...
void GL_Widget_SetShortcut(T_GL_HWIDGET widget, wchar key) GL_EXCEPTION;

/** Gets the keyboard shortcut attached to widget @ref GL_Widget_ShortcutProperties
@param widget widget handle
@return keystroke */
wchar GL_Widget_GetShortcut(T_GL_HWIDGET widget) GL_EXCEPTION;
...
void GL_Widget_SetFillChar1(T_GL_HWIDGET widget, wchar character) GL_EXCEPTION;
...
wchar GL_Widget_GetFillChar1(T_GL_HWIDGET widget) GL_EXCEPTION;

/** Sets the default fill character (This character appears only in fields with an input mask defined) @ref GL_Widget_MaskProperties
@param widget widget handle
@param character fill character */
void GL_Widget_SetFillChar2(T_GL_HWIDGET widget, wchar character) GL_EXCEPTION;

/** Gets the default fill character (This character appears only in fields with an input mask defined) @ref GL_Widget_MaskProperties
@param widget widget handle
@return character fill character */
wchar GL_Widget_GetFillChar2(T_GL_HWIDGET widget) GL_EXCEPTION;
...
void GL_Widget_SetPasswordChar(T_GL_HWIDGET widget, wchar character) GL_EXCEPTION;

/** Gets the default password character @ref GL_Widget_MaskProperties
@param widget widget handle
@return character password character */
wchar GL_Widget_GetPasswordChar(T_GL_HWIDGET widget) GL_EXCEPTION;
