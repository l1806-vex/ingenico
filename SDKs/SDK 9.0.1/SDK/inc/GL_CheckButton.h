// $Id: GL_CheckButton.h,v 1.1.2.22 2012/01/16 08:12:56 rbertholet Exp $
// Graphic Object button
#ifndef GL_CheckButton_h_INCLUDED
#define GL_CheckButton_h_INCLUDED
#ifdef __cplusplus
extern "C"
{
#endif
/**
@addtogroup GL_CheckButton
@{
@addtogroup GL_CheckButtonDoc  Documentation
@{

A check button is an option button that can be switched on (checked) or off (unchecked).
Checkboxes are typically used to represent features in an application that can be enabled or disabled without affecting others, but different types of behavior can be implemented.

Below is a list of specific functions to this class :
	- @ref GL_CheckButton_Create : Creating a check button
...
<h2>Sample</h2>
	...
	@image html checkbuttonTest.png
	@include GL_SampleCheckButton.c
@}
*/

/*<ALL>
	Extension("CHECKBUTTON",       "WIDGET",     "A check button is an option button that can be switched on (checked) or off (unchecked)",
...
T_GL_HWIDGET GL_CheckButton_Create(T_GL_HWIDGET parent) GL_EXCEPTION;
...
#endif
#endif // GL_CheckButton_h_INCLUDED
