...
#define ERR_EP_000034						(0x07000034)	/*!< Entry Point error, __EntryPoint_ApplicationSelection_StateSelectWithPPSE, A mandatory icc data is missing (tag 0x84 or 0xBF0C). */
