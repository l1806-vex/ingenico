...
// \endif
extern int ExeSchAndWaitEnd(SEG_ID SchId_P,char *pSchName_P,int*codeexit,int p0,int p1,int p2,int p3);
//! @}
...
// \endif
extern int sch_init (SEG_ID Id_P , char *SchName_P, int arg1 , int arg2, int arg3 , int arg4 );
//! @}
...
//  @GSIM_A:3:ONE_POINTER
// \endif
extern int ExeSchAndWaitEndUsb(SEG_ID SchId_P,char *pSchName_P,int*codeexit,int p0,int p1,int p2,int p3);
//! @}
...
// \endif
extern int sch_initUsb (SEG_ID Id_P , char *SchName_P, int arg1 , int arg2, int arg3 , int arg4 );
//! @}
...
// \endif
extern int ExeSchAndWaitEndGeneric(unsigned char i_uc_type, SEG_ID SchId_P,char *pSchName_P,int*codeexit,int p0,int p1,int p2,int p3);
//! @}
...
// \endif
extern int sch_initGeneric (unsigned char i_uc_type, SEG_ID Id_P , char *SchName_P, int arg1 , int arg2, int arg3 , int arg4 );
//! @}
...
// \endif
extern int DllExeSchAndWaitEnd(SEG_ID SchId_P,char *pSchName_P,int*codeexit,int p0,int p1,int p2,int p3, char *ad_deb, char *ad_fin);
//! @}
...
//  @GSIM_A:3:ONE_POINTER
// \endif
extern int DllExeSchAndWaitEndUsb(SEG_ID SchId_P,char *pSchName_P,int*codeexit,int p0,int p1,int p2,int p3, char *ad_deb, char *ad_fin);
//! @}
...
//  @GSIM_A:4:ONE_POINTER
// \endif
extern int DllExeSchAndWaitEndGeneric(unsigned char i_uc_type, SEG_ID SchId_P,char *pSchName_P,int*codeexit,int p0,int p1,int p2,int p3, char *ad_deb, char *ad_fin);
//! @}
...
// \endif
extern int Dllsch_init (SEG_ID Id_P , char *SchName_P, int arg1 , int arg2, int arg3 , int arg4, char *ad_deb, char *ad_fin );
//! @}
...
// \endif
extern int Dllsch_initUsb (SEG_ID Id_P , char *SchName_P, int arg1 , int arg2, int arg3 , int arg4, char *ad_deb, char *ad_fin );
//! @}
...
// \endif
extern int Dllsch_initGeneric (unsigned char i_uc_type, SEG_ID Id_P , char *SchName_P, int arg1 , int arg2, int arg3 , int arg4, char *ad_deb, char *ad_fin );
//! @}
...
//  @GSIM_A:3:ONE_POINTER
// \endif
extern unsigned char ApduSubmitPin(FILE *Fd_P, T_APDU *C_apdu_L, T_APDU *R_apdu_L, int Format_P ,int LgPin_P);
//! @}
...
//  @GSIM_A:3:ONE_POINTER
// \endif
extern unsigned char ApduSubmitPinUsb(FILE *Fd_P, T_APDU *C_apdu_L, T_APDU *R_apdu_L, int Format_P ,int LgPin_P);
//! @}
...
// \endif
extern void purge ( SEG_ID *ne_pas_razer);
//! @}
...
// \endif
extern void purgeUsb ( SEG_ID *ne_pas_razer);
//! @}
...
// \endif
extern void purgeGeneric ( unsigned char i_uc_type, SEG_ID *ne_pas_razer );
//! @}
...
// \endif
extern void   SetPprState       (int connected); /* connected must be True to send the scheme to a PPR/PPC */
//! @}
...
//  @GSIM_A:3:DATA_SIZE(4)
// \endif
extern int    ExeSchAndWaitEnd_w(SEG_ID SchId_P,char *pSchName_P,int*codeexit,int p0,int p1,int p2,int p3);
//! @}
...
// \endif
extern int    sch_init_w        (SEG_ID Id_P , char *SchName_P, int arg1 , int arg2, int arg3 , int arg4 );
//! @}
...
// \endif
extern FILE * open_iapp         (char* mod);
//! @}
