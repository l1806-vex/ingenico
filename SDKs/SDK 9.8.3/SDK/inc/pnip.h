...
/*! @brief Number report. */
// @GSIM_T:CR_NUMEROTATION:DATA_CODE(sizeof(CR_NUMEROTATION))
typedef unsigned char CR_NUMEROTATION[2];

/*! @brief Structure STR_ETABL_CONNEX*/
// @GSIM_T:STR_ETABL_CONNEX:SUPPLIED(BUF_SER_STR_ETABL_CONNEX;BUF_DES_STR_ETABL_CONNEX)
typedef struct
{
...
*/
// \if SIMULATION
//  @GSIM_F:ipdu_de_write:KSFAM_CB2A:0x02
//  @GSIM_A:1:DATA_SIZE(lg)
//  @GSIM_A:1:IN_ONLY
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:ipdu_etab_ligne:KSFAM_CB2A:0x06
...
*/
// \if SIMULATION
//  @GSIM_F:ipdu_coup_ligne:KSFAM_CB2A:0x04
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:ipdu_dt_read:KSFAM_CB2A:0x03
//  @GSIM_A:1:DATA_CODE(*lg)
//  @GSIM_A:2:ONE_POINTER
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:ipdu_deconnecte:KSFAM_CB2A:0x05
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:ipdu_set_timer_effectif:KSFAM_CB2A:0x3D
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:ipdu_get_timer_effectif:KSFAM_CB2A:0x3E
// \endif
...
*/
// \if SIMULATION
//  @GSIM_F:ipdu_capacite_raccordement:KSFAM_CB2A:0x3F
// \endif
