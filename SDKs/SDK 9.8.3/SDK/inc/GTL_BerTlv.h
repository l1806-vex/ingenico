...
#define STATUS_BER_TLV_ERROR					2		/*!< Indicates an internal error occurred. */
...
#define BER_TLV_TAG_CLASS_MASK					0xc0	/*!< Mask to retrieve the tag class. */
...
#define BER_TLV_LENGTH_NUMBER_OF_BYTES_MASK		0x7f	/*!< Mask to retrieve the number of bytes used to encode the length. */
...
//! \brief Retrieve the class of a BER-TLV tag								
