...
/* @GSIM_T:StructRetourSocle:SUPPLIED(BUF_SER_StructRetourSocle;BUF_DES_StructRetourSocle) */
typedef struct
{
	//See constant above		
...
*/
// \if SIMULATION
//  @GSIM_F:GestionRetourSocle:KSFAM_AUTRES_MANAGER:0x80
...
*/
// \if SIMULATION
//  @GSIM_F:GestionSocle:KSFAM_AUTRES_MANAGER:0x81
//  @GSIM_A:1:ONE_POINTER
// \endif
