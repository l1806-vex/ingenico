...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	This function is used to create and manage overlapping menus.
...
#define UIM_NavigateService ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief		This function allows the input of an IP address (format: www.xxx.yyy.zzz).
 *	It returns to the calling application the entered IP address.
...
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_GetIpAddress ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function is used to get a date entered by the user within a configurable graphical interface. Several date formats are taken into account.
...
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_GetDate ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int UIM_GetDate
(
	char* i_pcTitle,
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function is used to get a time entered by the user within a configurable graphical interface. Several time formats are taken into account.
 *	@param[in]		  i_pcTitle				  The screen header.
...
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_GetTime ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int UIM_GetTime
(
	char* i_pcTitle,
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function is used to get credit card data within a configurable graphical interface.
...
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_GetManualEntry ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function is used to get a numeric entry within a configurable graphical interface.
...
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_GetNumericEntry ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function is used to get an alphanumerical entry within a configurable graphical interface.
...
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_GetAlphaNumEntry ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function is used to draw a text message within a configurable graphical interface.
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_DrawTextMessage ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function is used to draw a configurable screen: 4 lines, footer, bitmap, etc...
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_DrawScreen ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int UIM_DrawScreen
(
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function gets a numerical or an alpha numerical entry, several formats are supported.
...
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_InputValue ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int UIM_InputValue
(
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function sets the current font mode  : Normal, ISO8859 or Unicode.
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_SetFontMode ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int UIM_SetFontMode(int i_nFontMode, char * i_pcFileName) MACRO_DEPRECATED ;
#endif


/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function draws an extended string according to the graphical font mode : @c Normal , @c ISO8859 or @c Unicode.
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_DrawExtendedStringWithFont ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
void   UIM_DrawExtendedStringWithFont(char *message, int x0,int y0,int reverse,int police,int type) MACRO_DEPRECATED ;
#endif
...
/*! @brief AVL UIM will not be supported in Telium+ framework. Please use GOAL.
 * To continue to use this function add _DEPRECATED_AVL_SDK090200_ in you compilation defines.
 * @brief	 This function draws a window according to the graphical font mode : @c Normal , @c ISO8859, @c Unicode.
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define UIM_DrawWindowWithFont ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
void  UIM_DrawWindowWithFont(int left,int top,int rigth,int bottom,int thickness,unsigned char *Titre) MACRO_DEPRECATED ;
#endif
