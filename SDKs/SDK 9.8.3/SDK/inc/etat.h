...
#define VOLUME_REGISTER       "MGR_REG"   			/*!<  VOLUME pour RegisterPowerFailure */     
 ...
 * @param out : S_TRANSOUT structure
 * @return 
 * -  FCT_OK or STOP can be returned indifferently to the manager at the end of the application's treatment.
 *
 * @link KSFAM_M2OS Back to top @endlink
**/    
 ...
 *
 * @b Activation: Each time the operator VALIDATES the application to be deleted in the DELETION menu 
 *
 ...
 * extern int more_function (NO_SEGMENT no, S_ETATOUT_EXTENDED *in, void *out);\n
 * The struct S_ETATOUT_EXTENDED allows to know the name selected by the user after pressing key "F".
 *
 ...
 * @link KSFAM_M2OS Back to top @endlink
**/     
extern int is_name_extended(NO_SEGMENT no,void *in,S_ETATOUT_EXTENDED *out);

/*! @brief This function is used to inform application about end of sleep mode
 *
 * @b Activation: called when wake up at idle state
 *
 * @b Type:  @c ALL_DIFFUSION 
 *
 * @b Environment: don't use any peripherals
 * @param no  : application rank
 * @param in  : S_WAKE_UP structure
 * @param out : NULL pointer
 * @return 
 * -  FCT_OK
 * -  STOP   
 ...
 * @link KSFAM_M2OS Back to top @endlink
**/     
extern int wake_up(NO_SEGMENT no,S_WAKE_UP *in,void *out);

/*! @brief This function is used to manage manual entry selection 
 *
 * @b Activation: called when F2 key is pressed
 *
 * @b Type: 
 * -  @c SELECTING : only few applications are to be called (in case of application selection)
 *
 ...
 * @param no  : application rank
 * @param in  : NULL pointer
 * @param out : S_MANUAL_ENTRY structure
 * @return 
 * -  FCT_OK
 * -  STOP   
 *
 * @link KSFAM_M2OS Back to top @endlink
**/     
extern int manual_entry_extended(NO_SEGMENT no,void *in,S_MANUAL_ENTRY *out);
