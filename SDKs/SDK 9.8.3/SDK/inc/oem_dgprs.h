...
#define DGPRS_FIOCTL_EXTERNAL                           0x8000                          /*!< @deprecated Base of GPRS fioctl number. */
...
#define GPRS_Mount(a) ERROR_Deprecation_For_Module_DPRGS_SeeDocumentation_In_CHM_File;
