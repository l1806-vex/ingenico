...
#define mifareSAM_SelectApplication(a, b)          ERROR_Deprecation_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_VerifyMAC(a, b, c, d)            ERROR_Deprecation_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_GenerateMAC(a, b, c, d, e)       ERROR_Deprecation_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_DecipherData(a, b, c, d, e)      ERROR_Deprecation_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_EncipherData(a, b, c, d, e, f)   ERROR_Deprecation_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_AuthenticatePICCFirstPart(a, b, c, d, e, f, g, h, i, j)     ERROR_Deprecation_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_AuthenticatePICCSecondPart(a, b, c)                         ERROR_Deprecation_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_ChangeKeyPICC(a, b, c, d, e, f, g, h, i, j, k)              ERROR_Deprecation_For_MifareDLL_SeeDocumentation_In_CHM_File;
