...
#                  Compiler                        #
#--------------------------------------------------#
INCLUDES   = -I "$(SDK_SAMPLES_INC)" -I "$(SDK_INC)" -I ..\..\..\inc
SYSINC     = -B "$(GCC_INC)"
...
LIBS       = "$(SDK_LIB)\eft30.lib" "$(SDK_LIB)\SEC.lib" "$(SDK_LIB)\IAPP.lib" "$(SDK_LIB)\trap.lib" -L "$(GCC_LIB1)" -lc -L "$(GCC_LIB2)" -lgcc
...
"$(OBJ_DIR)\Secure.o" : "$(SOURCE_DIR)\Secure.c"
	@echo Compiling...Secure.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Secure.c"
