...
static T_GL_HWIDGET CreateBarcode(T_GL_HWIDGET parent)
{
	...
	GL_Barcode_SetMimeType(barcode, GL_MIME_BARCODE_CODE128);
	...
	GL_Barcode_SetValue(barcode, "CODE 128", strlen("CODE 128") + 1);
...
// sample function to display a barcode code 128
...
// sample function to print a barcode code 128
