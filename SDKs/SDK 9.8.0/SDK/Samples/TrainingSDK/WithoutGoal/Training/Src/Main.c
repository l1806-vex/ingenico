...
int Main(doubleword size, StructPt *data)
{
	...
	case IS_CHANGE_INIT :                 // Activated on "F" key: Initialisation->Parameters->List, Conditions for changing Manager parameters?
	...
	case MODIF_PARAM :                    // Activated on "F" key: Initialisation->Parameters->List, Manager reports parameters changed.
