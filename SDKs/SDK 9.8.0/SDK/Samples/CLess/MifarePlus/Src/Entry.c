...
int more_function( NO_SEGMENT no, void *p1, void *p2 )
{
    ...
    do
    {
        ...
        {
        case 0: Sample_MFP_SL3(); break;  // Function1 selected
        case 1: Sample_MFP_SL3_With_SAM(); break;  // Function2 selected
        case 2: Sample_MFP_SL2_With_SAM(); break;  // Function3 selected
