...
static T_GL_HWIDGET CreateBarcode(T_GL_HWIDGET parent)
{
	...
	GL_Barcode_SetMimeType(barcode, GL_MIME_BARCODE_EAN13);
	...
	GL_Barcode_SetValue(barcode, "013013013013", strlen("013013013013") + 1);
...
// sample function to print a barcode ean13
