...
static T_GL_HWIDGET CreateBarcode(T_GL_HWIDGET parent)
{
	...
	GL_Barcode_SetMimeType(barcode, GL_MIME_BARCODE_CODE39);
	...
	GL_Barcode_SetValue(barcode, "CODE 39", strlen("CODE 39") + 1);
...
// sample function to display a barcode code 39
...
// sample function to print a barcode code 39
