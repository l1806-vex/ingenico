...
void GL_SampleDialogIconMenu(T_GL_HGRAPHIC_LIB graphicLib)
{
	const char * menu [] =
	{
		...
		"Ten",    "file://flash/HOST/TU.TAR/icones/10.png",
		"Eleven", "file://flash/HOST/TU.TAR/icones/11.png",
		"Twelve", "file://flash/HOST/TU.TAR/icones/12.png",
	...
	result = GL_Dialog_IconMenu (graphicLib, "Menu", menu, 0, GL_BUTTON_DEFAULT, GL_KEY_0, GL_TIME_INFINITE);
}
