...
#define BACKLIGHT_FIOCTL_SET_STATE        	0x8001  /*!<  @deprecated You should use HWCNF_SetBacklightLevelEx API instead. To use this fioctl, you may define _DEPRECATED_BACKLIGHT_SDK96_. <br/> @brief.Set the backlight state (enabled/disabled) @param unsigned int * : \ref BACKLIGHT_ENABLE = enable backlight / \ref BACKLIGHT_DISABLE = disable backlight @return \ref BACKLIGHTFIOCTL_ERR */
...
#define BACKLIGHT_FIOCTL_SET_RGB_PWM      	0x8007  /*!<  @deprecated This fioctl has been parsed as unused in our survey. To use this fioctl, you may define _DEPRECATED_BACKLIGHT_SDK96_. <br/> @brief.Set RGB pwm param @param BACKLIGHT_RGB_PARAM_T *  */
