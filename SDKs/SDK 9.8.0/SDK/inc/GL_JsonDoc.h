...
@{
	...
	<table border=0 cellspacing=0 cellpadding=0><tr><td><a href="#ARROWBUTTON">ARROWBUTTON</a></td><td>The arrow button is used to display a button with an arrow</td></tr><tr><td><a href="#BARCODE">BARCODE</a></td><td>Widget to display a barcode</td></tr><tr><td><a href="#BUTTON">BUTTON</a></td><td>The button to command the terminal to perform some action, or to answer a question</td></tr><tr><td><a href="#CHECKBUTTON">CHECKBUTTON</a></td><td>A check button is an option button that can be switched on (checked) or off (unchecked)</td></tr><tr><td><a href="#DOCUMENT">DOCUMENT</a></td><td>The document allows the print of a document</td></tr><tr><td><a href="#DRAWING">DRAWING</a></td><td>the drawing widget is a surface on which the user can draw a graph</td></tr><tr><td><a href="#EDIT">EDIT</a></td><td>Widget that is used to edit a single line of text.</td></tr><tr><td><a href="#HSCROLLBAR">HSCROLLBAR</a></td><td>A scroll bar is a control that enables the user to access parts of a document that is larger than the widget used to display it</td></tr><tr><td><a href="#HSLIDER">HSLIDER</a></td><td>The slider is the classic widget for controlling a bounded value. It lets the user move a slider handle along groove and translates the handle's position into an integer value within the legal range</td></tr><tr><td><a href="#ICON">ICON</a></td><td>The class icon is equivalent to a button, it allows the display of an image more</td></tr><tr><td><a href="#ICONBUTTON">ICONBUTTON</a></td><td>The class icon button is equivalent to a button with an icon, it allows the display of an image more</td></tr><tr><td><a href="#INCLUDE">INCLUDE</a></td><td>This class is used include another resource file or use user control (WARNING this API is not final and may change in future)</td></tr><tr><td><a href="#LABEL">LABEL</a></td><td>This class is used to display text on a line or a multi-line text.</td></tr><tr><td><a href="#LAYOUT">LAYOUT</a></td><td>The layout can be viewed as a table with multiple rows and columns to place widgets</td></tr><tr><td><a href="#LIST">LIST</a></td><td>The list allows the display of all elements of widgets</td></tr><tr><td><a href="#MEDIA">MEDIA</a></td><td>This class is used to play movie or sound</td></tr><tr><td><a href="#PALETTE">PALETTE</a></td><td>A palette is a widget that can display a color palette</td></tr><tr><td><a href="#PICTURE">PICTURE</a></td><td>A picture is a widget that can display a fixed image or animated image</td></tr><tr><td><a href="#PLUGIN">PLUGIN</a></td><td>This class is used to play movie or sound</td></tr><tr><td><a href="#PRINT">PRINT</a></td><td>This class is used to print text on a line or a multi-line text</td></tr><tr><td><a href="#PROGRESSBAR">PROGRESSBAR</a></td><td>A progress bar is used to give the user an indication of the progress of an operation </td></tr><tr><td><a href="#RADIOBUTTON">RADIOBUTTON</a></td><td>A radio button is an option button that can be switched on (checked) or off (unchecked)</td></tr><tr><td><a href="#SCROLLVIEW">SCROLLVIEW</a></td><td>A scroll view is used to display the contents of many children widget within a frame</td></tr><tr><td><a href="#SIGNATURE">SIGNATURE</a></td><td>This class is used to play movie or sound</td></tr><tr><td><a href="#TIMER">TIMER</a></td><td>Repetitive timers</td></tr><tr><td><a href="#USERCONTROL">USERCONTROL</a></td><td>This class is used create a user control (WARNING this API is not final and may change in future)</td></tr><tr><td><a href="#VIRTUALKEYBOARD">VIRTUALKEYBOARD</a></td><td>The virtual keyboard allows easy entry of special characters</td></tr><tr><td><a href="#VSCROLLBAR">VSCROLLBAR</a></td><td>A scroll bar is a control that enables the user to access parts of a document that is larger than the widget used to display it</td></tr><tr><td><a href="#WINDOW">WINDOW</a></td><td>This widget allows management of a window on the screen</td></tr></table><br><b><a name="ARROWDIRECTION">ARROWDIRECTION enumeration, </a></b> Arrow direction, the different values used are : 
<table border=0 cellspacing=0 cellpadding=0>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"none"</td><td> : No arrow on the button</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"left"</td><td> : The arrow is displayed at left</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"right"</td><td> : The arrow is displayed at right</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"left,right"</td><td> : The arrow is displayed left and right</td></tr>
</table><br>
<b><a name="ARROWBUTTON">ARROWBUTTON object</a></b>, The arrow button is used to display a button with an arrow, the different elements that can be used in the object are : 
...
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"arrowdirection":</td><td><a href="#ARROWDIRECTION">ARROWDIRECTION</a>,</td><td>// Arrow direction</td></tr>
<tr><td>}</td></tr></table><br>
<b><a name="BARCODE_PARAM_INTEGER">BARCODE_PARAM_INTEGER object</a></b>, Define a barcode integer parameter, the different elements that can be used in the object are : 
<table border=0 cellspacing=0 cellpadding=0><tr><td>{</td></tr>
...
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"maxsize":</td><td><a href="#SIZE">SIZE</a>,</td><td>// Maximal size of the widget</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"minsize":</td><td><a href="#SIZE">SIZE</a>,</td><td>// Minimal size of the widget</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"text":</td><td><a href="#STRING">STRING</a>,</td><td>// Text displayed on the widget
Escapes sequences supported :
 ...
 - "\x1B\x??" : Set the forecolor or backcolor, see in documentations the colors value</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"font":</td><td><a href="#FONT">FONT</a>,</td><td>// Font used in display of text</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"wrap":</td><td><a href="#BOOL">BOOL</a>,</td><td>// The wrap allows text to automatically return to the line if it does not fit in width in the space allocated to it.</td></tr>
<tr><td>}</td></tr></table><br>
...
<table border=0 cellspacing=0 cellpadding=0><tr><td>[</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="#ARROWBUTTON">ARROWBUTTON</a>,</td><td>// This widget is a button with an arrow</td></tr>
...
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="#INCLUDE">INCLUDE</a>,</td><td>// This widget is used include another resource file or use user control.</td></tr>
...
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"text":</td><td><a href="#STRING">STRING</a>,</td><td>// Text printed on the widget
Escapes sequences supported :
 - "\x1B*" : Toggle in bold
 - "\x1B/" : Toggle in italic
 - "\x1B-" : Toggle in underline
...
<tr><td>}</td></tr></table><br>
<b><a name="INCLUDE">INCLUDE object</a></b>, This class is used include another resource file or use user control (WARNING this API is not final and may change in future), the different elements that can be used in the object are : 
<table border=0 cellspacing=0 cellpadding=0><tr><td>{</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"id":</td><td><a href="#INTEGER">INTEGER</a>,</td><td>// Id to identify single and unique widget</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"item":</td><td><a href="#ITEM">ITEM</a>,</td><td>// Location in the layout</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>"grow":</td><td><a href="#DIRECTION">DIRECTION</a>,</td><td>// Indicates that the widget can be growed (only in case if it is placed in a layout)</td></tr>
...
<table border=0 cellspacing=0 cellpadding=0><tr><td>[</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="#ARROWBUTTON">ARROWBUTTON</a>,</td><td>// This widget is a button with an arrow</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="#BARCODE">BARCODE</a>,</td><td>// This widget is a barcode</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="#BUTTON">BUTTON</a>,</td><td>// The button to command the terminal to perform some action, or to answer a question</td></tr>
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="#CHECKBUTTON">CHECKBUTTON</a>,</td><td>// A check button is an option button that can be switched on (checked) or off (unchecked)</td></tr>
