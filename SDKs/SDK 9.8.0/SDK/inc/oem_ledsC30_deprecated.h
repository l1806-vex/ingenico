...
#ifdef _DEPRECATED_LEDSC30_SDK96_
/*
======================================================================
					List of Defines
======================================================================
...
#define LEDS_C30_FIOCTL_CMD_STOP      (LEDS_C30_FIOCTL_EXTERNAL+1)		/*!< @deprecated stop led */
#define LEDS_C30_FIOCTL_CMD_START     (LEDS_C30_FIOCTL_EXTERNAL+2)		/*!< @deprecated start led */
#define LEDS_C30_FIOCTL_CMD_BLINK     (LEDS_C30_FIOCTL_EXTERNAL+3)		/*!< @deprecated start blink led */
#define LEDS_C30_FIOCTL_CMD_PWM     	(LEDS_C30_FIOCTL_EXTERNAL+4)		/*!< @deprecated start led using PWM */
#define LEDS_C30_FIOCTL_PN_TEST_MODE     	(LEDS_C30_FIOCTL_EXTERNAL+0x0A)		/*!< @deprecated configure LED using PN512 */
