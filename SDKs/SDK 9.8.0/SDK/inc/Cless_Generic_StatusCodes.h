...
#define CLESS_STATUS_UNKNOWN_TAG							0x0A0F		/*!< STATUS CODE - The requested tag is not known by Entry Point. */
...
#define CLESS_STATUS_EP_NOT_LOADED							0x0A17		/*!< STATUS CODE - Indicates that ENTRY POINT is not loaded into the terminal. */
...
#define CLESS_STATUS_EP_CLESS_SELECTION_NOT_ALLOWED			0x0A26		/*!< STATUS CODE - Indicates the contactless application selection is not allowed as the is no available AID for Entry Point and for List Of AID method (if it shares the EP preprocessing results). */
...
#define CLESS_STATUS_BAD_COMPONENT_INIT						0x0AFE		/*!< STATUS CODE - Indicates Entry Point has not been initialised correctly (global value init failed). */
