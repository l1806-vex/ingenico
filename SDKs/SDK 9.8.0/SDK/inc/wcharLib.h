...
*/
extern int wcslen(const TM_wchar_t *s);
...
*/
extern TM_wchar_t * wcschr(const TM_wchar_t *s,TM_wchar_t c);
...
*/
extern TM_wchar_t * wcsncpy(TM_wchar_t * s1,const TM_wchar_t * s2,size_t n);
...
*/
extern TM_wchar_t * wcscat(TM_wchar_t * s1,const TM_wchar_t * s2);
...
*/
extern int wcscmp(const TM_wchar_t * s1,const TM_wchar_t * s2);
...
*/
extern TM_wchar_t * wcscpy(TM_wchar_t * s1,const TM_wchar_t * s2);
...
*/
extern TM_wchar_t * wcsncat(TM_wchar_t * s1,const TM_wchar_t * s2,size_t n);
...
*/
extern int swprintf( TM_wchar_t *buffer,...);
