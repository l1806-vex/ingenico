...
#ifdef _DEPRECATED_ACCELERO_SDK98_
...
// List of all fioctl 
#define ACCELERO_FIOCTL_START             0x8000   /*!< @deprecated:This fioctl has been parsed as unused in our survey. It may no longer be supported in future releases. To use it, you may define _DEPRECATED_ACCELERO_SDK98_.<br/> @brief.param NULL : Start accelerometer */
#define ACCELERO_FIOCTL_STOP              0x8001   /*!< @deprecated:This fioctl has been parsed as unused in our survey. It may no longer be supported in future releases. To use it, you may define _DEPRECATED_ACCELERO_SDK98_.<br/> @brief.param NULL : Stop accelerometer */
#define ACCELERO_FIOCTL_GET_DRV_STATE     0x8002   /*!< @deprecated:This fioctl has been parsed as unused in our survey. It may no longer be supported in future releases. To use it, you may define _DEPRECATED_ACCELERO_SDK98_.<br/> @brief.param unsigned int* : Get driver state */
#define ACCELERO_FIOCTL_CONFIG_POWER      0x8003   /*!< @deprecated:This fioctl has been parsed as unused in our survey. It may no longer be supported in future releases. To use it, you may define _DEPRECATED_ACCELERO_SDK98_.<br/> @brief.param accelero_cfg_pwr_t* : Set accelerometer power configuration */
#define ACCELERO_FIOCTL_GET_POWER_CONFIG  0x8004   /*!< @deprecated:This fioctl has been parsed as unused in our survey. It may no longer be supported in future releases. To use it, you may define _DEPRECATED_ACCELERO_SDK98_.<br/> @brief.param accelero_cfg_pwr_t* : Get accelerometer power configuration */
#define ACCELERO_FIOCTL_SET_EVENT         0x8005   /*!< @deprecated:This fioctl has been parsed as unused in our survey. It may no longer be supported in future releases. To use it, you may define _DEPRECATED_ACCELERO_SDK98_.<br/> @brief.param unsigned int* : Set user event to report when accelerometer event  */
#define ACCELERO_FIOCTL_CLEAR_EVENT       0x8006   /*!< @deprecated:This fioctl has been parsed as unused in our survey. It may no longer be supported in future releases. To use it, you may define _DEPRECATED_ACCELERO_SDK98_.<br/> @brief.param NULL : Clear user event management */
#define ACCELERO_FIOCTL_GET_STATE         0x8007   /*!< @deprecated:This fioctl has been parsed as unused in our survey. It may no longer be supported in future releases. To use it, you may define _DEPRECATED_ACCELERO_SDK98_.<br/> @brief.param accelero_state_t* : Get accelerometer state */
