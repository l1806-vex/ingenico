// $Id: GL_Dir.h,v 1.1.2.5 2012/04/13 14:00:52 rbertholet Exp $
...
@addtogroup GL_Dir
@{
@addtogroup GL_DirDoc Directory
@{
...
/** Gets the current selected item path name (directory + filename + extension)
@param dir directory handle
@return name of current item */
const char * GL_Dir_GetPath(T_GL_HDIR dir) GL_EXCEPTION;

/** Gets the current selected item directory
@param dir directory handle
@return name of current item */
const char * GL_Dir_GetDirectory(T_GL_HDIR dir) GL_EXCEPTION;
