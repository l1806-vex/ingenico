...
#ifdef _DEPRECATED_SYSTEMFIOCTL_SDK96_
#define SYS_FIOCTL_GET_PRODUCT_SERIAL_NUMBER            0x8007		/*!< @deprecated This fioctl should not be called directly, use TM_GetSerialNumber API instead. To use it, you may define define _DEPRECATED_SYSTEMFIOCTL_SDK96_ in your application. 
...
//! @{
#ifdef _DEPRECATED_SYSTEMFIOCTL_SDK96_
#define SYS_FIOCTL_BOOSTER_GET_SECURITY_LEVEL  	 				0x8065 			/*!< @deprecated You should not call this fioctl directly, use TM_IsTerminalPeds API instead. To use it, you may define define _DEPRECATED_SYSTEMFIOCTL_SDK96_ in your application. 
...
//! @{
#ifdef _DEPRECATED_SYSTEMFIOCTL_SDK96_
#define SYS_FIOCTL_BOOSTER_DISABLE_YELLOW_DOT                   0x809C /*!< @deprecated You should not call directly this fioctl, call TM_DisableYellowDot API from the Manager instead. To continue to use the fioctl, you may define define _DEPRECATED_SYSTEMFIOCTL_SDK96_ in your application. 
