...
// Copyright (c) 2012 INGENICO , rue claude Chappe,
...
//!  Schemes to sign with your application: #NAM_STLV_CIPHER_DATA "STLCipherDa" for BL1,
//!											#NAM_TLV_CIPHER_DATA "TlvCipherDa" for BL2 and more
//!
//! \param[in] ptCipherKeyId :  Key Id of the ciphering key (cAlgoType defines the algorithm to use DES (TLV_TYPE_KDES) or TDES (TLV_TYPE_KTDES/TLV_TYPE_KTDES_24)
...
//! \par TEST CASE #3 :
//!	\verbatim  
//!	  Ciphering TDES Key (24 bytes) : (hex form) 7A52AB4C25C73440 6D3D162CBC978F3E 1011121314151617
//!	  Initial Vector (8 bytes) : 0102030405060708
//!	  Input data (deciphered data) (24 bytes) : 4E6F772069732074 68652074696D6520 666F7220616C6C20
//!	  Output data (ciphered data)  (24 bytes) : C5A1FDE55CD50F62 AA9E7BA7E9D68482 E025FC02F2E82C2E
//!	\endverbatim 
