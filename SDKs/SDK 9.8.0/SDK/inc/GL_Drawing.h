// $Id: GL_Drawing.h,v 1.1.2.45 2012/09/04 11:02:55 rbertholet Exp $
...
<h2>Sample</h2>
	...
	Below is an example of creating a window with a vectorized drawing surface. 

	@image html drawingTest.png
	@include GL_SampleDrawing.c

	Below is an example of creating a window with a not vectorized drawing surface. 
	@include GL_SampleDrawingNotVectorized.c
@}
*/
...
To know the size in pixels of a text, use the function: @ref GL_GraphicLib_GetTextSize.
...
IMPORTANT : The data drawed are lost if you resize the drawing. This command works only in non-vectorized mode (@ref GL_Drawing_SetVectorized with false parameter).
