...
/*!
* @brief AVL DRM will not be supported in Telium+ framework. Use file system functions instead (see sample in SDK/Samples/Training/Src/FFMS.c).
...
#define DRM_Init ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int DRM_Init (	char * i_pcPathName,	char * i_pcFileName,	unsigned int i_nDiskSize) MACRO_DEPRECATED ;
#endif
...
*/
#ifndef _DEPRECATED_AVL_SDK090200_
#define DRM_GetStatus ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int DRM_GetStatus (DRM_t_drm_status *o_sDrmStatus) MACRO_DEPRECATED ;
#endif
...
*/
#ifndef _DEPRECATED_AVL_SDK090200_
#define DRM_SaveData ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int DRM_SaveData (	unsigned int  i_uiLabelData,	void * i_pvData,	unsigned int i_nSizeData) MACRO_DEPRECATED ;
#endif
...
*/
#ifndef _DEPRECATED_AVL_SDK090200_
#define DRM_DeleteData ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int DRM_DeleteData (unsigned int  i_uiLabelData) MACRO_DEPRECATED ;
#endif
...
*/
#ifndef _DEPRECATED_AVL_SDK090200_
#define DRM_RestoreData ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int DRM_RestoreData ( unsigned int  i_uiLabelData , void * o_pvData,  int* o_pnSizeData) MACRO_DEPRECATED ;
#endif
