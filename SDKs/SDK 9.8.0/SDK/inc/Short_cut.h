...
* @note The data must be global and not in the heap 
* static Serv_short_cut_t s_shortcut
* void func(void)
* {
*   strcpy(s_shortcut.name_short_cut, "MyShorcut");
*   strcpy(s_shortcut.short_cut, "210");
*   s_shortcut.appli_id = Get_TypeCode(ApplicationGetCurrent());
*   s_shortcut.sap = tmsCall_shortcut;
*   ShortCutRegister(1, &s_shortcut);
* }
