...
SYSINC     = -B "$(GCC_INC)"
CCOPT      = -Os -Wall -Wcast-align -fshort-wchar -mthumb -mthumb-interwork -mlittle-endian -msoft-float -pipe -mcpu=arm920t -fomit-frame-pointer -fshort-enums -mstructure-size-boundary=8 -g -c
...
LIBS       = "$(SDK_LIB)\eft30.lib" "$(SDK_LIB)\trap.lib" -L "$(GCC_LIB1)" -lc -L "$(GCC_LIB2)" -lgcc
...
#                  Build                           #
#--------------------------------------------------#
OBJ        =	"$(OBJ_DIR)\Entry.o" "$(OBJ_DIR)\Main.o" "$(OBJ_DIR)\Test.o" "$(OBJ_DIR)\English.o"
...
"$(OBJ_DIR)\Main.o" : "$(SOURCE_DIR)\Main.c"
	...
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Main.c"

"$(OBJ_DIR)\English.o" : "$(SOURCE_DIR)\English.c"
	@echo Compiling... English.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\English.c"

"$(OBJ_DIR)\Test.o" : "$(SOURCE_DIR)\Test.c"
	@echo Compiling... Test.c
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Test.c"