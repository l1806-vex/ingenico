...
const unsigned char   item0  [20] = {"Set Configuration "};
const unsigned char   item1  [20] = {"Get Configuration "};
const unsigned char   item2  [20] = {"List the secrets  "};
const unsigned char   item3  [20] = {"Create Secret Area"};
const unsigned char   item4  [20] = {"Free a Secret     "};
const unsigned char   item5  [20] = {"Load ROOT Key     "};
const unsigned char   item6  [20] = {"Load Pin Keys     "};
const unsigned char   item7  [20] = {"Load MAC Keys     "};
const unsigned char   item8  [20] = {"Pin Entry         "};
const unsigned char   item9  [20] = {"Encipher PIN      "};
const unsigned char   item10 [20] = {"MAC Calculation   "};
const unsigned char   result [20] = {"Result ?"};


const NavigationItems mylist1 [ITEMS_M1] =
{ 
  {(char *)item0, NULL, 0, (PFONCNAVI) SetConfigSecurity}, 
  {(char *)item1, NULL, 0, (PFONCNAVI) GetConfigSecurity}, 
  {(char *)item2, NULL, 0, (PFONCNAVI) ListSecretAreas}, 
  {(char *)item3, NULL, 0, (PFONCNAVI) CreateSecretAreas}, 
  {(char *)item4, NULL, 0, (PFONCNAVI) FreeSecret}, 
  {(char *)item5, NULL, 0, (PFONCNAVI) LoadRootKey}, 
  {(char *)item6, NULL, 0, (PFONCNAVI) LoadPinKeys}, 
  {(char *)item7, NULL, 0, (PFONCNAVI) LoadMACKeys}, 
  {(char *)item8, NULL, 0, (PFONCNAVI) PinEntry}, 
  {(char *)item9, NULL, 0, (PFONCNAVI) EncipherPin}, 
  {(char *)item10, NULL, 0,(PFONCNAVI) MacCalculation}, 
};
...
FILE  *hdPrinter;
	...
	if (hdPrinter != NULL)
	{
	   ...
	   pprintf  ("Vers. : %s\n",       Get_AppliName(noappli));
       pprintf  ("Type  : %X (hex)\n", Get_TypeCode (noappli));
	   pprintf  ("Crc   : %04X\n",     Get_AppliCrc (noappli));
	   pprintf  ("@Code : %08X\n",     Get_AppliCode(noappli));
	   pprintf  ("@Data : %08X\n\n\n", Get_AppliData(noappli));
...
char           buffer[30];
    ...
    Menu.tab[1] = (unsigned char *)item1;
    Menu.tab[2] = (unsigned char *)item2;
    Menu.tab[3] = (unsigned char *)item3;
    Menu.tab[4] = (unsigned char *)item4;
    Menu.tab[5] = (unsigned char *)item5;
    Menu.tab[6] = (unsigned char *)item6;
    Menu.tab[7] = (unsigned char *)item7;
    Menu.tab[8] = (unsigned char *)item8;
    Menu.tab[9] = (unsigned char *)item9;
    Menu.tab[10] = (unsigned char *)item10;
