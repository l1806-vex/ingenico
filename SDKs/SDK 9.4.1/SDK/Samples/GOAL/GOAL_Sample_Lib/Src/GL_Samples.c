...
static void GL_Samples_MenuWidgetGraphical(T_GL_HGRAPHIC_LIB  graphicLib)
{
	...
	do
	{
		...
		case 7 : GL_SampleBarcode   (graphicLib); break;
...
void  GL_Samples_Menu(T_GL_HGRAPHIC_LIB  graphicLib)
{
	...
	do
	{
		...
		case 7  : GL_Samples_MenuWidgetList       (graphicLib); break;
		case 8  : GL_Samples_MenuWidgetBar        (graphicLib); break;
		case 9  : GL_Samples_MenuWidgetOther      (graphicLib); break;
		case 10 : GL_SampleAllWidgets             (graphicLib); break;
		case 11 : GL_TutorialSteps_Menu           (graphicLib); break;
		}
	}
	while(choice != GL_KEY_CANCEL);
}
