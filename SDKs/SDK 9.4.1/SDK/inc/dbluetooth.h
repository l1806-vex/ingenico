 ...
 *
 * Introduction to Bluetooth handhelds and cradles interoperability.
 *
...
#define DBLUETOOTH_FIOCTL_LEARN_ISMP_CRADLE (DBLUETOOTH_FIOCTL_EXTERNAL + 0x0F)		/*!< Request association with an iSMP base, only its BT_address is known */
...
#define DBLUETOOTH_FIOCTL_GET_COM1_FORCE_USB (DBLUETOOTH_FIOCTL_EXTERNAL + 0x22)		/*!< Is COM1 configured to use only InfraRed(930)/USB(iWL) link ? */
#define DBLUETOOTH_FIOCTL_SET_COM1_FORCE_USB (DBLUETOOTH_FIOCTL_EXTERNAL + 0x23)		/*!< Set COM1 to work on InfraRed(930)/USB(iWL) only or not */
...
#define DBLUETOOTH_FIOCTL_GET_COMN_FORCE_USB (DBLUETOOTH_FIOCTL_EXTERNAL + 0x30)		/*!< Is COMN configured to use only InfraRed(930)/USB(iWL) link ? */
#define DBLUETOOTH_FIOCTL_SET_COMN_FORCE_USB (DBLUETOOTH_FIOCTL_EXTERNAL + 0x31)		/*!< Set COMN to work on InfraRed(930)/USB(iWL) only or not */
...
#define DBLUETOOTH_FIOCTL_GET_MODEM_IS_CDC   (DBLUETOOTH_FIOCTL_EXTERNAL + 0x42)		/*!< Is MODEM configured to work on a plain P base (not a smart one) ? */
#define DBLUETOOTH_FIOCTL_SET_MODEM_IS_CDC   (DBLUETOOTH_FIOCTL_EXTERNAL + 0x43)		/*!< Set MODEM to work on plain P base, or not (restart required to be taken into account) */
#define DBLUETOOTH_FIOCTL_GET_MODEM_FORCE_USB (DBLUETOOTH_FIOCTL_EXTERNAL + 0x44)		/*!< Is MODEM configured to use only InfraRed(930)/USB(iWL) link ? */
#define DBLUETOOTH_FIOCTL_SET_MODEM_FORCE_USB (DBLUETOOTH_FIOCTL_EXTERNAL + 0x45)		/*!< Set MODEM to work on InfraRed(930)/USB(iWL) only or not */
...
#define DBLUETOOTH_FIOCTL_GET_BASE_INFOS         (DBLUETOOTH_FIOCTL_EXTERNAL + 0x56)		/*!< Request to get infos about the cradle we are docked on ; parameter is pointeur to inter_uc_sp_options_public_base_s */
...
#define DBLUETOOTH_FIOCTL_GET_COMU_FORCE_USB (DBLUETOOTH_FIOCTL_EXTERNAL + 0x92)		/*!< Is COMU configured to use only USB link ? */
#define DBLUETOOTH_FIOCTL_SET_COMU_FORCE_USB (DBLUETOOTH_FIOCTL_EXTERNAL + 0x93)		/*!< Set COMU to work on USB only or not */
