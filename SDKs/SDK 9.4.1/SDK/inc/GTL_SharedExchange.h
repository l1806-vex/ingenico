...
#define STATUS_SHARED_EXCHANGE_ERROR				2		/*!< Indicates an internal error occured. */
...
//! <tr><td>\ref STATUS_SHARED_EXCHANGE_ERROR</td><td>An internal error occured.</td></tr>
//! </table>
...
//!		- NULL if an error occured (not enough memory).
