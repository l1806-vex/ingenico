...
#define BUZZER_FIOCTL_CMD_STOP      (BUZZER_FIOCTL_EXTERNAL+1)		/*!< stop buzzer (use BUZZER_FIOCTL_T parameter) */
#define BUZZER_FIOCTL_CMD_START     (BUZZER_FIOCTL_EXTERNAL+2)		/*!< start buzzer (use BUZZER_FIOCTL_T parameter) */
#define BUZZER_FIOCTL_CMD_CONFIGURE_BEEP_ON_PIN_ENTRY     (BUZZER_FIOCTL_EXTERNAL+3)		/*!< configure buzzer on pin entry. only for IWL350 (use BUZZER_FIOCTL_BEEP_ON_PIN_ENTRY_T parameter) */
