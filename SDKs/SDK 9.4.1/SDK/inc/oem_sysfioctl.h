...
#define SYS_FIOCTL_SET_SYSTEM_SAV						0x8038 			/*!< Internal use only. Set the sav sytem status  (Thunder 2)
...
#define SYS_FIOCTL_GET_SYSTEM_SAV						0x8039 			/*!< Internal use only. Get the sav sytem status (Thunder 2)
...
#define SYS_FIOCTL_GET_READER_INFORMATION						0x80A1 /*!< Give information about External Reader
																			@param SYS_FIOCTL_PINPAD_DEF * *  pointer to struct of reader features
																			@return 0: OK*/
//! @}

#define SYS_FIOCTL_GET_HORS_SERVICE_BUTTON_STATE				0x80A2 /*!< Give information about the "Out of Order" switch (iUP250/iUR250)
																			@param unsigned char * : 0=Released 1=Pressed 255=Not Available
																			@return 0: OK*/

#define	SYS_FIOCTL_MOUNT_NIL_DEVICE								0x80A3 /*!< Mount Nil Device  */	

#define SYS_FIOCTL_GET_KEY_JAMMED_INFO							0x80A4 /*!< Look if a key is jammed on the keyboard
...
//! \addtogroup SYSFIOCTL_PCI_FIRMWARE
//! @{
#define SYS_FIOCTL_GET_READER_PCI_CORE_REQUIREMENTS_FIRMWARE			0x80A5  /*!< Get External Reader PCI Core Requirements firmware version  -> ex:"820514v01.01".
																			@param char[16]
																			@return 
																			\li 0 : OK
																			\li -1 : not supported
...
#define	SYS_FIOCTL_SET_MODE_LEVER_LOCK									0x80A6 /*!< Activate/Desactivate Lever Lock on iUR250
...
#define SYS_FIOCTL_GET_CPU_CHARGE						0x80A7 /*!< Give information about External Reader
																			@param NULL
...
#define SYS_FIOCTL_CONFIGURE_PROXY  							0x80A8 /*!< Configure system to automaticaly use a SOCKS proxy in TCP connection
...
#define  SYS_FIOCTL_SET_WAKEUP_EVENT                   0x810C /*!< Fioctl used to send an event when the terminal wakes up using SetNextWakeUp.
...
#define  SYS_FIOCTL_SET_LOWPOWER_EXIT_EVENT            0x8116 /*!< Fioctl used to send an event when the terminal exits from low power mode.
...
#define SYS_FIOCTL_USB_HOST_BSD_GET_LAST_HUB_SPEED      0x82F1 /*!< make a usb BSD host ioctl to get the last plugged hub speed (used by PROD tests) iSC250/350 */
...
#define SYS_FIOCTL_USB_HOST_BSD_GET_LAST_HUB_DCNX       0x82F2 /*!< make a usb BSD host ioctl to get the last plugged hub number of deconncetions (used by PROD tests) iSC250/350 */

#define SYS_FIOCTL_USB_HOST_BSD_DLLWIFI                 0x82F3 /*!< make a usb BSD host DLL WIFI ioctl */
...
//! \addtogroup SYSTEMFIOCTL_CMD
//! @{
#define SYS_FIOCTL_SND_SWITCH									0x8315 /*!< switch between primary and secondary sound output */
...
#define SYS_FIOCTL_IS_AUDIO_AVAILABLE			               	0x8410 
#define SYS_FIOCTL_AUDIO_SET_VOLUME			               		0x8411
#define SYS_FIOCTL_AUDIO_SET_ATTENUATION						0x8412
#define SYS_FIOCTL_AUDIO_PLAY_OGG			               		0x8420
#define SYS_FIOCTL_AUDIO_PLAY_OGG_WITH_VOL	             		0x8421
