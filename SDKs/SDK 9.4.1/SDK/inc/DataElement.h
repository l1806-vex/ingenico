...
#ifndef __DATABASE_ELEMENT_H__INCLUDED__
#define __DATABASE_ELEMENT_H__INCLUDED__
 ...
 **/
T_ET_STATUS Et_Init(T_DATA_ELEMENT* pDataElement, void* pBuffer, unsigned long ulBufferSize, T_ET_TAG Tag, T_ET_LENGTH Length) AVL_DEPRECATED ;
/*! \brief Initialise a data element.
 ...
 **/
T_ET_STATUS Et_Initialise(T_DATA_ELEMENT* pDataElement, void* pBuffer, unsigned long ulBufferSize, T_ET_TAG Tag, T_ET_LENGTH Length) AVL_DEPRECATED ;
 ...
 *	- \a EtInvalidParameter/EtNotEnoughSpace if not.
 **/
T_ET_STATUS Et_InitEx(T_DATA_ELEMENT* pDataElement, void* pBuffer, unsigned long ulBufferSize, T_ET_TAG Tag, T_ET_LENGTH Length, const void* pValue) AVL_DEPRECATED ;
 ...
 **/
T_ET_STATUS Et_Tag(const T_DATA_ELEMENT* pDataElement, T_ET_TAG* pTag) AVL_DEPRECATED ;
 ...
 *	- \a EtInvalidParameter/EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_Length(const T_DATA_ELEMENT* pDataElement, T_ET_LENGTH* pLength) AVL_DEPRECATED ;
 ...
 *	- \a EtInvalidParameter/EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_Value(const T_DATA_ELEMENT* pDataElement, const void** pValue) AVL_DEPRECATED ;
 ...
 *	- \a EtInvalidParameter/EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_GetDataElementBuffer(const T_DATA_ELEMENT* pDataElement, const void** pBuffer, unsigned long* pLength) AVL_DEPRECATED ;
 ...
 *	- \a EtInvalidParameter/EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_GetBuffer(const T_DATA_ELEMENT* pDataElement, T_ET_POSITION Position, const void** pBuffer) AVL_DEPRECATED ;
 ...
 *	- \a EtInvalidParameter/EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_Add(T_DATA_ELEMENT* pDataElement, T_ET_TAG Tag, T_ET_LENGTH Length, const void* pValue) AVL_DEPRECATED ;
 ...
 *	- \a EtInvalidParameter/EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_AddElement(T_DATA_ELEMENT* pDataElement, const T_DATA_ELEMENT* pSource) AVL_DEPRECATED ;
 ...
 *	- \a EtInvalidParameter/EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_ModifyTag(T_DATA_ELEMENT* pDataElement, T_ET_POSITION Position, T_ET_TAG Tag, T_ET_LENGTH Length, const void* pValue) AVL_DEPRECATED ;
 ...
 **/
T_ET_STATUS Et_GetFirstPosition(const T_DATA_ELEMENT* pDataElement, T_ET_POSITION* pPosition) AVL_DEPRECATED ;
 ...
 **/
T_ET_STATUS Et_GetNext(const T_DATA_ELEMENT* pDataElement, T_ET_POSITION* pPosition, T_ET_TAG* pTag, T_ET_LENGTH* pLength, const void** pValue) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_GetCurrent(const T_DATA_ELEMENT* pDataElement, T_ET_POSITION Position, T_ET_TAG* pTag, T_ET_LENGTH* pLength, const void** pValue) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_FindNext(const T_DATA_ELEMENT* pDataElement, T_ET_POSITION* pPosition, T_ET_TAG Tag, T_ET_LENGTH* pLength, const void** pValue, T_ET_POSITION* pTagPosition) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_SearchNext(const T_DATA_ELEMENT* pDataElement, T_ET_POSITION* pPosition, T_ET_TAG Tag, T_ET_TAG IndexTag, T_ET_LENGTH IndexLength, const void* pIndexValue, T_ET_LENGTH* pLength, const void** pValue, T_ET_POSITION* pTagPosition) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_RemoveCurrent(T_DATA_ELEMENT* pDataElement, T_ET_POSITION* pPosition) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_RemoveTag(T_DATA_ELEMENT* pDataElement, T_ET_TAG Tag) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_RemoveAll(T_DATA_ELEMENT* pDataElement) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_CheckConsistency(const T_DATA_ELEMENT* pDataElement) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_AddToDel(const T_DATA_ELEMENT* pDataElement, DEL* pDel, int bSecDel) AVL_DEPRECATED ;
 ...
 *	- \a EtProcessingError if an error occurs.
 **/
T_ET_STATUS Et_AddDel(T_DATA_ELEMENT * pDataElement, const DEL* pDel) AVL_DEPRECATED ;
#endif
#endif
...
#endif // __DATABASE_ELEMENT_H__INCLUDED__
