#ifndef __XML_EXPAT_H__
#define __XML_EXPAT_H__

//
// Types definitions and enum
//
...
// API functions
//
int XMLlib_open( void );
void XMLlib_close( void );
