// $Id: GL_Label.h,v 1.1.2.41 2012/06/11 07:26:16 rbertholet Exp $
// Label management
...
<h2>Sample</h2>
	...
	Below is an example of creating a blank window with a text label.

	@image html labelTest.png
	@include GL_SampleLabel.c

	Below is an example of creating a blank window with different font size.

	@image html labelTest2.png
	@include GL_SampleFont.c

	Below is an example of creating a blank window with a text label in utf8.

	@image html labelTest3.png
	@include GL_SampleLabelUtf8.c

	Below is an example of creating a blank window with a wrapped text. 

	@image html scrollText.png
	@include GL_SampleScrollText.c

	Below is an example of creating a blank window with different font style.
