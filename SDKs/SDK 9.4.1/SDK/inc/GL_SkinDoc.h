...
<tr><td><b>Main files</b></td><td>These files are mandatory and must have the same name and location in the archive of the skin</td></tr>
		...
		<tr><td>&nbsp;&nbsp;&nbsp; keymap.js              </td><td> This file contains all the keyboard mappings for different terminals. See @ref GL_SkinKeymapJs</td></tr>
...
****************************************************************************************
****************************************************************************************
@addtogroup GL_SkinKeymapJs Skin keymap.js file
@{


The keymap.js file allows for the association between the physical keyboard keys and virtual keys used by GOAL.
It allows defining keys for cyclic alphabetic characters. It should not normally be changed.
The file must contain all the mappings of all terminal keyboards, if a terminal is forgotten in this file the keyboard handling is defective.

See @ref GL_TypesTerminal to know the ?strings values ?of terminal types. 
To know the exact terminal type of your terminal using the function GL_GraphicLib_GetTerminalType.
The file associates the press of a telium key to one or more virtual key.

For the number keys are placed more characters in the virtual key, the first character of the list should always be the number itself.
If no association is made ??the telium key will be sent as is.

It is important to note that goal requires that at least the following keys are defined :
	- @ref GL_VIRTUAL_KEY_PREVIOUS : Pass the focus to previous widget
	- @ref GL_VIRTUAL_KEY_NEXT : Pass the focus to next widget
	- @ref GL_VIRTUAL_KEY_LEFT : Moves the cursor to the left in the widget that has focus 
	- @ref GL_VIRTUAL_KEY_RIGHT : Moves the cursor to the right in the widget that has focus

To know the key codes see Telium @ref GL_TypesKeys.
...
@code
{
	...
	// Terminal type string, here is the mapping for the terminal iPP480
	"iPP480"   : 
	{
		// Telium   : Virtual
		// Key        Key
		"0"         : "0 +\"_'",   // GL_KEY_0    -> "0 +\"_'"
		"1"         : "1qzQZ",     // GL_KEY_1    -> "1qzQZ"
		"2"         : "2abcABC",   // GL_KEY_2    -> "2abcABC"
		"3"         : "3defDEF",   // GL_KEY_3    -> "3defDEF"
		"4"         : "4ghiGHI",   // GL_KEY_4    -> "4ghiGHI"
		"5"         : "5jklJKL",   // GL_KEY_5    -> "5jklJKL"
		"6"         : "6mnoMNO",   // GL_KEY_6    -> "6mnoMNO"
		"7"         : "7prsPRS",   // GL_KEY_7    -> "7prsPRS"
		"8"         : "8tuvTUV",   // GL_KEY_8    -> "8tuvTUV"
		"9"         : "9wxyWXY",   // GL_KEY_9    -> "9wxyWXY"
		"."         : ".,-:?@",    // GL_KEY_DOT  -> ".,-:?@"
		"\uF859"    : "\uF81B",    // GL_KEY_UP   -> GL_VIRTUAL_KEY_PREVIOUS
		"\uF85A"    : "\uF81C",    // GL_KEY_DOWN -> GL_VIRTUAL_KEY_NEXT
		"\uF856"    : "\uF81B",    // GL_KEY_F2   -> GL_VIRTUAL_KEY_PREVIOUS
		"\uF857"    : "\uF81C",    // GL_KEY_F3   -> GL_VIRTUAL_KEY_PREVIOUS
		// ... etc ...
	},
