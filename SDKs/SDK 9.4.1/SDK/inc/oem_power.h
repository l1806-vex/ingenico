...
#define PWR_FIOCTL_IS_BACKLIGHT_WAKEUP_SUPPORTED 0x8045       /*!< no parameter : Is the backlight wakeup supported ? NULL=YES -2=NO */
#define PWR_FIOCTL_IS_LOWPWR_SUPPORTED          0x8046        /*!< no parameter : Is the low power mode supported ? 0=YES -2=NO */
...
#define PWR_FIOCTL_SET_PWRDWN_THRESHOLD         0x804B        /*!< param unsigned int : battery level form 0 to 100
...
#define PWR_FIOCTL_IS_LOWPWR_ON_CRADLE_SUPPORTED  0x804C        /*!< param unsignet int : Is the low power mode on cradle supported ? 0=YES -2=NO */

#define PWR_FIOCTL_SET_LOWPWR_ON_CRADLE_STATE     0x804E        /*!< param unsigned int : Enable or disable lowpower on cradle (iWL only)*/

#define PWR_FIOCTL_GET_LOWPWR_ON_CRADLE_STATE     0x804F        /*!< param unsigned int : Get the lowpower on cradle state (iWL only). */


#define PWR_FIOCTL_GET_AAM_VOLTAGE              0x8050        /*!< param unsigned int : ISMP only permit to read Cless antenna voltage
                                                                   in factory process */

#define PWR_FIOCTL_IS_SHUTDOWN_MODE_SUPPORTED  	  0x8051     /*!< param unsignet int nMode*/
...
#define PWR_LOWPWR_STATE_ON		  		 		1		/*!< value for \ref PWR_FIOCTL_GET_CHARGER_STATE , \ref PWR_FIOCTL_SET_LOWPWR_STATE , \ref PWR_FIOCTL_SET_LOWPWR_ON_CRADLE_STATE and \ref PWR_FIOCTL_GET_LOWPWR_ON_CRADLE_STATE  : lowpower is enabled */
#define PWR_LOWPWR_STATE_OFF  					0		/*!< value for \ref PWR_FIOCTL_GET_CHARGER_STATE , \ref PWR_FIOCTL_SET_LOWPWR_STATE , \ref PWR_FIOCTL_SET_LOWPWR_ON_CRADLE_STATE and \ref PWR_FIOCTL_GET_LOWPWR_ON_CRADLE_STATE : lowpower is disabled */
...
#define PWR_SHUTDOWN_MODE_AUTOMATIC 1					/*!< automatic shutdown enabled  . value for PWR_FIOCTL_SET_SHUTDOWN_MODE // PWR_FIOCTL_IS_SHUTDOWN_MODE_SUPPORTED */
#define PWR_SHUTDOWN_MODE_MANUAL	2					/*!< automatic shutdown disabled . value for PWR_FIOCTL_SET_SHUTDOWN_MODE // PWR_FIOCTL_IS_SHUTDOWN_MODE_SUPPORTED */
