...
typedef struct S_MIFARE_SAM_CONTEXT T_MIFARE_SAM_CONTEXT; //!< Type associated to \ref S_MIFARE_SAM_CONTEXT
...
//! This command automatically calls \ref mifareSAM_SelectApplication if SAM is used.
//! \param[in,out] pContext Pointer to the application context.
...
extern int mifareSAM_VerifyMAC(T_MIFARE_SAM_CONTEXT* pSAMCtx, int iDataLen,
      unsigned char *pData, int iMacLen);
...
extern int mifareSAM_EncipherData(T_MIFARE_SAM_CONTEXT* pSAMCtx,
      ...
      int *piCipheredDataLen, unsigned char *pCipheredData);
...
extern int mifareSAM_AuthenticatePICCSecondPart(T_MIFARE_SAM_CONTEXT* pSAMCtx,
      int iDataLen, unsigned char *pData);
...
extern int mifareSAM_ChangeKeyPICC(T_MIFARE_SAM_CONTEXT* pSAMCtx,
      ...
      unsigned char *pDivInp, int *piDataLen, unsigned char *pData);
