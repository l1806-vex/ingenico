...
/*! @addtogroup VGE_DRM
 * @{
	* @deprecated	DRM is deprecated since SDK 9.2. Use file system functions instead (see sample in SDK/Samples/Training/Src/FFMS.c)	
...
/*! @deprecated Structure describing the status of the <b>Data Recover Management module (DRM)</b>. **/
typedef struct
{
...
} DRM_t_drm_status AVL_DEPRECATED ;
...
/*!
* @deprecated	This function initializes the <b>Data Recover Management module (DRM)</b>.
...
*/
int DRM_Init (	char * i_pcPathName,	char * i_pcFileName,	unsigned int i_nDiskSize) AVL_DEPRECATED ;


/*!
* @deprecated	This function gets the status of the @b DRM module: <i> FileName, PathName, File size, Number of data saved, Data ID list</i>
...
* @link VGE_DRM Back to top @endlink	
*/
int DRM_GetStatus (DRM_t_drm_status *o_sDrmStatus) AVL_DEPRECATED ;


/*!
* @deprecated	This function saves a data value in the flash memory and enables the recovery of its contents.
...
* @link VGE_DRM Back to top @endlink	
*/
int DRM_SaveData (	unsigned int  i_uiLabelData,	void * i_pvData,	unsigned int i_nSizeData) AVL_DEPRECATED ;


/*!
* @deprecated	This function deletes a data value (already saved by #DRM_SaveData) from the flash memory and disables the recovery of its contents 
...
* @link VGE_DRM Back to top @endlink		
*/
int DRM_DeleteData (unsigned int  i_uiLabelData) AVL_DEPRECATED ;


/*!
* @deprecated	This function enables the recovery of the data value saved by #DRM_SaveData in the flash memory.
...
* @link VGE_DRM Back to top @endlink	
*/
int DRM_RestoreData ( unsigned int  i_uiLabelData , void * o_pvData,  int* o_pnSizeData) AVL_DEPRECATED ;
