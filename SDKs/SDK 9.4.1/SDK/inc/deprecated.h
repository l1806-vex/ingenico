...
#ifdef _DEPRECATED_SDK94_


/*! @brief This function must not be used by application
*
 *  @deprecated For compatibility purpose only, if you want to continue to use this function, you have to add the compilation directive _DEPRECATED_SDK94_
 *
*/
