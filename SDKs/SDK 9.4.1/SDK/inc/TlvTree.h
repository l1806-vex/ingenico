 ...
 * @name TLV Tree deprecated elements
 *  @{ **/
#ifdef _DEPRECATED_TLVTREE_SDK65_
// Function: TlvTree_RemoveChild

/*! @brief This function removes a child from an existing parent TLV tree.
 *  This function is deprecated, use \ref TlvTree_Release instead.
 *  @param hParent parent TLV tree
 *  @param hNode child TLV tree to be removed
 *  @return
 *  - 0 on success
 *  - a negative value otherwise
 *  @deprecated This function is deprecated since SDK6.5, use \ref TlvTree_Release instead.\n
 *  However, if you want to continue temporarily to use this function, you have to add the compilation directive _DEPRECATED_TLVTREE_SDK65_
 *  
 *  @link DOC_TLVTREE Back to top @endlink **/
