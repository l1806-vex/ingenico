...
#define CAM_FIOCTL_WARM_RESET          CAM_XX_FIOCTL_EXTERNAL+12	   /*!< Command to issue a warm reset : available only in ISO7816 mode (use power_on function) 
                                                                          @param (CAM_FIOCTL_WARM_RESET_S *) */
                                                                          
#define CAM_FIOCTL_SET_CUSTOM_ATR      CAM_XX_FIOCTL_EXTERNAL+13	   /*!< Command to overwrite the current card ATR by a custom ATR : available only in ISO7816 mode (use power_on function)
                                                                          @param (CAM_FIOCTL_SET_CUSTOM_ATR_S *) */


/*! @brief structure used with CAM_FIOCTL_SET_CUSTOM_ATR fioctl : Used to overwrite the current card ATR by a custom ATR */
typedef struct
{
...
/*! @brief structure used with CAM_FIOCTL_WARM_RESET fioctl : Used to issue a warm reset */
typedef struct
{
	int            status;                 /*!< (output) level 1 status */
