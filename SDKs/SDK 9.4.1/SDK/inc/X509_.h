 ...
 *	@link KSFAM_X509 Back to top @endlink
 **/
int X509_GetInfo(const void * x509, int informationType, int field, char * buffer, int buflen);
 ...
 *	@link KSFAM_X509 Back to top @endlink
 **/
int X509_CrlGetInfo(X509_CRL_HANDLE x509, int informationType, int nid, char * buffer, int buflen);
