...
/*! @addtogroup VGE_BLM
 * @{
	* @deprecated	BLM is deprecated since SDK 9.2.	
...
/*! @deprecated PAN structure. 
*/
typedef struct
{
	unsigned char ucPan [BLM_MAX_LEN_PAN] ;									/*!< Primary Account Number. */	
} BLM_t_pan AVL_DEPRECATED ;


/*! @deprecated Range structure. */
typedef struct
{
...
} BLM_t_range AVL_DEPRECATED ;


/*! @deprecated Black List Element structure. 
 *  */
typedef struct
{
...
} BLM_t_elt_black_list AVL_DEPRECATED ;


/*! @deprecated Black List structure.
	 */
typedef struct
{
...
} BLM_t_black_list  AVL_DEPRECATED ;


/*! @deprecated Sort function type. */
typedef int (* BLM_Sorting) ( BLM_t_black_list * io_psBlackList) AVL_DEPRECATED ;

/*! @deprecated Find function type. */
typedef int (* BLM_FindElement) ( BLM_t_black_list* io_psBlackList, BLM_t_pan *i_psPan,
								 int * o_pnPostion) AVL_DEPRECATED ;
...
/*! @deprecated	This function allows the creation of the Black List.
 * @deprecated It accepts as input the sorting and search methods that will be used to add and to search elements into the black list.
...
**/
int BLM_CreateBlackList(BLM_Sorting i_pfSort,BLM_FindElement i_pfFindElt) AVL_DEPRECATED ;


/*! @deprecated	This function deletes the black list file from the system.
 *	@return
 *	- #BLM_SUCCESS; or
 ...
 * @link VGE_BLM Back to top @endlink
**/
int BLM_DeleteBlackList(void) AVL_DEPRECATED ;


/*! @deprecated	Allows the initialization of the black list with the input parameters: the validity dates and the version number.
 ...
 * @link VGE_BLM Back to top @endlink
**/
int BLM_InitBlackList(DATE i_sActivationDate,DATE i_sExpirationDate,int i_nVersionNumber) AVL_DEPRECATED ;


/*! @deprecated	This function checks the existence of a PAN in the Black List.
 ...
 * @link VGE_BLM Back to top @endlink
**/
int BLM_CheckExistenceInBL(	BLM_t_pan *i_psPan) AVL_DEPRECATED ;


/*! @deprecated	This function allows the addition of a PAN or a range to the black list.
 ...
 * @link VGE_BLM Back to top @endlink
**/
int BLM_AddElementInBL(	BLM_t_elt_black_list* i_psEltBlackList) AVL_DEPRECATED ;


/*! @deprecated	This function allows to remove a PAN or a range from the black list.
 ...
 * @link VGE_BLM Back to top @endlink
**/
int BLM_DeleteElementFromBL(BLM_t_elt_black_list* i_psEltBlackList) AVL_DEPRECATED ;


/*! @deprecated	This function allows the modification of the black list temporal validity.
		@deprecated The black list temporal validity is identified by the activation and expiration dates.
 ...
 * @link VGE_BLM Back to top @endlink
**/
int BLM_ModifyValidityOfBL(DATE i_sActivationDate,DATE i_sExpirationDate) AVL_DEPRECATED ;


/*! @deprecated	This function checks the validity of the black list regarding the input date.
 ...
 * @link VGE_BLM Back to top @endlink
**/
int BLM_VerifyValidityOfBL(DATE i_sCurrentDate) AVL_DEPRECATED ;



/*! @deprecated	This function allows to print the diagnostic concerning the black list.
 *
 * @link VGE_BLM Back to top @endlink
**/
void BLM_PrintDiagOfBL(void) AVL_DEPRECATED ;
