// $Id: GL_CommonTypes.h,v 1.1.2.65 2013/05/22 13:05:33 rbertholet Exp $
...
#if defined(_EFT30_) && !defined(__TELIUM2__) && !defined(__TELIUM3__)
	#define __TELIUM2__
#endif
...
typedef enum T_GL_ENCODING_CHARSET
{
	...
	GL_ENCODING_ISO_8859_16, ///< Latin-10
	GL_ENCODING_BIG_5,       ///< Chinese big 5
...
typedef enum T_GL_EVENT_TYPE
{
	...
	GL_EVENT_MEDIA_ENDED          = 116,   ///< The video, audio or animated image ended
...
/** Text label color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_LABEL_TEXT                  ((T_GL_COLOR)0x00000001)  
/** Focus color of a key on the virtual keyboard (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_KEY_FOCUS                   ((T_GL_COLOR)0x00000002)  
/** Text color of a key on the virtual keyboard (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_KEY_TEXT                    ((T_GL_COLOR)0x00000003)  
/** Window background color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_WINDOW_BACKGROUND           ((T_GL_COLOR)0x00000004)  
/** Window border color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_WINDOW_BORDER               ((T_GL_COLOR)0x00000005)  
/** Window text color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_WINDOW_TEXT                 ((T_GL_COLOR)0x00000006)  
/** Ink color of the signature capture (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_SIGNATURE_INK               ((T_GL_COLOR)0x00000007)  
/** Border color of the signature capture (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_SIGNATURE_BORDER            ((T_GL_COLOR)0x00000008)  
/** Background color of the signature capture (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_SIGNATURE_BACKGROUND        ((T_GL_COLOR)0x00000009)  
/** Focus color on the palette (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_PALETTE_FOCUS               ((T_GL_COLOR)0x0000000A)  
/** Border focus color on the palette (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_PALETTE_FOCUS_BORDER        ((T_GL_COLOR)0x0000000B)  
/** Edit text color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_EDIT_TEXT                   ((T_GL_COLOR)0x0000000C)  
/** Button text color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_BUTTON_TEXT                 ((T_GL_COLOR)0x0000000D)  
/** Dialog text color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_DIALOG_TEXT                 ((T_GL_COLOR)0x0000000E)  
/** Dialog text background color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_DIALOG_TEXT_BACKGROUND      ((T_GL_COLOR)0x0000000F)  
/** Progress bar text color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_PROGRESS_TEXT               ((T_GL_COLOR)0x00000010)  
/** Progress text background color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_PROGRESS_TEXT_BACKGROUND    ((T_GL_COLOR)0x00000011)  
/** Dialog help text color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_DIALOG_HELP_TEXT            ((T_GL_COLOR)0x00000012)  
/** Dialog help text background color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_DIALOG_HELP_TEXT_BACKGROUND ((T_GL_COLOR)0x00000013)  
/** Printing text color (The exact value of the color is extracted directly from the skin loaded) */
#define GL_COLOR_PRINT_TEXT                  ((T_GL_COLOR)0x00000014)  
/** Last skined color */
#define GL_COLOR_LAST_SKINED                 ((T_GL_COLOR)0x00000100)  
...
/** terminal type EFTSmart */
#define GL_TERMINAL_SMART     "EFTSmart"  
/** terminal type EFT30F */
#define GL_TERMINAL_EFT30F    "EFT30"     
/** terminal type EFT30PLUS */
#define GL_TERMINAL_EFT30PLUS "EFT30PLUS" 
/** terminal type Twin30 */
#define GL_TERMINAL_TWIN30    "Twin30"    
/** terminal type Twin31 */
#define GL_TERMINAL_TWIN31    "Twin31"    
/** terminal type Twin32 */
#define GL_TERMINAL_TWIN32    "Twin32"    
/** terminal type Twin33 */
#define GL_TERMINAL_TWIN33    "Twin33"    
/** terminal type EFT930G */
#define GL_TERMINAL_EFT930G   "EFT930G"   
/** terminal type EFT930B */
#define GL_TERMINAL_EFT930B   "EFT930B"   
/** terminal type EFT930S */
#define GL_TERMINAL_EFT930S   "EFT930S"   
/** terminal type EFT930W */
#define GL_TERMINAL_EFT930W   "EFT930W"   
/** terminal type EFT930P */
#define GL_TERMINAL_EFT930P   "EFT930P"   
/** terminal type ML30 */
#define GL_TERMINAL_ML30      "ML30"      
/** terminal type SPM */
#define GL_TERMINAL_SPM       "SPM"       
/** terminal type iPP320 */
#define GL_TERMINAL_IPP320    "iPP320"    
/** terminal type iPP350 */
#define GL_TERMINAL_IPP350    "iPP350"    
/** terminal type CAD30 */
#define GL_TERMINAL_CAD30     "CAD30UCM"  
/** terminal type MR40 */
#define GL_TERMINAL_MR40      "MR40"      
/** terminal type iWL220 */
#define GL_TERMINAL_IWL220    "iWL220"    
/** terminal type iWL250 */
#define GL_TERMINAL_IWL250    "iWL250"    
/**  terminal type iWL280 */
#define GL_TERMINAL_IWL280    "iWL280"    
/** terminal type iWL350 */
#define GL_TERMINAL_IWL350    "iWL350"    
/** terminal type iCT220 */
#define GL_TERMINAL_ICT220    "iCT220"    
/** terminal type iCT250 */
#define GL_TERMINAL_ICT250    "iCT250"    
/** terminal type iSC350 */
#define GL_TERMINAL_ISC350    "iSC350"    
/** terminal type iSC480 */
#define GL_TERMINAL_ISC480    "iSC480"    
/** terminal type iSC250 */
#define GL_TERMINAL_ISC250    "iSC250"    
/** terminal type E560 */
#define GL_TERMINAL_E560      "E560"      
/** terminal type E532 */
#define GL_TERMINAL_E532      "E532"      
/** terminal type iMP320 */
#define GL_TERMINAL_IMP320    "iMP320"    
/** terminal type iMP350 */
#define GL_TERMINAL_IMP350    "iMP350"    
/** terminal type iPP480 */
#define GL_TERMINAL_IPP480    "iPP480"    
/** terminal type iST150 */
#define GL_TERMINAL_IST150    "iST150"    
/** terminal type iUP250 */
#define GL_TERMINAL_IUP250    "iUP250"    
/** terminal type iUC180 */
#define GL_TERMINAL_IUC180    "iUC180"    
...
@{
@section GL_TypesMimesDoc Images MIME types
*/

/** MIME type for the wgu image codec */
#define GL_MIME_IMAGE_WGU "image/wgu"  
/** MIME type for the bitmap image codec */
#define GL_MIME_IMAGE_BMP "image/bmp"  
/** MIME type for the portable network graphic image codec */
#define GL_MIME_IMAGE_PNG "image/png"  
/** MIME type for the jpeg image codec */
#define GL_MIME_IMAGE_JPG "image/jpeg" 
/** MIME type for the gif image codec */
#define GL_MIME_IMAGE_GIF "image/gif"  
/** MIME type for the ipf image codec */
#define GL_MIME_IMAGE_IPF "image/ipf"  

/**
@}
@addtogroup GL_TypesBarcodeInfo Barcode
@{
...
/** MIME type for the ipf image codec */
#define GL_MIME_BARCODE_QR      "barcode/qr"       
/** MIME type for the barcode pdf417 codec */
#define GL_MIME_BARCODE_PDF417  "barcode/pdf417"   
/** MIME type for the barcode ean 8 codec */
#define GL_MIME_BARCODE_EAN8    "barcode/ean8"     
/** MIME type for the barcode ean 13 codec */
#define GL_MIME_BARCODE_EAN13   "barcode/ean13"    
/** MIME type for the barcode code 25 codec */
#define GL_MIME_BARCODE_CODE25  "barcode/code25"   
/** MIME type for the barcode code 39 codec */
#define GL_MIME_BARCODE_CODE39  "barcode/code39"   
/** MIME type for the barcode code 128 codec */
#define GL_MIME_BARCODE_CODE128 "barcode/code128"  
...
/** Value of the barcode (Binary buffer) */
#define GL_BARCODE_VALUE                "value"           
/** Pixel color of the barcode */
#define GL_BARCODE_FORECOLOR            "forecolor"       

/** Version of the symbol. If 0, the library chooses the minimum version for the given input data. (Integer) */
#define GL_BARCODE_QR_VERSION           "version"         
/** Error correction level (@ref T_GL_BARCODE_QR_ERROR_LEVEL) (Integer) */
#define GL_BARCODE_QR_ERROR_LEVEL       "errorlevel"      
/** Encoding Mode (@ref T_GL_BARCODE_QR_ENCODING_MODE) (Integer) */
#define GL_BARCODE_QR_ENCODING_MODE     "encoding"        
/** Case-sensitive(1) or not(0) (Integer) */
#define GL_BARCODE_QR_CASESENSITIVE     "casesensitive"   
/** Minimal size of pixel (Integer) */
#define GL_BARCODE_QR_PIXEL_SIZE        "pixelsize"       
/** Space in pixel of the margin (Integer) */
#define GL_BARCODE_QR_MARGIN            "margin"          
...
@{
*/
/** Number of columns (Ranged integer from 1 to 30) */
#define GL_BARCODE_PDF417_COLUMNS       "columns"         
/** Number of rows (Ranged integer from 30 to 90) */
#define GL_BARCODE_PDF417_ROWS          "rows"            
/** error correction level (Ranged integer from 1 to 8) */
#define GL_BARCODE_PDF417_CORRECTION    "correctionlevel" 
...
/** Space in pixel of the left and right margin for 1D barcodes (Integer) */
#define GL_BARCODE_1D_SIDE_MARGIN      "sidemargin"      
...
/** Activate checksum for code 25 barcodes (Integer) */
#define GL_BARCODE_CODE25_CHECKSUM      "checksum"        
