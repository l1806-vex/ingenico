// $Id: GL_Media.h,v 1.1.2.27 2013/01/08 15:16:36 rbertholet Exp $
// Media management
...
/** Sets the volume (This function does not work with a animated image as a gif or ipf file)
@param media media handle 
...
/** Gets the total time duration of the video (This function does not work with a animated image as a gif or ipf file)
@param media media handle 
@return the duration in milliseconds */
ulong GL_Media_GetDuration(T_GL_HWIDGET media) GL_EXCEPTION;

/** Set the viewing of video at a given time (This function does not work with a animated image as a gif or ipf file)
@param media media handle 
@param time time in milliseconds */
void GL_Media_SetTime(T_GL_HWIDGET media, ulong time) GL_EXCEPTION;

/** Gets the current time of the video (This function does not work with a animated image as a gif or ipf file)
@param media media handle 
