...
#define 	LL_FORMAT_APDUOPTIM				8 // enable/disable FDT between apdu
...
//Cless LOGO center position management
#define CLESSLOGO_SET_X 50
#define CLESSLOGO_SET_Y 51
#define CLESSLOGO_GET_X 52
#define CLESSLOGO_GET_Y 53
...
//! \brief Data structure of ioctl function's parameters \n
//! Get the cless logo center's position.
typedef struct
{
    int*   p_XcenterClessLogo;							//!< address of X axis position
    int*   p_YcenterClessLogo;							//!< address of Y axis position
}T_CLEMV_FIOCTLPARAM_GET_LOGO_POSITION;
...
#define CLEMV_FIOCTL_USE_SECONDARY_PINPAD_CLESS		CLEMV_FIOCTL_EXTERNAL+15
#define CLEMV_FIOCTL_GET_CLESS_LOGO_POSITION CLEMV_FIOCTL_EXTERNAL+16
