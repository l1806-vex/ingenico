...
#define EXTENDED_SERVICE    		99	/*!< Extended service to bypass 100 limit. */
...
typedef unsigned char TRACK2_BUFFER [40+1]; 	/*!< track 2 = 40 characters for TRACK2 and one Characters for null termination */
...
#else
	Telium_File_t *handle;								/*!< handle of the event. */
#endif
} S_EVENTOUT;
