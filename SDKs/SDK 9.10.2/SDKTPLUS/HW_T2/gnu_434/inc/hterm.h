...
/*! @brief This function Check if the terminal is an IMP350 or an IMP320.
 * @return != 0 if terminal is an IMP350 or an IMP320.
 *
 * @link KSFAM_M2OS Back to top @endlink
*/
...
/*! @brief This function Get full reference of product.
 * @param FullReference : NULL string of 64 characters 
 * @return 
 * - 0 if OK
 * - -1 unvalaible
 *
 * @link KSFAM_M2OS Back to top @endlink
*/
extern int TM_GetFullReference(unsigned char *FullReference);
...
#else
extern int TM_Printer_AdjustIntensity(Telium_File_t*prnt,int darkness);
#endif
...
#else
extern int TM_Printer_GetIntensity(Telium_File_t *prnt,int *darkness);
#endif
...
/*! @brief This function return terminal type
 * @return
 * -  -1 if not implemented
 * -  return See TERMTYPE_VALUE
 *
 * @note
 *
 *
 * @link KSFAM_IOSF Back to top @endlink
 */
extern int  TM_GetTerminalType(void);
