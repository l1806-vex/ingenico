 ...
 *	@param x : in range [0,127]. 
 *	@param y : in range [0,127]. 
 *	@return  depend onto the graphic context (PERIPH_DISPLAY_EXTENDED or PERIPH_DISPLAY)
 *  @par exit (EXIT_DLL_LIBGR_NOT_INITIALIZED + 13) if function does not exist
 *	@note 
  *	- The result depend on Graphic Context
  * - After InitContexteGraphique(PERIPH_DISPLAY_EXTENDED) return true color value (ARGB)
  * - After InitContexteGraphique(PERIPH_DISPLAY) return _ON_ for BLACK and _OFF_ for WHITE
 *
 * @link KSFAM_VISU Back to top @endlink
*/
...
#define  DRAW_SET_FULL_COLOR              0x8000      /*!<  update manager and thunder memory */
#define  DRAW_BITMAP_COLOR_FILM           0x8003      /*!<  don't update thunder memory (faster) */
 ...
 *		-  DRAW_BITMAP_COLOR_FILM don't update thunder memory (faster)
