...
/*! @brief This function convert an ISO8859-6 string in an UNICODE string
 * @param i__input_string : input string in ISO8859-6 (1 bytes per character)
 * @param o__output_string : output string in UNICODE  (2 bytes per character)
 * @param i__output_string_size: size of output string including null terminated character
 * @return Length of unicode string
 * -  -1 : i__output_string_size to small to store output string
 * -  -2 : corresponding arabic unicode character not found into ISO6 conversion table
 * @par exit (EXIT_DLL_LIBGR_NOT_INITIALIZED + 135) if function does not exist
 * @note
 *   i__output_string_size is calculated before calling the function
 *
 * @include fontlib_Sample_09.c
 * @link KSFAM_FONTLIB Back to top @endlink
*/
