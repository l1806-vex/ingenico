...
//! \brief Convert a DCB coded number to an unsigned long long.
//! \param[in] pDcb DCB coded number to convert.
//! \param[out] pValue Unsigned long long containing the converted value.
//! \param[in] nDcbLength DCB coded number length (in bytes).
//! Here is an example :
//! pDcb = 0x12 0x34
//! GTL_Convert_DcbNumberToUl (pDcb, &ulNumber, 2) : ullNumber = 0x00000000000004D2 (1234).

void GTL_Convert_DcbNumberToUll(const unsigned char* pDcb, unsigned long long * pValue, int nDcbLength);
