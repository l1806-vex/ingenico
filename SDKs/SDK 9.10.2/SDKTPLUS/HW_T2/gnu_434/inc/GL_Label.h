// $Id: GL_Label.h,v 1.1.2.45 2013/01/08 15:16:36 rbertholet Exp $
// Label management
...
<h2>Sample</h2>
	...
	Below is an example of creating a window with a text label in big5.

	@image html labelTest6.png
	@include GL_SampleLabelBig5.c
@}
*/
