...
#define TPASS_COMPONENT_TYPE_OS_STERM_FILE			(0x05)	//!< The contactless component is the software description file.
...
//! \brief Get the coordinate in pixels of the center of the contactless field.
//! \param[out] x Horizontal position.
//! \param[out] y Vertical position.
//! \return
//! <table><tr><th>Value</th><th>Description</th></tr>
//! <tr><td>\ref CLESS_STATUS_OK</td><td>The x/y positions are correctly filled. Note that x and y are set to -1 if the contactless field logo must not be displayed.</td></tr>
//! <tr><td>\ref CLESS_STATUS_KO</td><td>The contactless driver cannot be opened.</td></tr>
//! <tr><td>\ref CLESS_STATUS_NOT_IMPLEMENTED</td><td>This function is not present in the TPass DLL used.</td></tr>
//! <tr><td>\ref CLESS_STATUS_DLL_NOT_LOADED</td><td>The TPass DLL is not loaded in the terminal.</td></tr>

int TPass_GetFieldCenterCoords(int *x, int *y);
...
/*! \brief Retrieve the version of the level 1 specification.
\return
<table><tr><th>Value</th><th>Description</th></tr>
...
<tr><td>2</td><td>The driver is EMV 2.x certified.</td></tr>
<tr><td>0</td><td>An error occurred (e.g. driver not opened, etc).</td></tr>
</table>
*/
...
/*! \brief Retrieve the UID of an ISO14443-4 contactless card.
...
<tr><td>\a CLSTM_KO</td><td>An error occurred.</td></tr>
</table>
*/
...
/*! \brief Retrieve the type and the UID of a STMicroelectronics contactless card.
...
/*! \brief Retrieve the write protection flag of a STMicroelectronics contactless card.
...
<tr><td>\a CLBP_KO</td><td>An error occurred.</td></tr>
</table>
*/
...
/*! \brief Retrieve the ATR of an Innovatron Calypso contactless card.
...
#include "Cless_LowLevel_deprecated.h"
