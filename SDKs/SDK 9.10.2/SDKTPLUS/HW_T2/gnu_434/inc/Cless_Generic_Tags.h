...
#define TAG_GENERIC_APPLICATION_TYPE				0x9F928201		/*!< Indicates the application type which provided the AID for PPSE Application Selection.<br>	- Format : b.<br>	- Length : 2 bytes.<br>	- Source : Terminal. */
...
#define TAG_GENERIC_SELECT_COMMAND					0x9F928206		/*!< LOA METHOD - Indicates the card command used to select an application.<br>	- Format : b.<br>	- Length : 22 bytes max.<br>	- Source : Card. */
#define TAG_GENERIC_SELECT_CARD_RESPONSE			0x9F928207		/*!< LOA METHOD - Indicates the card response to select command.<br>	- Format : b.<br>	- Length : 257 bytes max.<br>	- Source : Card. */
#define TAG_GENERIC_SELECT_CARD_SW					0x9F928208		/*!< LOA METHOD - Indicates the card response status to select command.<br>	- Format : b.<br>	- Length : 2 bytes.<br>	- Source : Terminal. */
...
#define TAG_GENERIC_SELECT      					0xBF928202		/*!< LOA METHOD - Indicates a card command/response/SW to select an application.<br>	- Format : b.<br>	- Length : 281 bytes max.<br>	- Source : Card. */
