...
#ifndef __DIAG_DEF_H_INCLUDED__
#define __DIAG_DEF_H_INCLUDED__
...
typedef struct
		{
			...
			T_VERSION				os_version;					/*!< OS version */
			unsigned short	os_crc;							/*!< CRC of the OS */
			char						hardware_info;		/*!< informations about the hardware. */
		}TERMINAL_INFOS;
...
typedef struct
		{
			...
			unsigned char software[4];		/*!< software reader information */
		}CARD_READER_INFO;
