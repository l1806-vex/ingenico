...
#define ERR_CLESS_000001						(0x0A000001)	/*!< Cless error, Cless_AS_ApplicationSelection.c, __Cless_AS_SendAndStoreSelect, An error occurred when adding the Command/Response element in the list. */
#define ERR_CLESS_000002						(0x0A000002)	/*!< Cless error, Cless_AS_ApplicationSelection.c, __Cless_AS_SendAndStoreSelect, An error occurred when trying to build or to send the command to the card (bad parameter or no card answer). */ 
...
#define ERR_CLESS_000009						(0x0A000009)	/*!< Cless error, Cless_AS_ApplicationSelection.c, __Cless_AS_ExtractAndParseFciTemplate, A parsing error occurred on the card response (extracting data from FCI template). */
...
#define ERR_CLESS_000014						(0x0A000014)	/*!< Cless error, Cless_AS_ApplicationSelection.c, __Cless_AS_ParseFciProprietaryTemplate, A parsing error occurred on the card response (extracting data from FCI template). */
...
#define ERR_CLESS_00001D						(0x0A00001D)	/*!< Cless error, Cless_AS_ApplicationSelection.c, Cless_AS_ListOfAidMethod, An error occurred when Sending command to card. */
...
#define ERR_CLESS_000029						(0x0A000029)	/*!< Cless error, Cless_Generic_Commands.c, Cless_Generic_Commands_SendSelectCommand, A communication error occurred with the card (card removed for example) or contactless driver is not opened. */
#define ERR_CLESS_00002A						(0x0A00002A)	/*!< Cless error, Cless_Generic_Commands.c, Cless_Generic_Commands_SendSelectCommand, An error occurred when building the SELECT command. */
...
#define ERR_CLESS_00002D						(0x0A00002D)	/*!< Cless error, Cless_AS_ApplicationSelection.c, Cless_AS_ListOfAidMethod, An error occurred during Final Application Selection of AID having the highest priority. */

//! \cond NOT_DOCUMENTED
#define ERR_CLESS_00002E						(0x0A00002E)	/*!< Cless error,  */ 
//! \endcond

#define ERR_CLESS_00002F						(0x0A00002F)	/*!< Cless error, Cless_AS_ApplicationSelection.c, __Cless_AS_FinalSelectionProcessing, An error occurred during Final Application Selection. */
#define ERR_CLESS_000030						(0x0A000030)	/*!< Cless error, Cless_AS_ApplicationSelection.c, Cless_AS_RemoveAidFromCandidateList, An error occurred during the final selection process (remove AID and then SELECT next). */
#define ERR_CLESS_000031						(0x0A000031)	/*!< Cless error, Cless_AS_ApplicationSelection.c, Cless_AS_RemoveAidFromCandidateList, An internal error occurred when trying to remove an AID from the candidate list (status code already updated). */
...
#define ERR_CLESS_000034						(0x0A000034)	/*!< Cless error, Cless_APDU_ApduMethod, Cless_APDU_Method_Process, An error occurred when trying to send command to the card response storage error). */
...
#define ERR_CLESS_00005B						(0xA000005B)	/*!< Cless error, Cless_Internal_Selection.c, LoA method is not executed as the card is already detected as blocked in the PPSE method. */
