// $Id: GL_Dialog.h,v 1.1.2.43 2012/07/31 12:35:14 rbertholet Exp $
...
@param update null or callback function called periodically to update the progress bar (if this pointer is null, the parameter value is only taken into account)
@param buttons button to make visible and manage
@param duration inactivity duration in milliseconds (@ref GL_RESULT_INACTIVITY)
@return returns the key or button pressed @see GL_TypesKeys*/
