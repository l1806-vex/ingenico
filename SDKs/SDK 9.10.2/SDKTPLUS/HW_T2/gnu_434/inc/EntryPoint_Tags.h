 ...
 *
 * \author Ingenico
 * \author Copyright (c) 2012 Ingenico, 1 rue claude Chappe,\n
...
#define TAG_EP_CLESS_APPLI_CAPABILITY_TYPE			0x9F28			/*!< <b>OBSOLETE</b><br>ENTRY POINT - Contactless Application Capabilities Type.<br>Identifies the capabilities of the application to the Terminal, for instance whether the application supports the EMV Contactless Application.<br>	- Format : b.<br>	- Length : 3-8 bytes.<br>	- Source : Card. */
#define TAG_EP_CARD_EXTENDED_SELECTION				0x9F29			/*!< ENTRY POINT - The value to be appended to the ADF Name in the data field of the SELECT command, if the Extended Selection Support flag is present and set to 1 (see \ref TAG_EP_AID_OPTIONS for more information).<br>Note: the maximum length of ADF Name in the same directory entry suc that Length of Extended Selection + Length of ADF Name <= 16.<br>	- Format : b.<br>	- Length : var.<br>	- Source : Card. */
#define TAG_EP_CARD_KERNEL_IDENTIFIER				0x9F2A			/*!< ENTRY POINT - Indicates the card's preference for the kernel on which the contactless application can be processed.<br>	- Format : b.<br>	- Length : 1 byte or 3-8 bytes.<br>	- Source : Card. */
...
#define TAG_EP_ASSOCIATED_KERNEL_ID					0x9F928116		/*!< ENTRY POINT - Indicates the kernel ID linked with a given AID. This is used (and mandatory) if the B1b7 of \ref TAG_EP_AID_OPTIONS is set.<br>	- Format : b.<br>	- Length : 1 or 3-8 bytes.<br>	- Source : Terminal. */ 
