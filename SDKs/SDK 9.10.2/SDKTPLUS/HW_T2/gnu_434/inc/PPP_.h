...
//! @{
#define PPP_STATE_DEAD                ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
#define PPP_STATE_ESTABLISH           ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
#define PPP_STATE_NETWORK             ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
#define PPP_STATE_AUTH                ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
...
#define PPP_INFO_CB_AUTH			      ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
#define PPP_INFO_CB_CONNECT			      ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
#define PPP_INFO_CB_DISCONNECT		      ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
#define PPP_INFO_CB_LINK			      ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
#define PPP_INFO_CB_DATA			      ERROR_Deprecation_For_Module_PACKIP_SeeDocumentation_In_CHM_File
