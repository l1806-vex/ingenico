...
void GL_SampleDialogMultiFile1(T_GL_HGRAPHIC_LIB graphicLib)
{
	...
	if (GL_Dialog_MultiFile(graphicLib, "Select files HOST", "dir://flash/HOST", "*.TXT", files, 0, GL_TIME_INFINITE) == GL_KEY_VALID)
	{
...
void GL_SampleDialogMultiFile2(T_GL_HGRAPHIC_LIB graphicLib)
{
	...
	if (GL_Dialog_MultiFile(graphicLib, "Select files USB key", "dir://umsd0a", "*.TXT", files, 0, GL_TIME_INFINITE) == GL_KEY_VALID)
	{
		// Here print list of files selected
		GL_SamplePrintFileList(graphicLib, files);
	}
...
void GL_SampleDialogMultiFile3(T_GL_HGRAPHIC_LIB graphicLib)
{
	...
	if (GL_Dialog_MultiFile(graphicLib, "Select files MMC", "dir://mmcd0a", "*.TXT", files, 0, GL_TIME_INFINITE) == GL_KEY_VALID)
	{
		// Here print list of files selected
		GL_SamplePrintFileList(graphicLib, files);
	}
...
void GL_SampleDialogMultiFile4(T_GL_HGRAPHIC_LIB graphicLib)
{
	...
	if (GL_Dialog_MultiFile(graphicLib, "Select files TAR", "file://flash/HOST/TU.TAR", "*.TXT", files, 0, GL_TIME_INFINITE) == GL_KEY_VALID)
	{
		// Here print list of files selected
		GL_SamplePrintFileList(graphicLib, files);
	}
...
{
	GL_SampleDialogMultiFile1(graphicLib);
	GL_SampleDialogMultiFile2(graphicLib);
	GL_SampleDialogMultiFile3(graphicLib);
	GL_SampleDialogMultiFile4(graphicLib);
}
