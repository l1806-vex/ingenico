...
{
    strncpy(param_out->returned_state[param_out->response_number].appname, appName, sizeof(T_APPNAME));
...
int more_function( NO_SEGMENT no, void *p1, void *p2 )
{
    ...
    if(hDisplay != NULL)
    {
       do
       {
           ...
           {
              case 0: Sample_MF_ULC(); break;  // Function1 selected
              case 1: Sample_MF_ULC_With_SAM(); break;  // Function2 selected
