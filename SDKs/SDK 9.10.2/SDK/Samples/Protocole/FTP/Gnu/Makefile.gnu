...
LIBS       = "$(SDK_LIB)\FTP_.lib" "$(SDK_LIB)\eft30.lib" "$(SDK_LIB)\trap.lib" -L "$(GCC_LIB1)" -lc -L "$(GCC_LIB2)" -lgcc
...
OBJ        =	"$(OBJ_DIR)\Entry.o"  			\
		...
		"$(OBJ_DIR)\UserInterfaceHelpers.o"	\
		"$(OBJ_DIR)\Menu.o"			\
		"$(OBJ_DIR)\FTP_DownloadDir.o"		\
		"$(OBJ_DIR)\Loader_util.o"		\
		"$(OBJ_DIR)\SoftwareActivate.o"
...
"$(OBJ_DIR)\Menu.o" : "$(SOURCE_DIR)\Menu.c"
	@echo Compiling...
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Menu.c"

"$(OBJ_DIR)\Communication.o" : "$(SOURCE_DIR)\Communication.c"
	@echo Compiling...
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Communication.c"

"$(OBJ_DIR)\UserInterfaceHelpers.o" : "$(SOURCE_DIR)\UserInterfaceHelpers.c"
	@echo Compiling...
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\UserInterfaceHelpers.c"

"$(OBJ_DIR)\FTP_DownloadDir.o" : "$(SOURCE_DIR)\FTP_DownloadDir.c"
	@echo Compiling...
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\FTP_DownloadDir.c"

"$(OBJ_DIR)\SoftwareActivate.o" : "$(SOURCE_DIR)\SoftwareActivate.c"
	@echo Compiling...
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\SoftwareActivate.c"

"$(OBJ_DIR)\Loader_util.o" : "$(SOURCE_DIR)\Loader_util.c"
	@echo Compiling...
	@cd "$(OBJ_DIR)"
	@$(COMPILE) "$(SOURCE_DIR)\Loader_util.c"
