...
// \brief This module implements the deprecated MIFARE commands
...
#define mifareSAM_SelectApplication(a, b)          ERROR_Deprecation_For_Function_mifareSAM_SelectApplication_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_ChangeKeyEntry(a, b, c, d)       ERROR_Deprecation_For_Function_mifareSAM_ChangeKeyEntry_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_VerifyMAC(a, b, c, d)            ERROR_Deprecation_For_Function_mifareSAM_VerifyMAC_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_GenerateMAC(a, b, c, d, e)       ERROR_Deprecation_For_Function_mifareSAM_GenerateMAC_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_DecipherData(a, b, c, d, e)      ERROR_Deprecation_For_Function_mifareSAM_DecipherData_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_EncipherData(a, b, c, d, e, f)   ERROR_Deprecation_For_Function_mifareSAM_EncipherData_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_AuthenticatePICCFirstPart(a, b, c, d, e, f, g, h, i, j)     ERROR_Deprecation_For_Function_mifareSAM_AuthenticatePICCFirstPart_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_AuthenticatePICCSecondPart(a, b, c)                         ERROR_Deprecation_For_Function_mifareSAM_AuthenticatePICCSecondPart_For_MifareDLL_SeeDocumentation_In_CHM_File;
#define mifareSAM_ChangeKeyPICC(a, b, c, d, e, f, g, h, i, j, k)              ERROR_Deprecation_For_Function_mifareSAM_ChangeKeyPICC_For_MifareDLL_SeeDocumentation_In_CHM_File;
...
/**
 * Update a SAM key entry, only for SAM in AV1 mode.
 * @deprecated Use \ref mifareSAM_ChangeKeyEntryEx instead.
 ...
 *      </table>
 * @param[in] pKeyEntry Pointer to \ref T_MIFARE_KEY_ENTRY of the new key entry.
 * @return
...
extern int mifareSAM_ChangeKeyEntry(T_MIFARE_SAM_CONTEXT* pSAMCtx,
      unsigned char ucKeyNo, unsigned char ucProgMask, T_MIFARE_KEY_ENTRY* pKeyEntry) MACRO_DEPRECATED;
...
extern int mifareSAM_GenerateMAC(T_MIFARE_SAM_CONTEXT* pSAMCtx, int iDataLen,
      const unsigned char *pData, unsigned int *puiMacLen, unsigned char *pMac) MACRO_DEPRECATED;
...
extern int mifareSAM_EncipherData(T_MIFARE_SAM_CONTEXT* pSAMCtx,
      unsigned char ucOffset, int iDataLen, const unsigned char *pData,
...
extern int mifareSAM_AuthenticatePICCFirstPart(T_MIFARE_SAM_CONTEXT* pSAMCtx,
      ...
      int iDivInpLen, const void* pDivInp, int *piResLen,
