...
#ifndef __CONFIG_DEF_H_INCLUDED__
#define __CONFIG_DEF_H_INCLUDED__
...
#define HTERM_OPT_EXT_CARD    (ConfigTerm()->options[1]&0x40)  /*!< bit 14 */
...
#define    HTERM_OPT_PROD_TYPE_IPP310            0x70 //FT13222 IPP310
...
#define HTERM_EXT_OPT_IMP_COMPANION (ConfigTerm()->extension_type[0]&0x10) /*!< bit 4 (zero means n/a) */
...
#endif   // __CONFIG_DEF_H_INCLUDED__
