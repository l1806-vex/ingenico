...
namespace GL
{
	...
	public:
		...
		inline Widget searchId(T_GL_ID userControlId, T_GL_ID internalId)
		{
			Widget result(GL_UserControl_SearchId(m_widget, userControlId, internalId));
			return result;
		}
		...
		inline void setShortcut(T_GL_WCHAR key)
		{
			GL_Widget_SetShortcut(m_widget, key);
		}

		inline T_GL_WCHAR getShortcut(void)
		{
		...
		inline void setFillChar1(T_GL_WCHAR character)
		{
			GL_Widget_SetFillChar1(m_widget, character);
		}

		inline T_GL_WCHAR getFillChar1(void)
		{
			return GL_Widget_GetFillChar1(m_widget);
		}

		inline void setFillChar2(T_GL_WCHAR character)
		{
			GL_Widget_SetFillChar2(m_widget, character);
		}

		inline T_GL_WCHAR getFillChar2(void)
		{
			return GL_Widget_GetFillChar2(m_widget);
		}

		inline void setPasswordChar(T_GL_WCHAR character)
		{
			GL_Widget_SetPasswordChar(m_widget, character);
		}

		inline T_GL_WCHAR getPasswordChar(void)
		{
		...
		{
			GL_Widget_SetWrap(m_widget, wrap);
		}

		inline bool getWrap(void)
		{
			return GL_Widget_GetWrap(m_widget);
		}

		inline Widget instanciateResource(Widget parent, const char * content, unsigned long size)
		{
			return Widget(GL_Widget_InstanciateResource(parent.getHandle(), content, size));
		}
	...
	{
	protected:
		T_GL_HGRAPHIC_LIB m_graphicLib;
	public:
		inline GraphicLib() 
		{
			m_graphicLib = GL_GraphicLib_Create();
		}
			
		inline GraphicLib(Viewer & viewer, const char * skinName = 0)
		{
			m_graphicLib = GL_GraphicLib_CreateWithParam(viewer.getHandle(), skinName);
		}
			
		inline virtual ~GraphicLib()
		{
			GL_GraphicLib_Destroy(m_graphicLib);
		}
			
		inline Widget readResource(const char * filename)
		{
			Widget result(GL_GraphicLib_ReadResource(m_graphicLib, filename));
			return result;
		}
			
		inline const char * getErrorMessage()
		{
			return GL_GraphicLib_GetErrorMessages(m_graphicLib);
		}
			
		inline void setCharset(T_GL_ENCODING_CHARSET charset)
		{
			GL_GraphicLib_SetCharset(m_graphicLib, charset);
		}

		inline T_GL_ENCODING_CHARSET getCharset(void)
		{
			return GL_GraphicLib_GetCharset(m_graphicLib);
		}

		inline void bindManyKey(T_GL_WCHAR teliumKey, const T_GL_WCHAR * keys, unsigned long count)
		{
			GL_GraphicLib_BindManyKey(m_graphicLib, teliumKey, keys, count);
		}

		inline void bindOneKey(T_GL_WCHAR teliumKey, T_GL_WCHAR key)
		{
			GL_GraphicLib_BindSingleKey(m_graphicLib, teliumKey, key);
		}
			
		inline void unbinKey(T_GL_WCHAR teliumKey)
		{
			GL_GraphicLib_UnbindKey(m_graphicLib, teliumKey);
		}
		...
		inline void sendKey(T_GL_WCHAR key)
		{
			GL_GraphicLib_SendKey(m_graphicLib, key);
		}

		inline void sendClick(T_GL_COORD x, T_GL_COORD y, T_GL_UNIT unit)
		{
			GL_GraphicLib_SendClick(m_graphicLib, x, y, unit);
		}

		inline void sendBreak(void)
		{
			GL_GraphicLib_SendBreak	(m_graphicLib);
		}

		inline void setWindowSize(T_GL_DIM width, T_GL_DIM height, T_GL_UNIT unit)
		{
			GL_GraphicLib_SetWindowSize(m_graphicLib, width, height, unit);
		}

		inline void setWindowPosition(T_GL_COORD x, T_GL_COORD y, T_GL_UNIT unit)
		{
			GL_GraphicLib_SetWindowPosition(m_graphicLib, x, y, unit);
		}

		inline const char *getTerminalType(void)
		{
			return GL_GraphicLib_GetTerminalType(m_graphicLib);
		}

		inline T_GL_SIZE getScreenSize(void)
		{
			return GL_GraphicLib_GetScreenSize(m_graphicLib);
		}

		inline ulong dialogMultiFile (const char * title, const char * root, const char * filter, StringList & files, T_GL_DIALOG_FILE_FILTER filterCallback, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_MultiFile (m_graphicLib, title, root, filter, files.getHandle(), filterCallback, duration);
		}

		inline ulong iconButtonMenu (const char * title, const char ** menu, int selectedItem, T_GL_BUTTONS buttons, T_GL_WCHAR shortcut, T_GL_DURATION duration)
		{
			return GL_Dialog_IconButtonMenu (m_graphicLib, title, menu, selectedItem, buttons, shortcut, duration);
		}

		inline ulong dialogMessage(const char * title, const char * text, T_GL_DIALOG_ICON icon, T_GL_BUTTONS buttons, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Message(m_graphicLib, title, text, icon, buttons, duration);
		}

		inline ulong dialogDate (const char * title, const char * text, T_GL_HDATE date, const char * format, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Date (m_graphicLib, title, text, date, format, duration);
		}

		inline ulong dialogText (const char * title, const char * text, const char * mask, char * value, ulong valueSize, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Text (m_graphicLib, title, text, mask, value, valueSize, duration);
		}

		inline ulong dialogIp (const char * title, const char * text, T_GL_HIP ipAddr, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Ip (m_graphicLib, title, text, ipAddr, duration);
		}

		inline ulong dialogAmount (const char * title, const char * text, const char * mask, char * amount, ulong amountSize, const char * unit, T_GL_ALIGN unitAlign, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Amount (m_graphicLib, title, text, mask, amount, amountSize, unit, unitAlign, duration);
		}

		inline ulong dialogChoice (const char * title, const char * const * menu, int selectedItem, T_GL_BUTTONS buttons = GL_BUTTON_DEFAULT, T_GL_WCHAR shortcut = GL_KEY_1, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Choice (m_graphicLib, title, menu, selectedItem, buttons, shortcut, duration);
		}

		inline ulong dialogIconMenu (const char * title, const char * const * menu, int selectedItem, T_GL_BUTTONS buttons = GL_BUTTON_DEFAULT, T_GL_WCHAR shortcut = GL_KEY_1, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_IconMenu (m_graphicLib, title, menu, selectedItem, buttons, shortcut, duration);
		}

		inline ulong dialogMenu (const char * title, const char * const * menu, int selectedItem, T_GL_BUTTONS buttons = GL_BUTTON_DEFAULT, T_GL_WCHAR shortcut = GL_KEY_1, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Menu (m_graphicLib, title, menu, selectedItem, buttons, shortcut, duration);
		}

		inline ulong dialogColor (const char * title, const char * text, T_GL_HCOLOR color, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Color (m_graphicLib, title, text, color, duration);
		}

		inline ulong dialogMedia (const char * title, const char * text, const char * source, byte volum, T_GL_BUTTONS buttons = GL_BUTTON_DEFAULT, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Media (m_graphicLib, title, text, source, volum, buttons, duration);
		}

		inline ulong dialogPicture (const char * title, const char * text, const char * source, T_GL_BUTTONS buttons = GL_BUTTON_DEFAULT, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Picture (m_graphicLib, title, text, source, buttons, duration);
		}

		inline ulong dialogSlider(const char * title, const char * text, const char * source, T_GL_COORD * value, T_GL_COORD min, T_GL_COORD max, T_GL_DIM step, T_GL_DIALOG_SLIDER_UPDATE update = 0, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Slider(m_graphicLib, title, text, source, value, min, max, step, update, duration);
		}

		inline ulong dialogProgress(const char * title, const char * text, const char * source, T_GL_COORD * value, T_GL_COORD min, T_GL_COORD max, T_GL_DIALOG_PROGRESS_UPDATE update = 0, T_GL_BUTTONS buttons = GL_BUTTON_DEFAULT, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Progress(m_graphicLib, title, text, source, value, min, max, update, buttons, duration);
		}

		inline ulong dialogFile(const char * title, const char * root, const char * filter, char * fileSelected, unsigned long fileSelectedSize, T_GL_DIALOG_FILE_FILTER filterCallback, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_File (m_graphicLib, title, root, filter, fileSelected, fileSelectedSize, filterCallback, duration);
		}

		inline ulong virtualKeyboard (const char * title, const char * text, const char * mask, char * value, ulong valueSize, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_VirtualKeyboard (m_graphicLib, title, text, mask, value, valueSize, duration);
		}

		inline ulong multiChoice (const char * title, const char * const * menu, int selectedItem, bool * checkedItems, T_GL_BUTTONS buttons = GL_BUTTON_DEFAULT, T_GL_WCHAR shortcut = GL_KEY_1, T_GL_DURATION duration= GL_TIME_INFINITE)
		{
			return GL_Dialog_MultiChoice (m_graphicLib, title, menu, selectedItem, checkedItems, buttons, shortcut, duration);
		}

		inline ulong password (const char * title, const char * text, const char * mask, char * value, ulong valueSize, T_GL_DURATION duration = GL_TIME_INFINITE)
		{
			return GL_Dialog_Password (m_graphicLib, title, text, mask, value, valueSize, duration);
		}

		inline ulong scheme (const char * title, const char * text, const char * help, T_GL_HSCHEME_INTERFACE interfac)
		{
			return GL_Dialog_Scheme (m_graphicLib, title, text, help, interfac);
		}

		inline ulong signature (const char * title, const char * text, const char * filename, T_GL_DURATION duration)
		{
			return GL_Dialog_Signature(m_graphicLib, title, text, filename, duration);
		}

		inline T_GL_ERROR_CODE getErrorCode(void)
		{
			return GL_GraphicLib_GetErrorCode(m_graphicLib);
		}

		inline bool isTouch(void)
		{
			return GL_GraphicLib_IsTouchPresent(m_graphicLib);
		}

		inline void setFontName(const char * name)
		{
			GL_GraphicLib_SetFontName(m_graphicLib, name);
		}

		inline const char * getFontName(void)
		{
			return GL_GraphicLib_GetFontName(m_graphicLib);
		}

		inline Widget getWidgetAtPosition(T_GL_COORD x, T_GL_COORD y)
		{
			Widget result(GL_GraphicLib_GetWidgetAtPosition(m_graphicLib, x, y));
			return result;
		}

		inline const char * getDefaultPath(void)
		{
			return GL_GraphicLib_GetDefaultPath(m_graphicLib);
		}

		inline void saveImage(const char * filename, const char * mimeType)
		{
			GL_GraphicLib_SaveImage(m_graphicLib, filename, mimeType);
		}

		inline void setDefaultPath(const char * path)
		{
			GL_GraphicLib_SetDefaultPath(m_graphicLib, path);
		}

		inline T_GL_RECT getUserArea(void)
		{
			return GL_GraphicLib_GetUserArea(m_graphicLib);
		}


		inline T_GL_SCREEN_ORIENTATION getScreenOrientation(void)
		{
			return GL_GraphicLib_GetScreenOrientation(m_graphicLib);
		}

		inline T_GL_ERROR_CODE setScreenOrientation(T_GL_SCREEN_ORIENTATION orientation)
		{
			return GL_GraphicLib_SetScreenOrientation(m_graphicLib, orientation);
		}

		inline T_GL_ERROR_CODE lockScreenOrientation(void)
		{
			return GL_GraphicLib_LockScreenOrientation(m_graphicLib);
		}

		inline void unlockScreenOrientation(void)
		{
			GL_GraphicLib_UnlockScreenOrientation(m_graphicLib);
		}

		inline Widget instanciateResource(const char * content, unsigned long size)
		{
			return Widget(GL_GraphicLib_InstanciateResource(m_graphicLib, content, size));
		}

		inline T_GL_SIZE getTextSize(const char * text, const char * fontName, T_GL_FONT_STYLE fontStyle, T_GL_DIM fontHeight)
		{
			return GL_GraphicLib_GetTextSize(m_graphicLib, text, fontName, fontStyle, fontHeight);
		}


		inline void userControlRegister(const char * filename, T_GL_USERCONTROL_CALLBACK init)
		{
			GL_UserControl_Register(m_graphicLib, filename, init);
		}

		inline void userControlUnregister(const char * filename)
		{
			GL_UserControl_Unregister(m_graphicLib, filename);
		}
	};
	...
	public:
		...
		inline T_GL_DURATION getInterval(void)
		{
	...
	public:
		...
		inline Message(Widget & widget, T_GL_EVENT_TYPE type)
		{
			m_message = GL_Message_Create(widget.getHandle(), type);
		}
		...
		inline void setPosition(T_GL_COORD x, T_GL_COORD y)
		{
			GL_Message_SetPosition(m_message, x, y);
		}

		inline void setMove(T_GL_COORD x, T_GL_COORD y)
		{
			GL_Message_SetMove(m_message, x, y);
		}

		inline void setKey(T_GL_WCHAR key)
		{
			GL_Message_SetKey(m_message, key);
		}

		inline Widget getUserControl(void)
		{
			return Widget(GL_Message_GetUserControl(m_message));
		}

		inline unsigned long getData(void * data, unsigned long dataSize)
		{
			return GL_Message_GetData(m_message, data, dataSize);
		}
	
		inline void setData(const void * data, unsigned long dataSize)
		{
			GL_Message_SetData(m_message, data, dataSize);
		}

		inline T_GL_SCREEN_ORIENTATION getScreenOrientation(void)
		{
			return GL_Message_GetScreenOrientation(m_message);
		}

		inline void setRange(T_GL_RANGE range)
		{
			GL_Message_SetRange(m_message, range);
		}
	...
	public:
		...
		inline ulong dispatch(T_GL_DURATION duration)
		{
		...
		inline void setInactivityDuration(T_GL_DURATION duration)
		{
		...
		inline T_GL_RECT getArea(void)
		{
			return GL_Window_GetArea(m_widget);
		}
	};
	...
	public:
		...
		inline T_GL_RANGE getVerticalRange(void)
		{
			return GL_ScrollView_GetVerticalRange(m_widget);
		}

		inline T_GL_RANGE getHorizontalRange(void)
		{
			return GL_ScrollView_GetHorizontalRange(m_widget);
		}

		inline void move(T_GL_COORD xMove, T_GL_COORD yMove)
		{
			GL_ScrollView_Move(m_widget, xMove, yMove);
		}
	};
	...
	public:
		...
		inline const char * getDirectory(void)
		{
			return GL_Dir_GetDirectory(m_dir);
		}
	...
	public:
		...
		inline T_GL_ERROR_CODE flush(void)
		{
			return GL_File_Flush(m_file);
		}

		static inline T_GL_ERROR_CODE exists(const char* name)
		{
			return GL_File_Exists(name);
		}
	...
	{
	public:
		inline Barcode (Widget & parent) : Widget(0)
		{
			m_widget = GL_Barcode_Create(parent.getHandle());
		}
		
		inline void setValue(const void * value, ulong size)
		{
			GL_Barcode_SetValue(m_widget, value, size);
		}

		inline void setMimeType(const char * mimeType)
		{
			GL_Barcode_SetMimeType(m_widget, mimeType);
		}

		inline void setParamString(const char * name, const char * value)
		{
			GL_Barcode_SetParamString(m_widget, name, value);
		}

		inline void setParamInteger(const char * name, long value)
		{
			GL_Barcode_SetParamInteger(m_widget, name, value);
		}

		inline void setParamBuffer(const char * name, const void * value, ulong length)
		{
			GL_Barcode_SetParamBuffer(m_widget, name, value, length);
		}
	};


	class UserControl : public Widget
	{
	public:
		inline UserControl (Widget & parent, const char * filename) : Widget(0)
		{
			m_widget = GL_UserControl_Create(parent.getHandle(), filename);
		}
	};
	...
	{
	public:
		inline ArrowButton (Widget & parent) : Widget(0)
		{
			m_widget = GL_ArrowButton_Create(parent.getHandle());
		}
		
		inline void setArrowDirection(T_GL_ARROW_DIRECTION direction)
		{
			GL_ArrowButton_SetArrowDirection(m_widget, direction);
		}

		inline T_GL_ARROW_DIRECTION getArrowDirection(void)
		{
			return GL_ArrowButton_GetArrowDirection(m_widget);
		}
	};
	...
	inline void Widget::sendMessage(Message & message)
	{
		GL_Widget_SendMessage(m_widget, message.getHandle());
	}
