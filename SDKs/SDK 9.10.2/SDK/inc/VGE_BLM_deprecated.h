...
/*!  @brief AVL BLM will not be supported in Telium+ framework. This function has been reported as unused in the survey sent to regions.
 ...
 * It accepts as input the sorting and search methods that will be used to add and to search elements into the black list.
...
#define BLM_CreateBlackList ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int BLM_CreateBlackList(BLM_Sorting i_pfSort,BLM_FindElement i_pfFindElt) MACRO_DEPRECATED ;
#endif
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define BLM_DeleteBlackList ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int BLM_DeleteBlackList(void) MACRO_DEPRECATED ;
#endif
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define BLM_InitBlackList ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int BLM_InitBlackList(DATE i_sActivationDate,DATE i_sExpirationDate,int i_nVersionNumber) MACRO_DEPRECATED ;
#endif
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define BLM_CheckExistenceInBL ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int BLM_CheckExistenceInBL(	BLM_t_pan *i_psPan) MACRO_DEPRECATED ;
#endif
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define BLM_AddElementInBL ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int BLM_AddElementInBL(	BLM_t_elt_black_list* i_psEltBlackList) MACRO_DEPRECATED ;
#endif
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define BLM_DeleteElementFromBL ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int BLM_DeleteElementFromBL(BLM_t_elt_black_list* i_psEltBlackList) MACRO_DEPRECATED ;
#endif
 ...
 * The black list temporal validity is identified by the activation and expiration dates.
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define BLM_ModifyValidityOfBL ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int BLM_ModifyValidityOfBL(DATE i_sActivationDate,DATE i_sExpirationDate) MACRO_DEPRECATED ;
#endif
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define BLM_VerifyValidityOfBL ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
int BLM_VerifyValidityOfBL(DATE i_sCurrentDate) MACRO_DEPRECATED ;
#endif
...
**/
#ifndef _DEPRECATED_AVL_SDK090200_
#define BLM_PrintDiagOfBL ERROR_Deprecation_For_Module_AVL_SeeDocumentation_In_CHM_File;
#else
void BLM_PrintDiagOfBL() MACRO_DEPRECATED ;
#endif
