...
/*! @brief This function returns the handle Bluetooth.
...
#else
extern Telium_File_t *GetBtHandle(void);
#endif


/*! @brief This function returns the state of handle Bluetooth.
 * @param dbt : Handle Bluetooth.
...
#else
extern void  GetPeriphState(Telium_File_t *dbt,int fct,BtState *periph);
#endif
...
#else
extern int   IsBaseKnown(Telium_File_t *dbt);
#endif


/*! @brief This function returns TRUE if one base is connected.
 * @param dbt : Handle Bluetooth.
 * @param indice : num of base given by the Bluetooth driver
 * @return TRUE or FALSE
...
#else
extern int   IsBaseConnected(Telium_File_t *dbt,int indice);
#endif
...
#else
extern void  GetBaseName(Telium_File_t *dbt,int indice,char *base_name);
#endif


/*! @brief This function returns the level Bluetooth.
 * @param dbt : Handle Bluetooth.
 * @param indice : num of base given by the Bluetooth driver
 * @return
 * - 0 = not connected
...
#else
extern int   Get_BtLevel(Telium_File_t *dbt,int indice);
#endif
...
#else
extern int   Get_SIM_State(Telium_File_t *dgprs);
#endif
...
#else
extern int   Get_GPRS_State(Telium_File_t *dgprs,unsigned int *Attachment,int *ConnectState,char *network_name);
#endif
...
#else
extern int   Get_GPRS_Radio_Level(Telium_File_t *dgprs);
#endif
