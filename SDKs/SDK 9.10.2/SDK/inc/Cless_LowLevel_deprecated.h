...
#ifndef _DEPRECATED_TPASS_SDK090800_
#define CLESS_OpenDriver()			ERROR_Deprecation_For_Function_CLESS_OpenDriver_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_CloseDriver()			ERROR_Deprecation_For_Function_CLESS_CloseDriver_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_IsDriverOpened()		ERROR_Deprecation_For_Function_CLESS_IsDriverOpened_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_DetectCardsStart(a, b)	ERROR_Deprecation_For_Function_CLESS_DetectCardsStart_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_DetectCards(a, b, c, d)			ERROR_Deprecation_For_Function_CLESS_DetectCards_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_DetectCardsStop(a)		ERROR_Deprecation_For_Function_CLESS_DetectCardsStop_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_ActiveCard(a, b, c)			ERROR_Deprecation_For_Function_CLESS_ActiveCard_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_DeselectCard(a, b, c, d)		ERROR_Deprecation_For_Function_CLESS_DeselectCard_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_DeselectCardStart(a, b, c, d)	ERROR_Deprecation_For_Function_CLESS_DeselectCardStart_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define CLESS_Apdu(a, b, c, d, e, f)				ERROR_Deprecation_For_Function_CLESS_Apdu_For_TPassDLL_SeeDocumentation_In_CHM_File;
...
#ifndef _DEPRECATED_TPASS_SDK090800_
#define MF_OpenDriver()			ERROR_Deprecation_For_Function_MF_OpenDriver_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_CloseDriver()		ERROR_Deprecation_For_Function_MF_CloseDriver_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_IsDriverOpened()		ERROR_Deprecation_For_Function_MF_IsDriverOpened_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_DetectCards(a, b, c)		ERROR_Deprecation_For_Function_MF_DetectCards_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_DetectCardsEx(a, b, c, d)		ERROR_Deprecation_For_Function_MF_DetectCardsEx_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_GetUid(a, b, c, d, e)				ERROR_Deprecation_For_Function_MF_GetUid_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_ActiveCard(a, b)			ERROR_Deprecation_For_Function_MF_ActiveCard_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_Authentication(a, b, c, d)		ERROR_Deprecation_For_Function_MF_Authentication_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_ReadBlock(a, b, c, d, e)			ERROR_Deprecation_For_Function_MF_ReadBlock_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_WriteBlock(a, b, c, d, e)			ERROR_Deprecation_For_Function_MF_WriteBlock_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define MF_ValueOperation(a, b, c, d, e, f)		ERROR_Deprecation_For_Function_MF_ValueOperation_For_TPassDLL_SeeDocumentation_In_CHM_File;
...
#ifndef _DEPRECATED_TPASS_SDK091000_

#define TPass_LedsOnColored(a) ERROR_Deprecation_For_Function_TPass_LedsOnColored_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define TPass_LedsOffColored(a) ERROR_Deprecation_For_Function_TPass_LedsOffColored_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define TPass_LedsBlinkColored(a, b, c) ERROR_Deprecation_For_Function_TPass_LedsBlinkColored_For_TPassDLL_SeeDocumentation_In_CHM_File;
...
\warning This function will be deprecated in Telium+. Use \ref TPass_LedsOn instead.
...
*/
void TPass_LedsOnColored(unsigned char Leds) MACRO_DEPRECATED;


/*! \brief Turn off one or several LEDs.
\warning This function will be deprecated in Telium+. Use \ref TPass_LedsOff instead.
...
*/
void TPass_LedsOffColored(unsigned char Leds) MACRO_DEPRECATED;


/*! \brief Blink one or several LEDs.
\warning This function will be deprecated in Telium+. Use \ref TPass_LedsBlink instead.
...
*/
void TPass_LedsBlinkColored(unsigned char Leds, unsigned char TimeOn, unsigned char TimeOff) MACRO_DEPRECATED;
...
#ifndef _DEPRECATED_TPASS_SDK091000_
#define TPasslib_open()			ERROR_Deprecation_For_Function_TPasslib_open_For_TPassDLL_SeeDocumentation_In_CHM_File;
#define TPasslib_close()		ERROR_Deprecation_For_Function_TPasslib_close_For_TPassDLL_SeeDocumentation_In_CHM_File;
...
//! \warning This function will be deprecated in Telium+. This function is not needed anymore.
/* ------------------------------------------------------------------------ */
/* @GSIM_F:TPasslib_open:KSFAM_DLL:0x22                                     */
/* ------------------------------------------------------------------------ */
int TPasslib_open(void) MACRO_DEPRECATED;
...
/* ------------------------------------------------------------------------ */
void TPasslib_close(void) MACRO_DEPRECATED;
...
#ifndef _DEPRECATED_TPASS_SDK091000_
#define TPass_GetDiagnostics(a, b)			ERROR_Deprecation_For_Function_TPass_GetDiagnostics_For_TPassDLL_SeeDocumentation_In_CHM_File;
#else
...
<tr><td>\ref ERR_TPASS_KO</td><td>An error occurred.</td></tr>
</table>
*/
/* ------------------------------------------------------------------------ */
...
/* @GSIM_A:2:OUT_ONLY                                                       */
/* ------------------------------------------------------------------------ */
int TPass_GetDiagnostics(spy_data_t* pSpyData, char* pDiagnostics) MACRO_DEPRECATED;
#endif
//! @}
#endif
