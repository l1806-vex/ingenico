...
//! @{
	...
	//! @{
		...
		//! @{
			...
			//! \defgroup ClessGenericSelectionEntryPoint PPSE Application Selection
			// @{

				//! \defgroup EntryPointNewOption9F2AAndNewPreProcessing New features (management of 9F2A and pre processing)
				//!	\defgroup ClessGenericSelectionEntryPointFunctions PPSE Application Selection functions
		...
		//! @{
			...
			//! \defgroup ClessExplicitSelectionPreprocessing PPSE Application Selection pre-conditions and pre-processing (explicit selection)
...
//! \defgroup EntryPointDefines PPSE Application Selection Defines
//! @{

	//! \defgroup TagsDefinitions Tags definition
	//! @{

		//! \defgroup EntryPointDefinedTags PPSE Application Selection defined tags (defined by EMVCo).
		//! \defgroup EntryPointInternalDefinition PPSE Application Selection Ingenico created tags.
		//! @{

			//! \defgroup EntryPointPossibleKernels PPSE Application Selection Kernel identifiers (values for tag TAG_EP_KERNEL_TO_USE).
	...
	//! \defgroup EntryPoint_ExternalTypes PPSE Application Selection external types
