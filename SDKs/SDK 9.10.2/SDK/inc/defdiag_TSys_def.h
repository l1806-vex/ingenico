...
#ifndef __DEFDIAG_TSYS_DEF_H_INCLUDED__
#define __DEFDIAG_TSYS_DEF_H_INCLUDED__
...
#define EXIT_NOT_DESCRIPTOR 			5		/*!< File handler is not valid (argument has not been returned by fopen) */
...
#endif   // __DEFDIAG_TSYS_DEF_H_INCLUDED__
