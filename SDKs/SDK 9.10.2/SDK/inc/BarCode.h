...
**/
extern int  PrintBarCode128(unsigned char *Message,int Xsize,int Ysize,int Direction,int alignment, int PrintValue);
...
extern int  PrintBarCode25(unsigned char *Message,int Xsize,int Ysize,int Direction,int alignment, int PrintValue, int checksum);
...
extern int  PrintBarCode39(unsigned char *Message,int Xsize,int Ysize,int Direction,int alignment, int PrintValue);
...
* @link DOC_BARCODE Back to top @endlink
**/
extern int PrintBarCodeEAN8(unsigned char *Message,int Xsize,int Ysize,int Direction,int alignment, int PrintValue);
...
* @link DOC_BARCODE Back to top @endlink
**/
extern int PrintBarCodeEAN13(unsigned char *Message,int Xsize,int Ysize,int Direction,int alignment, int PrintValue	);
...
* @link DOC_BARCODE Back to top @endlink
**/
extern int  PrintBarCodePDF417(unsigned char *BarCodeText,int nrows,int ncols,int ecLevel,int rotate);

/*! @brief This function is the old format for PDF417 barcodes. Please see @ref PrintBarCodePDF417 for more information
* 
* @link DOC_BARCODE Back to top  @endlink
**/
extern int Print_PDF417_BarCode(unsigned char *BarCodeText,int nrows,int ncols,int ecLevel);
...
* @link DOC_BARCODE Back to top @endlink
**/
extern int Print_QR_BarCode(unsigned char *BarCodeText, unsigned int BarCodeTextSize,int nsize,QRencodeMode mode,QRecLevel ecLevel);
