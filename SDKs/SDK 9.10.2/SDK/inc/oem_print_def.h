...
# ifndef __OEM_PRINT_DEF_H_INCLUDED__
# define __OEM_PRINT_DEF_H_INCLUDED__
...
#define    PRINTER_GET_PRM_FILE_NAME			0x8028	/*!< Get the external file name @param unsigned char [32+1] */
...
/*! @brief structure to define a printer pattern (EXT_PRINTER only) */
typedef struct
{
...
#endif   // __OEM_PRINT_DEF_H_INCLUDED__
