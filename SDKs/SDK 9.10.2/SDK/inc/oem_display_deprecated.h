...
#ifdef _DEPRECATED_OEM_DISPLAY_SDK96_
/*
======================================================================
					List of Defines
======================================================================
...
//List of fioctl 
#define  FIOCTL_SET_FULL_COLOR              0x8000      /*!<  @deprecated Command to enable or disable Full color mode (pointeur to an unsigned char parameter : TRUE / FALSE) */
#define  FIOCTL_SET_COLOR_DISPLAY           0x8001      /*!<  @deprecated Command to pass a DISPLAY_COLOR_FIOCTL structure : set the text and background color in compatible mode */
#define  FIOCTL_BITMAP_COLOR                0x8002      /*!<  @deprecated Command to pass a DISPLAY_BITMAP_COLOR_FIOCTL structure : write in the display screen buffer and set a refresh in the periodcal task */
#define  FIOCTL_BITMAP_COLOR_FILM           0x8003      /*!<  @deprecated Command to pass a DISPLAY_BITMAP_COLOR_FILM_FIOCTL structure : send directly to the Booster the bitmap in the current task */
#define  FIOCTL_RECTANGLE_COLOR             0x8004      /*!<  @deprecated Command to pass a DISPLAY_RECTANGLE_COLOR_FIOCTL structure : write in the display screen buffer and set a refresh in the periodcal task  */
#define  FIOCTL_COLOR_REFRESH               0x8005      /*!<  @deprecated Command to pass a DISPLAY_BITMAP_COLOR_FIOCTL structure : refresh coordinated area in the current task */      
#define  FIOCTL_WRITE_COLOR_BMP             0x8006      /*!<  @deprecated Command to pass a DISPLAY_BITMAP_COLOR_FIOCTL structure : write in the display screen buffer */
#define  FIOCTL_GET_FULL_COLOR              0x8007      /*!<  @deprecated Command to get the display mode (full color or not : pointeur to an unsigned char parameter) */
#define  FIOCTL_GET_COLOR_DISPLAY           0x8008      /*!<  @deprecated Command to get the current DISPLAY_COLOR_FIOCTL structure */
#define  FIOCTL_GET_SCREEN_INFO             0x8009      /*!<  @deprecated Command to get the screen informations (DISPLAY_SCREEN_INFO_FIOCTL structure) */
#define  FIOCTL_READ_COLOR_BMP              0x800A      /*!<  @deprecated Command to pass a DISPLAY_BITMAP_COLOR_FIOCTL structure : return the encoding kind and saved coordinated bitmap (with a dll_malloc) */
#define  FIOCTL_CMD_EXTERNAL_DISPLAY        0x800B      /*!< @deprecated  */
#define  FIOCTL_FLUSH_DISPLAY               0x800C      /*!<  @deprecated Command to flush display buffer to screen (NULL parameter) */
#define  FIOCTL_REFRESH_ALL_DISPLAY         0x800D      /*!<  @deprecated Command to refresh and flush all display (NULL parameter) */
