// $Id: GL_List.h,v 1.1.2.35 2012/12/17 09:51:23 rbertholet Exp $
// Graphic Object list
...
<h2>Sample</h2>
	...
	@include GL_SampleListDynamic.c

	Below is a list icon completely redefined by the user

	@include GL_SampleUserList.c
