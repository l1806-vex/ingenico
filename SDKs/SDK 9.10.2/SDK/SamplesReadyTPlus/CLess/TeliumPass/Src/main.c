...
extern int cless_give_info(NO_SEGMENT no, S_TRANSIN * pParamIn, S_CLESS_GIVEINFO* pParamOut);
extern int cless_debit_aid(NO_SEGMENT no, unsigned int nSize, void * pData);
extern int cless_end(NO_SEGMENT no);
extern int cless_is_for_you(NO_SEGMENT no, unsigned int nSize, void * pData);
extern int cless_debit(NO_SEGMENT no, unsigned int nSize, void * pData);
...
int Main(unsigned int size, StructPt *data)
{
    ...
    case CLESS_GIVE_INFO:
        TRC_TRACE_INFO(trc_main, "SVC CALL: CLESS_GIVE_INFO");
        ret = cless_give_info(No, &data->Param.ClessGiveInfo.param_in, &data->Param.ClessGiveInfo.param_out);
        break;

    case CLESS_IS_FOR_YOU:
        TRC_TRACE_INFO(trc_main, "SVC CALL: CLESS_IS_FOR_YOU");
        ret = cless_is_for_you(No, size, data);
        break;

    case CLESS_DEBIT:
        TRC_TRACE_INFO(trc_main, "SVC CALL: CLESS_DEBIT");
        ret = cless_debit(No, size, data); 
        break;

    case CLESS_DEBIT_AID:
        TRC_TRACE_INFO(trc_main, "SVC CALL: CLESS_DEBIT_AID");
        ret = cless_debit_aid(No, size, data);
        break;

    case CLESS_END:
        TRC_TRACE_INFO(trc_main, "SVC CALL: CLESS_END");
        ret = cless_end(No);
        break;
