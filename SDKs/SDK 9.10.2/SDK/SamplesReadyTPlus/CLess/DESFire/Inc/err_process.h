...
#define ERR_CLESS_NOT_IMPLEMENTED   -(509)///<Error returned by ERR when cless is not implemented
#define ERR_DESFIRE_ERROR                    -(510)///<Error returned by ERR when desfire processing failed
