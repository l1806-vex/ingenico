 ...
 * \param[out] posKeyA pointer to the data to be obtained
 *
 * \return
 ...
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_PosKeyAGet(char **posKeyA);

/** \brief 
 * It contains Key A
 * The parameter's datatype is hexadecimal with READWRITE access
 * \param[in] posKeyA parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
...
*/
int PAR_PosKeyASet(char *posKeyA);

/** \brief 
 * It contains Key B
 * The parameter's datatype is hexadecimal with READWRITE access
 * \param[out] posKeyB pointer to the data to be obtained
 *
 * \return
 *      - PAR_OK = Parameter value is obtained succesfully
 * \return
 ...
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_PosKeyBGet(char **posKeyB);

/** \brief 
 * It contains Key B
 * The parameter's datatype is hexadecimal with READWRITE access
 * \param[in] posKeyB parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_ACCESS_DENIED = Access Denied, Read-only access.
 ...
 *      - \ref PAR_INVALID_DATA_LEN = Invalid Parameter data length being Set.
*/
int PAR_PosKeyBSet(char *posKeyB);

/** \brief 
 * It contains Key C
 * The parameter's datatype is hexadecimal with READWRITE access
 * \param[out] posKeyC pointer to the data to be obtained
 *
 * \return
 *      - PAR_OK = Parameter value is obtained succesfully
 * \return
 ...
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_PosKeyCGet(char **posKeyC);

/** \brief 
 * It contains Key C
 * The parameter's datatype is hexadecimal with READWRITE access
 * \param[in] posKeyC parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_ACCESS_DENIED = Access Denied, Read-only access.
 ...
 *      - \ref PAR_INVALID_DATA_LEN = Invalid Parameter data length being Set.
*/
int PAR_PosKeyCSet(char *posKeyC);
