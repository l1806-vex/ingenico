...
void TRC_Init(void)
{
    ...
    switch (output)
    {
        ...
        case TRC_STREAM_INT_FILE:
            TRC_OutputSet(output, "/HOST/DESFIRE.TXT", 0, 0, 0);
            break;

        case TRC_STREAM_EXT_FILE_USB1:
            TRC_OutputSet(output, "/USB1/DESFIRE.TXT", 0, 0, 0);
            break;

        case TRC_STREAM_EXT_FILE_MMC:
            TRC_OutputSet(output, "/MMC/DESFIRE.TXT", 0, 0, 0);
            break;
