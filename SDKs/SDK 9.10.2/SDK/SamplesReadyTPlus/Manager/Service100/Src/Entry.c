...
static service_desc_t Services[] = {
                                     ...
                                     { 0, SELECT_FUNCTION, (SAP) Main, (unsigned char) SERVICES_HIGH_PRIORITY }
};
...
{
   guiScreen("Service 100", (char*)idleMsg, GL_ICON_NONE, 0);
   return FCT_OK;
}
...
int file_received(NO_SEGMENT no, S_FILE *param_in, void *p2)
{
   ...
   if (strcmp(param_in->file_name, "SERVICE100.PAR") == 0)
   {
      PAR_Import("/HOST/SERVICE100.PAR");
   }
