 ...
 * \source Stream.c
 */
int stmGetBuf(tStream *stm, char *buf, unsigned int len); ///<get len bytes from the stream
 ...
 * \source Stream.c
 */
int stmPut(tStream *stm, char buf);
 ...
 * \source Stream.c
 */
int stmPutBuf(tStream *stm, const char *buf, unsigned int len); ///<put len bytes from the stream
