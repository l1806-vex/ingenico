...
#define UI_TIMEOUT_5_SECONDS               5000 ///< 5-second timeout delay used for GUI dialogs
   ...
   typedef enum
   {
      UI_PROMPT_MSG_START, UI_PROMPT_MSG_ERR_UNDEFINED_ERROR, UI_PROMPT_MSG_PAR_CURRENCY_VALUE, UI_PROMPT_MSG_PAR_FILE_NOT_FOUND, UI_PROMPT_MSG_END
   } UI_PromptIdx_t;
   ...
   /** Displays the menu choosing payment mode.
    *
    */
   unsigned long Ui_PaymentDisplayMenu(void);
   /** Displays the menu choosing payment type.
    *
    */
   unsigned long Ui_TypeDisplayMenu(void);

   /** Displays the menu choosing payment support.
    *
    */
   unsigned long Ui_SupportDisplayMenu(void);
