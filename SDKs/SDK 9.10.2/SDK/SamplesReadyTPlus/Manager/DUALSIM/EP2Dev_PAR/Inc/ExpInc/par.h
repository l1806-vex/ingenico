...
/** \brief Obtain the parameter data stringname
 * It contains operator name string
 * The parameter's datatype is alphanumeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be obtained
 * \param[out] nameStr pointer to the data to be obtained
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_T_GPRS_TEST_SETTINGS_NameStrGet(int T_GPRS_TEST_SETTINGS, char **nameStr);

/** \brief Save the parameter data stringname
 * It contains operator name string
 * The parameter's datatype is alphanumeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be updated
 * \param[in] nameStr parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
...
*/
int PAR_T_GPRS_TEST_SETTINGS_NameStrSet(int T_GPRS_TEST_SETTINGS, char *nameStr);

/** \brief Obtain the parameter data Slot Id
 * It contains Slot Identifier
 * The parameter's datatype is numeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be obtained
 * \param[out] nSlotId pointer to the data to be obtained
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_T_GPRS_TEST_SETTINGS_NSlotIdGet(int T_GPRS_TEST_SETTINGS, unsigned long *nSlotId);

/** \brief Save the parameter data Slot Id
 * It contains Slot Identifier
 * The parameter's datatype is numeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be updated
 * \param[in] nSlotId parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_ACCESS_DENIED = Access Denied, Read-only access.
 ...
 *      - \ref PAR_INVALID_DATA_LEN = Invalid Parameter data length being Set.
*/
int PAR_T_GPRS_TEST_SETTINGS_NSlotIdSet(int T_GPRS_TEST_SETTINGS, unsigned long nSlotId);

/** \brief Obtain the parameter data Pin Code
 * It contains Pin Code
 * The parameter's datatype is alphanumeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be obtained
 * \param[out] szPinCode pointer to the data to be obtained
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_T_GPRS_TEST_SETTINGS_SzPinCodeGet(int T_GPRS_TEST_SETTINGS, char **szPinCode);

/** \brief Save the parameter data Pin Code
 * It contains Pin Code
 * The parameter's datatype is alphanumeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be updated
 * \param[in] szPinCode parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_ACCESS_DENIED = Access Denied, Read-only access.
 ...
 *      - \ref PAR_INVALID_DATA_LEN = Invalid Parameter data length being Set.
*/
int PAR_T_GPRS_TEST_SETTINGS_SzPinCodeSet(int T_GPRS_TEST_SETTINGS, char *szPinCode);

/** \brief Obtain the parameter data Slot Id
 * It contains Slot Identifier
 * The parameter's datatype is alphanumeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be obtained
 * \param[out] szAPn pointer to the data to be obtained
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_T_GPRS_TEST_SETTINGS_SzAPnGet(int T_GPRS_TEST_SETTINGS, char **szAPn);

/** \brief Save the parameter data Slot Id
 * It contains Slot Identifier
 * The parameter's datatype is alphanumeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be updated
 * \param[in] szAPn parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_ACCESS_DENIED = Access Denied, Read-only access.
 ...
 *      - \ref PAR_INVALID_DATA_LEN = Invalid Parameter data length being Set.
*/
int PAR_T_GPRS_TEST_SETTINGS_SzAPnSet(int T_GPRS_TEST_SETTINGS, char *szAPn);

/** \brief Obtain the parameter data portNum
 * It contains port number
 * The parameter's datatype is numeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be obtained
 * \param[out] nPort pointer to the data to be obtained
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_T_GPRS_TEST_SETTINGS_NPortGet(int T_GPRS_TEST_SETTINGS, unsigned long *nPort);

/** \brief Save the parameter data portNum
 * It contains port number
 * The parameter's datatype is numeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be updated
 * \param[in] nPort parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_ACCESS_DENIED = Access Denied, Read-only access.
 ...
 *      - \ref PAR_INVALID_DATA_LEN = Invalid Parameter data length being Set.
*/
int PAR_T_GPRS_TEST_SETTINGS_NPortSet(int T_GPRS_TEST_SETTINGS, unsigned long nPort);

/** \brief Obtain the parameter data HostName
 * It contains Host Name String
 * The parameter's datatype is alphanumeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be obtained
 * \param[out] szHostName pointer to the data to be obtained
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_NOT_INITIALIZED = Parameter data not Initialized, PAR_Import must be performed first.
*/
int PAR_T_GPRS_TEST_SETTINGS_SzHostNameGet(int T_GPRS_TEST_SETTINGS, char **szHostName);

/** \brief Save the parameter data HostName
 * It contains Host Name String
 * The parameter's datatype is alphanumeric with READWRITE access
 * \param[in] T_GPRS_TEST_SETTINGS identifier of the data to be updated
 * \param[in] szHostName parameter value to be saved
 *
 * \return
 *      - \ref PAR_OK = Parameter file is parsed succesfully
 *      - \ref PAR_ACCESS_DENIED = Access Denied, Read-only access.
 ...
 *      - \ref PAR_INVALID_DATA_LEN = Invalid Parameter data length being Set.
*/
int PAR_T_GPRS_TEST_SETTINGS_SzHostNameSet(int T_GPRS_TEST_SETTINGS, char *szHostName);
