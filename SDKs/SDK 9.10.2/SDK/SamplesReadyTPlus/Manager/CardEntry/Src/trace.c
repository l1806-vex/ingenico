...
void TRC_Init(void)
{
    ...
    switch (output)
    {
        ...
        case TRC_STREAM_INT_FILE:
            TRC_OutputSet(output, "/HOST/CARDENTRY.TXT", 0, 0, 0);
            break;

        case TRC_STREAM_EXT_FILE_USB1:
            TRC_OutputSet(output, "/USB1/CARDENTRY.TXT", 0, 0, 0);
            break;

        case TRC_STREAM_EXT_FILE_MMC:
            TRC_OutputSet(output, "/MMC/CARDENTRY.TXT", 0, 0, 0);
            break;
