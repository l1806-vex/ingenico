...
static service_desc_t Services[] = {
    ...
    { 0, CUSTOMIZE_CARD_ENTRY, (SAP)FUN_ServiceCardEntry, (unsigned char)SERVICES_HIGH_PRIORITY }
};
...
int file_received(NO_SEGMENT no, S_FILE *param_in, void *p2)
{
    ...
    if (strcmp(param_in->file_name, "CARDENTRY.PAR")==0)
    {
        PAR_Import("/HOST/CARDENTRY.PAR");
    }
