...
extern int CGUI_DisplayEnterPinMsg(int nb_try, unsigned char PPTestType, unsigned char AllowTermIfPPadHS, int *PtrUsePinpad, WGUI_BROWSER_HANDLE WGUI_Browser);
...
extern  unsigned char CGUI_EnterPin(int nb_try,ENTRY_BUFFER *buffer,int type_pin,unsigned char PPTestType,unsigned char ForceKsu,unsigned char AllowTermIfPPadHS, WGUI_BROWSER_HANDLE Browser, WGUI_CANVAS_HANDLE WGUI_Canvas);
...
extern  unsigned char CGUI_ManageKeys(ENTRY_BUFFER *buffer,unsigned char ForceKsu,unsigned char KeyFunction,int isPinpad, int PinpadValue,int type_pin, WGUI_CANVAS_HANDLE WGUI_Canvas);
...
extern  unsigned char CGUI_SelectInputKeyMethod (int nb_try, ENTRY_BUFFER *buffer, unsigned char type_pin, unsigned char AllowTermIfPPadHS);
...
/*&END FT/09/5296/MA    SEC_ISO9563 has to be called only if Injection successfull */
			...
			{
				cr_enter_pin = CGUI_SelectInputKeyMethod (nb_try, buffer, CUP_PIN_ONLINE, AllowTermIfPPadHS);
			}
