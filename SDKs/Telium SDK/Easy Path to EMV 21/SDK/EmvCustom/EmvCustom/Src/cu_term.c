...
#define C_WAIT_PRINT_CMD		500							//!< Awaiting time for the printer in ticks (1 tick = 10 ms).
...
{ 
...

	{
		...
		{
			G_AfficherMSG (&CurrentMSG, mode, !ATTENDRE);
		}
...
#endif
	{
		if (CUTERMgetTerminalType() == T_CUTERM_TWIN30)
		{
			// return always FALSE
			isPrinter = B_FALSE;
		}
...
#endif
		{
			rc_entry = ttestall (((PINPAD)|CAM0), 0);
		}
