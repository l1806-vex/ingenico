...
#define CLESS_SAMPLE_SCREEN_SIGNATURE_OK                        (34)            /*!<  */
#define CLESS_SAMPLE_SCREEN_SIGNATURE_KO                        (35)            /*!<  */
#define CLESS_SAMPLE_SCREEN_STOPPED                             (36)            /*!<  */
...
#define CLESS_SAMPLE_EXPRESSPAY_SCREEN_SIGNATURE_OK_ONLINE_APPROVED       (150)       /*!<  */
#define CLESS_SAMPLE_EXPRESSPAY_SCREEN_PROCESSING                         (151)       /*!<  */
