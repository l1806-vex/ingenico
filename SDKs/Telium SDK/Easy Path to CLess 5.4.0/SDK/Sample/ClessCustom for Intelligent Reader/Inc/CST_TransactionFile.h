...
**/
#ifndef __CST_TRANSACTION_FILE_H__
#define __CST_TRANSACTION_FILE_H__
...
int CST_TransactionFile_GetTransaction (T_Transaction_File *pt_Tr_File, TLV_TREE_NODE *phOutputTlvTree, unsigned int Trans_pos, int * Trans_len);
...
#endif // __CST_TRANSACTION_FILE_H__
