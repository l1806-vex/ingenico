...
//! \brief This enumerator defines the different terminal types.
typedef enum
{
	T_CUTERM_EFT30,									//!< EFT30 terminal.
	T_CUTERM_EFT30PLUS,								//!< EFT30 plus terminal.
	T_CUTERM_SMART,									//!< EFTsmart terminal.
	T_CUTERM_X930,									//!< EFT930 terminal.
	T_CUTERM_TWIN30,								//!< Twin30 terminal or EFT930 wifi.
	T_CUTERM_X930G,									//!< EFT930 GPRS terminal.
	T_CUTERM_X930B,									//!< EFT930 bluetooth terminal.
	T_CUTERM_X930F									//!< EFT930 stationnary terminal.
} T_CUTERMtermtype;
...
//===========================================================================
//! \brief This function returns the terminal type.
//! \return The terminal type : 
//! - \ref T_CUTERM_EFT30
//! - \ref T_CUTERM_EFT30PLUS
//! - \ref T_CUTERM_SMART
//! - \ref T_CUTERM_X930
//! - \ref T_CUTERM_TWIN30
//! - \ref T_CUTERM_X930G
...
//! - \ref T_CUTERM_X930F
//===========================================================================
extern T_CUTERMtermtype CUTERMgetTerminalType(void);
...
//===========================================================================
//! \brief This function tests if a sped is connected to the terminal.
//! \return 
//! - TRUE if Sped is connected to terminal.
//! - FALSE otherwise.
//===========================================================================
extern T_Bool CUTERMIsSpedConnected (void);

//===========================================================================
//! \brief This function tests if a P30 is present.
//! \return 
//! - TRUE if P30 is present.
//! - FALSE otherwise.
//===========================================================================
extern T_Bool CUTERIsP30Present(void);
// extern T_Bool CUTERMisP30(void);

//===========================================================================
//! \brief This function tests if a card is inserted in P30.
//! \return 
//! - TRUE if a card is inserted in P30.
//! - FALSE otherwise.
//===========================================================================
extern unsigned char CUTERMCardOnPPAD (void);
