...
static void __CUC30_DisplayText(const char* szText, int nLength, int nAlignment)
{
   ...
   usOption = UCMDISPLAY_OPEN_IF_NOT | UCMDISPLAY_CLOSE_IF_OPEN;
   
   switch( nAlignment )
   {
      case CUC30_ALIGN_LEFT:
      case CUC30_ALIGN_RIGHT:
      break;
      case CUC30_ALIGN_CENTER:
         usOption|= UCMDISPLAY_CENTER;
      break;		      
   }

   iRet = iLIBUCM_Display_Option( giDisplayCanal, (char*) szText,  usOption, 0 );
