...
#ifdef _USE_UCM_
#define VERTICAL_BAR					   '*'			//!< Default character definition for vertical bar.
#define HORIZONTAL_BAR					'*'			//!< Default character definition for horizontal bar.
#define HORIZONTAL_BEGIN_BAR			'*'			//!< Default character definition for horizontal begin bar.
#define HORIZONTAL_END_BAR				'*'			//!< Default character definition for horizontal end bar.
#define HORIZONTAL_DOUBLE_BAR			'*'			//!< Default character definition for horizontal double bar.
#define HORIZONTAL_BEGIN_DOUBLE_BAR	'*'			//!< Default character definition for horizontal begin double bar.
#define HORIZONTAL_END_DOUBLE_BAR		'*'			//!< Default character definition for horizontal end double bar.
#define LEFT_BOTTOM_ROUNDED_CORNER		'*'			//!< Default character definition for left bottom rounded corner.
#define LEFT_TOP_ROUNDED_CORNER			'*'			//!< Default character definition for left top rounded corner.
#define RIGHT_BOTTOM_ROUNDED_CORNER		 '*'			//!< Default character definition for right bottom rounded corner.
#define RIGHT_TOP_ROUNDED_CORNER		'*'			//!< Default character definition for right top rounded corner.
#define EURO							'E'			//!< Default character definition for euro.
#else
