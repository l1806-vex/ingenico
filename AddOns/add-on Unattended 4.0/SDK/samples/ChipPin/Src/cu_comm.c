									...
									unsigned int nTimeout, unsigned int nRepetitions, TLV_TREE_NODE *pOutputTLVTree)
{
	...
	strcpy((char*)&AppProtocolConfig[nOffset + 2], "ISO8583.BIN");
	AppProtocolConfig[nOffset + 1] = strlen((char*)&AppProtocolConfig[nOffset + 2]) + 1;
	nOffset += 2 + AppProtocolConfig[nOffset + 1];

	AppProtocolConfig[nOffset + 0] = TAG_ISO8583_T_PATH;
	strcpy((char*)&AppProtocolConfig[nOffset + 2], "/HOST/");
	AppProtocolConfig[nOffset + 1] = strlen((char*)&AppProtocolConfig[nOffset + 2]) + 1;
	nOffset += 2 + AppProtocolConfig[nOffset + 1];
