...
-- oegwwebgroup_seq for id:
INSERT INTO web_groups
        (name,descr,access_admin,access_cfg,access_emm,access_oegwmm)
        VALUES ('admin','Administration group', 'Y', 'Y', 'Y', 'Y');

INSERT INTO web_groups
        (name,descr,access_admin,access_cfg,access_emm,access_oegwmm)
        VALUES ('helpdesk','Helpdesk people', 'N', 'Y', 'Y', 'Y');

INSERT INTO web_groups
        (name,descr,access_admin,access_cfg,access_emm,access_oegwmm)
        VALUES ('manager','Sale managers', 'N', 'N', 'N', 'N');
...
INSERT INTO oegw_activity_log
	...
	VALUES(CURRENT_DATE,'INFO','Completed','Init','','','','H2 DB recreated successfully');
