...
public class RequestFilter implements Filter {
    ...
    public void init(FilterConfig config) throws ServletException {
        ...
        resourceMapping.put(TERMINAL_OTHER, "/8550");
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (req.getMethod().equals("GET") && !redirected) {
            ...
            String resourceName = req.getRequestURI().replaceFirst("/iccemv/","");
            ...
            if (term.equalsIgnoreCase(TERMINAL_8550) || 
                ...
                redirectTo = res.encodeURL("/iccemv" + redirectValue + "/" + resourceName + "?redirected=1");
